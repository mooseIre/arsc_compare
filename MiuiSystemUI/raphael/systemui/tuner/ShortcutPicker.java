...
public class ShortcutPicker extends PreferenceFragment implements TunerService.Tunable {
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        ...
        preferenceCategory.setTitle(C0020R$string.tuner_other_apps);
        ...
        this.mNonePreference.setTitle(C0020R$string.lockscreen_none);
        this.mNonePreference.setIcon(C0012R$drawable.ic_remove_circle);
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        if ("sysui_keyguard_left".equals(this.mKey)) {
            getActivity().setTitle(C0020R$string.lockscreen_shortcut_left);
        } else {
            getActivity().setTitle(C0020R$string.lockscreen_shortcut_right);
        }
    }
    ...
    public static class AppPreference extends SelectablePreference {
        ...
        public AppPreference(Context context, LauncherActivityInfo launcherActivityInfo) {
            ...
            setTitle(context.getString(C0020R$string.tuner_launch_app, launcherActivityInfo.getLabel()));
            setSummary(context.getString(C0020R$string.tuner_app, launcherActivityInfo.getLabel()));
        }
    ...
    public static class ShortcutPreference extends SelectablePreference {
        ...
        public ShortcutPreference(Context context, ShortcutParser.Shortcut shortcut, CharSequence charSequence) {
            ...
            setSummary(context.getString(C0020R$string.tuner_app, charSequence));
        }
