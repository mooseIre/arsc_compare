...
public class PowerNotificationControlsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        return layoutInflater.inflate(C0016R$layout.power_notification_controls_settings, viewGroup, false);
    }

    public void onViewCreated(View view, Bundle bundle) {
        String str;
        super.onViewCreated(view, bundle);
        View findViewById = view.findViewById(C0014R$id.switch_bar);
        final Switch r3 = (Switch) findViewById.findViewById(16908352);
        final TextView textView = (TextView) findViewById.findViewById(C0014R$id.switch_text);
        r3.setChecked(isEnabled());
        if (isEnabled()) {
            str = getString(C0020R$string.switch_bar_on);
        } else {
            str = getString(C0020R$string.switch_bar_off);
        }
        ...
        r3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (z) {
                    str = PowerNotificationControlsFragment.this.getString(C0020R$string.switch_bar_on);
                } else {
                    str = PowerNotificationControlsFragment.this.getString(C0020R$string.switch_bar_off);
                }
                textView.setText(str);
            }
        });
