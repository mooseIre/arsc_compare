    ...
    public final class KeyboardUIHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (i != 8) {
                ...
                KeyboardUI.this.mDialog.setTitle(C0020R$string.enable_bluetooth_title);
                KeyboardUI.this.mDialog.setMessage(C0020R$string.enable_bluetooth_message);
                KeyboardUI.this.mDialog.setPositiveButton(C0020R$string.enable_bluetooth_confirmation_ok, bluetoothDialogClickListener);
