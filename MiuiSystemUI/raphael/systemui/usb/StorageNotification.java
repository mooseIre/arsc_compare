...
public class StorageNotification extends SystemUI {
            ...
            for (VolumeRecord volumeRecord : this.mStorageManager.getVolumeRecords()) {
                if (volumeRecord.getType() == 1) {
                    ...
                    if ((findVolumeByUuid == null || !findVolumeByUuid.isMountedWritable()) && !volumeRecord.isSnoozed()) {
                        String string = this.mContext.getString(17039975, new Object[]{volumeRecord.getNickname()});
                        String string2 = this.mContext.getString(17039974);
                        Notification.Builder deleteIntent = NotificationCompat.newBuilder(this.mContext, NotificationChannels.STORAGE).setSmallIcon(17302804).setColor(this.mContext.getColor(17170460)).setContentTitle(string).setContentText(string2).setContentIntent(buildForgetPendingIntent(volumeRecord)).setStyle(new Notification.BigTextStyle().bigText(string2)).setVisibility(1).setLocalOnly(true).setCategory("sys").setDeleteIntent(buildSnoozeIntent(fsUuid));
    ...
    public void onDiskScannedInternal(DiskInfo diskInfo, int i) {
        ...
        String string = this.mContext.getString(17040005, new Object[]{diskInfo.getDescription()});
        String string2 = this.mContext.getString(17040004, new Object[]{diskInfo.getDescription()});
    ...
    private Notification onVolumeChecking(VolumeInfo volumeInfo) {
        ...
        return buildNotificationBuilder(volumeInfo, this.mContext.getString(17039972, new Object[]{disk.getDescription()}), this.mContext.getString(17039971, new Object[]{disk.getDescription()})).setCategory("progress").setOngoing(true).build();
    }
    ...
    private Notification onVolumeMounted(VolumeInfo volumeInfo) {
        ...
        String string2 = this.mContext.getString(17039986, new Object[]{disk.getDescription()});
        Notification.Builder priority = buildNotificationBuilder(volumeInfo, string, string2).addAction(new Notification.Action(17302411, this.mContext.getString(17039999), buildUnmountPendingIntent(volumeInfo))).setContentIntent(buildBrowsePendingIntent(volumeInfo)).setCategory("sys").setPriority(-1);
    ...
    private Notification onVolumeUnmountable(VolumeInfo volumeInfo) {
        DiskInfo disk = volumeInfo.getDisk();
        return buildNotificationBuilder(volumeInfo, this.mContext.getString(17040001, new Object[]{disk.getDescription()}), this.mContext.getString(17040000, new Object[]{disk.getDescription()})).setContentIntent(buildInitPendingIntent(volumeInfo)).setCategory("err").build();
    }
    ...
    private Notification onVolumeRemoved(VolumeInfo volumeInfo) {
        ...
        DiskInfo disk = volumeInfo.getDisk();
        return buildNotificationBuilder(volumeInfo, this.mContext.getString(17039985, new Object[]{disk.getDescription()}), this.mContext.getString(17039984, new Object[]{disk.getDescription()})).setCategory("err").build();
    }
    ...
    private Notification onVolumeBadRemoval(VolumeInfo volumeInfo) {
        ...
        DiskInfo disk = volumeInfo.getDisk();
        return buildNotificationBuilder(volumeInfo, this.mContext.getString(17039969, new Object[]{disk.getDescription()}), this.mContext.getString(17039968, new Object[]{disk.getDescription()})).setCategory("err").build();
    }
    ...
    public void onMoveProgress(MoveInfo moveInfo, int i, long j) {
        ...
        if (!TextUtils.isEmpty(moveInfo.label)) {
            str = this.mContext.getString(17039978, new Object[]{moveInfo.label});
        } else {
            str = this.mContext.getString(17039981);
        }
        if (j < 0) {
            charSequence = null;
        } else {
        ...
        Notification.Builder ongoing = NotificationCompat.newBuilder(this.mContext, NotificationChannels.STORAGE).setSmallIcon(17302804).setColor(this.mContext.getColor(17170460)).setContentTitle(str).setContentText(charSequence).setContentIntent(pendingIntent).setStyle(new Notification.BigTextStyle().bigText(charSequence)).setVisibility(1).setLocalOnly(true).setCategory("progress").setProgress(100, i, false).setOngoing(true);
    ...
    public void onMoveFinished(MoveInfo moveInfo, int i) {
        ...
        if (i == -100) {
            str = this.mContext.getString(17039980);
            str2 = this.mContext.getString(17039979, new Object[]{bestVolumeDescription});
        } else {
            str = this.mContext.getString(17039977);
            str2 = this.mContext.getString(17039976);
        }
        ...
        Notification.Builder autoCancel = NotificationCompat.newBuilder(this.mContext, NotificationChannels.STORAGE).setSmallIcon(17302804).setColor(this.mContext.getColor(17170460)).setContentTitle(str).setContentText(str2).setContentIntent(pendingIntent).setStyle(new Notification.BigTextStyle().bigText(str2)).setVisibility(1).setLocalOnly(true).setCategory("sys").setAutoCancel(true);
