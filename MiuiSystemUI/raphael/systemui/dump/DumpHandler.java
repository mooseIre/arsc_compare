...
public final class DumpHandler {
    ...
    private final void dumpConfig(PrintWriter printWriter) {
        ...
        printWriter.println(this.context.getResources().getString(C0020R$string.config_systemUIVendorServiceComponent));
        dumpServiceList(printWriter, "global", C0007R$array.config_systemUIServiceComponents);
        dumpServiceList(printWriter, "per-user", C0007R$array.config_systemUIServiceComponentsPerUser);
    }
