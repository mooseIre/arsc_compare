...
public class QSDetail extends LinearLayout {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        FontSizeUtils.updateFontSize(this.mDetailDoneButton, C0011R$dimen.qs_detail_button_text_size);
        FontSizeUtils.updateFontSize(this.mDetailSettingsButton, C0011R$dimen.qs_detail_button_text_size);
    ...
    public void onFinishInflate() {
        ...
        ViewStub viewStub = (ViewStub) this.mQsDetailHeader.findViewById(C0014R$id.toggle_stub);
        ...
        this.mDetailDoneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                qSDetail.announceForAccessibility(((LinearLayout) qSDetail).mContext.getString(C0020R$string.accessibility_desc_quick_settings));
    ...
    public WindowInsets onApplyWindowInsets(WindowInsets windowInsets) {
        ...
        if (cornerCutoutMargins == null) {
            this.mQsDetailHeader.setPaddingRelative(getResources().getDimensionPixelSize(C0011R$dimen.qs_detail_header_padding), getPaddingTop(), getResources().getDimensionPixelSize(C0011R$dimen.qs_detail_header_padding), getPaddingBottom());
        } else {
