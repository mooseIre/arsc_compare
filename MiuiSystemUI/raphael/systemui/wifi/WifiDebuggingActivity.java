...
public class WifiDebuggingActivity extends AlertActivity implements DialogInterface.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        alertParams.mTitle = getString(C0020R$string.wifi_debugging_title);
        alertParams.mMessage = getString(C0020R$string.wifi_debugging_message, new Object[]{stringExtra, this.mBssid});
        alertParams.mPositiveButtonText = getString(C0020R$string.wifi_debugging_allow);
        ...
        checkBox.setText(getString(C0020R$string.wifi_debugging_always));
    ...
    static /* synthetic */ boolean lambda$onCreate$0(View view, MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 1) {
            ...
            Toast.makeText(view.getContext(), C0020R$string.touch_filtered_warning, 0).show();
        }
        return true;
    }
