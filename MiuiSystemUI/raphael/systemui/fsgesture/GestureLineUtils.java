...
public class GestureLineUtils {
    ...
    public static NavigationHandle createAndaddNavigationHandle(RelativeLayout relativeLayout) {
        ...
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(relativeLayout.getContext().getResources().getDimensionPixelSize(C0011R$dimen.navigation_home_handle_width), relativeLayout.getContext().getResources().getDimensionPixelSize(17105336));
