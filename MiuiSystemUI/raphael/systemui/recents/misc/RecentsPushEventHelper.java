...
public class RecentsPushEventHelper {
    ...
    public static void sendExitMultiWindowEvent(String str) {
        HashMap hashMap = new HashMap();
        hashMap.put("multi_window_exitType", str);
        sendEvent("multi_window_exitMultiWindow", hashMap);
    }
    ...
    public static void sendResizeStackEvent(String str) {
        HashMap hashMap = new HashMap();
        hashMap.put("multi_window_position", str);
        sendEvent("multi_window_resizeStack", hashMap);
    }
