...
public abstract class BaseRecentsImpl {
    ...
    public final void onBusEvent(SuperPowerModeChangedEvent superPowerModeChangedEvent) {
        this.mIsSuperPowerMode = superPowerModeChangedEvent.mIsSuperPowerMode;
        NavStubView navStubView = this.mNavStubView;
        if (navStubView != null) {
            navStubView.setIsSuperPowerMode(this.mIsSuperPowerMode);
        }
    }
    ...
    public void showRecents(boolean r7, boolean r8, boolean r9, boolean r10, boolean r11, int r12, boolean r13) {
        ...
        L_0x003b:
            ...
            r7 = 2131822085(0x7f110605, float:1.9276931E38)
    ...
    private void reloadResources() {
        ...
        this.mNavBarHeight = resources.getDimensionPixelSize(17105304);
        this.mNavBarWidth = resources.getDimensionPixelSize(17105309);
