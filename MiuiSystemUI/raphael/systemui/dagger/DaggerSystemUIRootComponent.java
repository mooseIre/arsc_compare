...
public final class DaggerSystemUIRootComponent implements SystemUIRootComponent {
    ...
    /* access modifiers changed from: private */
    public Provider<LightBarController> provideLightBarControllerProvider;
    /* access modifiers changed from: private */
    ...
    private void initialize2(Builder builder) {
        ...
        this.provideBatteryControllerProvider = DoubleCheck.provider(SystemUIDefaultModule_ProvideBatteryControllerFactory.create(this.provideContextProvider, this.enhancedEstimatesImplProvider, this.providePowerManagerProvider, this.providesBroadcastDispatcherProvider, this.provideMainHandlerProvider, create));
        ...
        Provider<Optional<Lazy<StatusBar>>> access$500 = PresentJdkOptionalLazyProvider.of(this.provideStatusBarProvider);
        this.optionalOfLazyOfStatusBarProvider = access$500;
        Provider<ActivityStarterDelegate> provider14 = DoubleCheck.provider(ActivityStarterDelegate_Factory.create(access$500));
    ...
    private void initialize3(Builder builder) {
        ...
        PipAnimationController_Factory create3 = PipAnimationController_Factory.create(this.provideContextProvider, this.pipSurfaceTransactionHelperProvider);
        this.pipAnimationControllerProvider = create3;
        this.pipTaskOrganizerProvider = DoubleCheck.provider(PipTaskOrganizer_Factory.create(this.provideContextProvider, this.pipBoundsHandlerProvider, this.pipSurfaceTransactionHelperProvider, this.provideDividerProvider, this.displayControllerProvider, create3));
        ...
        Provider<Optional<Divider>> access$600 = PresentJdkOptionalInstanceProvider.of(this.provideDividerProvider);
        this.optionalOfDividerProvider = access$600;
        this.overviewProxyServiceProvider = DoubleCheck.provider(OverviewProxyService_Factory.create(this.provideContextProvider, this.provideCommandQueueProvider, this.provideNavigationBarControllerProvider, this.navigationModeControllerProvider, this.notificationShadeWindowControllerProvider, this.provideSysUiStateProvider, this.pipUIProvider, access$600, this.optionalOfLazyOfStatusBarProvider, this.providesBroadcastDispatcherProvider));
        ...
        SystemServicesModule_ProvideWallpaperManagerFactory create4 = SystemServicesModule_ProvideWallpaperManagerFactory.create(this.provideContextProvider);
        this.provideWallpaperManagerProvider = create4;
        this.lockscreenWallpaperProvider = DoubleCheck.provider(LockscreenWallpaper_Factory.create(create4, SystemServicesModule_ProvideIWallPaperManagerFactory.create(), this.keyguardUpdateMonitorProvider, this.dumpManagerProvider, this.provideNotificationMediaManagerProvider, this.provideMainHandlerProvider));
        ...
        DozeLogger_Factory create5 = DozeLogger_Factory.create(provider13);
        this.dozeLoggerProvider = create5;
        Provider<DozeLog> provider14 = DoubleCheck.provider(DozeLog_Factory.create(this.keyguardUpdateMonitorProvider, this.dumpManagerProvider, create5));
        ...
        StatusBarNotificationActivityStarterLogger_Factory create6 = StatusBarNotificationActivityStarterLogger_Factory.create(this.provideNotifInteractionLogBufferProvider);
        this.statusBarNotificationActivityStarterLoggerProvider = create6;
        this.builderProvider4 = DoubleCheck.provider(StatusBarNotificationActivityStarter_Builder_Factory.create(this.provideContextProvider, this.provideCommandQueueProvider, this.provideMainHandlerProvider, this.provideBgHandlerProvider, this.provideUiBackgroundExecutorProvider, this.provideNotificationEntryManagerProvider, this.notifPipelineProvider, this.notifCollectionProvider, this.provideHeadsUpManagerPhoneProvider, this.activityStarterDelegateProvider, this.notificationClickNotifierProvider, this.statusBarStateControllerImplProvider, this.statusBarKeyguardViewManagerProvider, this.provideKeyguardManagerProvider, this.provideIDreamManagerProvider, this.newBubbleControllerProvider, this.assistManagerProvider, this.provideNotificationRemoteInputManagerProvider, this.notificationGroupManagerProvider, this.notificationLockscreenUserManagerImplProvider, this.shadeControllerImplProvider, this.keyguardStateControllerImplProvider, this.miuiNotificationInterruptStateProviderImplProvider, this.provideLockPatternUtilsProvider, this.statusBarRemoteInputCallbackProvider, this.activityIntentHelperProvider, this.featureFlagsProvider, this.provideMetricsLoggerProvider, create6));
        Factory create7 = InstanceFactory.create(this);
        this.systemUIRootComponentProvider = create7;
        this.injectionInflationControllerProvider = DoubleCheck.provider(InjectionInflationController_Factory.create(create7));
        ...
        Provider<SettingsObserverImpl> provider19 = DoubleCheck.provider(SettingsObserverImpl_Factory.create(this.provideContextProvider, this.providesBroadcastDispatcherProvider));
        this.settingsObserverImplProvider = provider19;
        Provider<ControlPanelController> provider20 = DoubleCheck.provider(ControlPanelController_Factory.create(this.provideContextProvider, this.newKeyguardViewMediatorProvider, this.providesBroadcastDispatcherProvider, provider19));
        this.controlPanelControllerProvider = provider20;
        ...
        MediaControllerFactory_Factory create9 = MediaControllerFactory_Factory.create(this.provideContextProvider);
        this.mediaControllerFactoryProvider = create9;
        this.mediaTimeoutListenerProvider = DoubleCheck.provider(MediaTimeoutListener_Factory.create(create9, this.provideMainDelayableExecutorProvider));
        Provider<MediaResumeListener> provider22 = DoubleCheck.provider(MediaResumeListener_Factory.create(this.provideContextProvider, this.providesBroadcastDispatcherProvider, this.provideBackgroundExecutorProvider, this.tunerServiceImplProvider));
        ...
        Provider<TrustManager> provider25 = DoubleCheck.provider(SystemServicesModule_ProvideTrustManagerFactory.create(this.provideContextProvider));
        ...
        Provider<NotificationShadeWindowController> provider27 = DoubleCheck.provider(NotificationShadeWindowController_Factory.create(this.provideContextProvider, this.provideWindowManagerProvider, this.provideIActivityManagerProvider, this.dozeParametersProvider, this.statusBarStateControllerImplProvider, this.provideConfigurationControllerProvider, this.newKeyguardViewMediatorProvider, this.keyguardBypassControllerProvider, this.sysuiColorExtractorProvider, this.dumpManagerProvider));
        ...
        Provider<BubblePersistentRepository> provider28 = DoubleCheck.provider(BubblePersistentRepository_Factory.create(this.provideContextProvider));
    ...
    private void initialize4(Builder builder) {
        ...
        DriveModeControllerImpl_Factory create6 = DriveModeControllerImpl_Factory.create(this.provideContextProvider, this.provideBgLooperProvider, this.provideBackgroundExecutorProvider, this.provideMainExecutorProvider);
    ...
    private void initialize5(Builder builder) {
        ...
        Provider<MiuiQSTileHostInjector> provider5 = DoubleCheck.provider(MiuiQSTileHostInjector_Factory.create(this.provideContextProvider, this.providePluginManagerProvider, this.tunerServiceImplProvider, this.controlPanelControllerProvider, this.superSaveModeControllerProvider, provider4, this.deviceProvisionedControllerImplProvider));
        this.miuiQSTileHostInjectorProvider = provider5;
        Provider<QSTileHost> provider6 = DoubleCheck.provider(QSTileHost_Factory.create(this.provideContextProvider, this.statusBarIconControllerImplProvider, this.qSFactoryImplProvider, this.provideMainHandlerProvider, this.provideBgLooperProvider, this.providePluginManagerProvider, this.tunerServiceImplProvider, this.autoTileManagerProvider, this.dumpManagerProvider, this.providesBroadcastDispatcherProvider, this.optionalOfStatusBarProvider, this.qSLoggerProvider, this.provideUiEventLoggerProvider, this.statusBarStateControllerImplProvider, provider5, this.controlPanelControllerProvider));
        this.qSTileHostProvider = provider6;
        ((DelegateFactory) this.qSTileHostProvider).setDelegatedProvider(provider6);
        this.controlPanelWindowManagerProvider = DoubleCheck.provider(ControlPanelWindowManager_Factory.create(this.provideContextProvider, this.provideStatusBarProvider, this.controlPanelControllerProvider, this.provideHeadsUpManagerPhoneProvider, this.statusBarStateControllerImplProvider));
        Provider<ControlsPluginManager> provider7 = DoubleCheck.provider(ControlsPluginManager_Factory.create());
        this.controlsPluginManagerProvider = provider7;
        this.provideControlCenterProvider = DoubleCheck.provider(ControlCenterModule_ProvideControlCenterFactory.create(this.provideContextProvider, this.controlPanelControllerProvider, this.statusBarIconControllerImplProvider, this.provideExpandInfoControllerProvider, this.activityStarterDelegateProvider, this.provideCommandQueueProvider, this.injectionInflationControllerProvider, this.superSaveModeControllerProvider, this.controlCenterActivityStarterProvider, this.qSTileHostProvider, this.controlPanelWindowManagerProvider, this.provideStatusBarProvider, provider7, this.providesBroadcastDispatcherProvider, this.provideConfigurationControllerProvider));
        Provider<PackageEventController> provider8 = DoubleCheck.provider(PackageEventController_Factory.create(this.provideContextProvider, this.provideMainHandlerProvider));
        this.packageEventControllerProvider = provider8;
        this.miuiWallpaperZoomOutServiceProvider = DoubleCheck.provider(MiuiWallpaperZoomOutService_Factory.create(this.provideContextProvider, this.provideStatusBarProvider, this.deviceProvisionedControllerImplProvider, this.providesBroadcastDispatcherProvider, provider8));
        ...
        Provider<PanelExpansionObserver> provider9 = DoubleCheck.provider(PanelExpansionObserver_Factory.create());
        this.panelExpansionObserverProvider = provider9;
        this.miuiGxzwPolicyProvider = DoubleCheck.provider(MiuiGxzwPolicy_Factory.create(provider9, this.statusBarStateControllerImplProvider, this.provideStatusBarProvider));
        ...
        Provider<OLEDScreenHelper> provider10 = DoubleCheck.provider(OLEDScreenHelper_Factory.create(this.provideContextProvider, this.screenLifecycleProvider, this.provideConfigurationControllerProvider, this.dumpManagerProvider, this.provideNavigationBarControllerProvider, this.superStatusBarViewFactoryProvider));
        ...
        Provider<ContextComponentResolver> provider11 = DoubleCheck.provider(ContextComponentResolver_Factory.create(this.mapOfClassOfAndProviderOfActivityProvider, this.mapOfClassOfAndProviderOfServiceProvider, this.mapOfClassOfAndProviderOfSystemUIProvider, this.mapOfClassOfAndProviderOfRecentsImplementationProvider, build));
        this.contextComponentResolverProvider = provider11;
        ((DelegateFactory) this.contextComponentResolverProvider).setDelegatedProvider(provider11);
        ...
        ForegroundServiceLifetimeExtender_Factory create2 = ForegroundServiceLifetimeExtender_Factory.create(this.notificationInteractionTrackerProvider, this.bindSystemClockProvider);
        this.foregroundServiceLifetimeExtenderProvider = create2;
        this.foregroundServiceNotificationListenerProvider = DoubleCheck.provider(ForegroundServiceNotificationListener_Factory.create(this.provideContextProvider, this.foregroundServiceControllerProvider, this.provideNotificationEntryManagerProvider, this.notifPipelineProvider, create2, this.bindSystemClockProvider));
        ...
        this.cloudDataManagerProvider = DoubleCheck.provider(CloudDataManager_Factory.create(this.provideContextProvider, this.dumpManagerProvider));
        this.eventTrackerProvider = DoubleCheck.provider(EventTracker_Factory.create(this.provideContextProvider));
        this.appIconsManagerProvider = DoubleCheck.provider(AppIconsManager_Factory.create(this.provideContextProvider));
        this.notificationStatProvider = DoubleCheck.provider(NotificationStat_Factory.create(this.provideContextProvider, this.provideNotificationEntryManagerProvider, this.notificationGroupManagerProvider, this.provideHeadsUpManagerPhoneProvider, this.statusBarStateControllerImplProvider, this.keyguardStateControllerImplProvider, this.eventTrackerProvider));
        ...
        this.keyguardNotificationControllerProvider = DoubleCheck.provider(KeyguardNotificationController_Factory.create(this.provideContextProvider, this.provideNotificationEntryManagerProvider, this.notificationGroupManagerProvider, this.keyguardStateControllerImplProvider));
        this.notificationSettingsManagerProvider = DoubleCheck.provider(NotificationSettingsManager_Factory.create(this.provideContextProvider, this.cloudDataManagerProvider));
        ...
        Provider<KeyguardUpdateMonitorInjector> provider12 = DoubleCheck.provider(KeyguardUpdateMonitorInjector_Factory.create(this.provideContextProvider, this.superSaveModeControllerProvider));
        this.keyguardUpdateMonitorInjectorProvider = provider12;
        this.notificationSensitiveControllerProvider = DoubleCheck.provider(NotificationSensitiveController_Factory.create(this.provideContextProvider, this.miuiFaceUnlockManagerProvider, this.keyguardUpdateMonitorProvider, provider12, this.userSwitcherControllerProvider, this.provideNotificationViewHierarchyManagerProvider));
        ...
        Provider<ModalRowInflater> provider13 = DoubleCheck.provider(ModalRowInflater_Factory.create(this.notificationContentInflaterProvider, this.provideNotificationRemoteInputManagerProvider));
        this.modalRowInflaterProvider = provider13;
        Provider<ModalController> provider14 = DoubleCheck.provider(ModalController_Factory.create(this.provideContextProvider, this.provideStatusBarProvider, provider13));
        this.modalControllerProvider = provider14;
        this.appMiniWindowManagerProvider = DoubleCheck.provider(AppMiniWindowManager_Factory.create(this.provideContextProvider, this.provideDividerProvider, this.provideHeadsUpManagerPhoneProvider, this.provideMainHandlerProvider, provider14, this.notificationSettingsManagerProvider));
    ...
    private void initialize6(Builder builder) {
        ...
        Provider<RepeatableExecutor> provider2 = DoubleCheck.provider(ConcurrencyModule_ProvideBackgroundRepeatableExecutorFactory.create(this.provideBackgroundDelayableExecutorProvider));
        this.provideBackgroundRepeatableExecutorProvider = provider2;
        this.seekBarViewModelProvider = SeekBarViewModel_Factory.create(provider2);
        Provider<MiuiMediaTransferManager> provider3 = DoubleCheck.provider(MiuiMediaTransferManager_Factory.create(this.provideContextProvider));
        this.miuiMediaTransferManagerProvider = provider3;
        this.miuiMediaControlPanelProvider = MiuiMediaControlPanel_Factory.create(this.provideContextProvider, this.provideBackgroundExecutorProvider, this.activityStarterDelegateProvider, this.mediaViewControllerProvider, this.seekBarViewModelProvider, provider3);
        ...
        SystemServicesModule_ProvideMediaRouter2ManagerFactory create = SystemServicesModule_ProvideMediaRouter2ManagerFactory.create(this.provideContextProvider);
        this.provideMediaRouter2ManagerProvider = create;
        Provider<MediaDeviceManager> provider4 = DoubleCheck.provider(MediaDeviceManager_Factory.create(this.provideContextProvider, this.localMediaManagerFactoryProvider, create, this.provideMainExecutorProvider, this.mediaDataManagerProvider, this.dumpManagerProvider));
        this.mediaDeviceManagerProvider = provider4;
        Provider<MediaDataCombineLatest> provider5 = DoubleCheck.provider(MediaDataCombineLatest_Factory.create(this.mediaDataManagerProvider, provider4));
        this.mediaDataCombineLatestProvider = provider5;
        Provider<MediaDataFilter> provider6 = DoubleCheck.provider(MediaDataFilter_Factory.create(provider5, this.providesBroadcastDispatcherProvider, this.mediaResumeListenerProvider, this.mediaDataManagerProvider, this.notificationLockscreenUserManagerImplProvider, this.provideMainExecutorProvider, this.provideNotificationEntryManagerProvider));
        this.mediaDataFilterProvider = provider6;
        Provider<MediaCarouselController> provider7 = DoubleCheck.provider(MediaCarouselController_Factory.create(this.provideContextProvider, this.miuiMediaControlPanelProvider, this.provideVisualStabilityManagerProvider, this.mediaHostStatesManagerProvider, this.activityStarterDelegateProvider, this.provideMainDelayableExecutorProvider, provider6, this.provideConfigurationControllerProvider, this.falsingManagerProxyProvider));
        this.mediaCarouselControllerProvider = provider7;
        this.mediaHierarchyManagerProvider = DoubleCheck.provider(MediaHierarchyManager_Factory.create(this.provideContextProvider, this.statusBarStateControllerImplProvider, this.keyguardStateControllerImplProvider, this.keyguardBypassControllerProvider, provider7, this.notificationLockscreenUserManagerImplProvider, this.wakefulnessLifecycleProvider));
        ...
        this.keyguardMediaControllerProvider = DoubleCheck.provider(KeyguardMediaController_Factory.create(create2, this.keyguardBypassControllerProvider, this.statusBarStateControllerImplProvider, this.notificationLockscreenUserManagerImplProvider));
        ...
        Provider<PeopleHubDataSourceImpl> provider8 = DoubleCheck.provider(PeopleHubDataSourceImpl_Factory.create(this.provideNotificationEntryManagerProvider, this.notificationPersonExtractorPluginBoundaryProvider, this.provideUserManagerProvider, this.provideLauncherAppsProvider, this.providePackageManagerProvider, this.provideContextProvider, this.provideNotificationListenerProvider, this.provideBackgroundExecutorProvider, this.provideMainExecutorProvider, this.notificationLockscreenUserManagerImplProvider, this.peopleNotificationIdentifierImplProvider));
        this.peopleHubDataSourceImplProvider = provider8;
        Provider<PeopleHubViewModelFactoryDataSourceImpl> provider9 = DoubleCheck.provider(PeopleHubViewModelFactoryDataSourceImpl_Factory.create(this.activityStarterDelegateProvider, provider8));
        this.peopleHubViewModelFactoryDataSourceImplProvider = provider9;
        this.peopleHubViewAdapterImplProvider = DoubleCheck.provider(PeopleHubViewAdapterImpl_Factory.create(provider9));
        Provider<LogBuffer> provider10 = DoubleCheck.provider(LogModule_ProvideNotificationSectionLogBufferFactory.create(this.provideLogcatEchoTrackerProvider, this.dumpManagerProvider));
    ...
    public static final class Builder {
        ...
        /* access modifiers changed from: private */
        public MiuiStatusBarModule miuiStatusBarModule;
    ...
    private final class DependencyInjectorImpl implements Dependency.DependencyInjector {
        ...
        private void initialize() {
            ...
            this.nCSwitchControllerProvider = NCSwitchController_Factory.create(DaggerSystemUIRootComponent.this.provideContextProvider, DaggerSystemUIRootComponent.this.statusBarStateControllerImplProvider, DaggerSystemUIRootComponent.this.controlPanelControllerProvider, DaggerSystemUIRootComponent.this.notificationShadeWindowControllerProvider, DaggerSystemUIRootComponent.this.systemUIStatProvider);
        }
        ...
        private Dependency injectDependency(Dependency dependency) {
            ...
            Dependency_MembersInjector.injectMExpandInfoController(dependency, DoubleCheck.lazy(DaggerSystemUIRootComponent.this.provideExpandInfoControllerProvider));
