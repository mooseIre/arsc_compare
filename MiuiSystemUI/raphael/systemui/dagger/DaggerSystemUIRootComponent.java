...
public final class DaggerSystemUIRootComponent implements SystemUIRootComponent {
    ...
    private void initialize4(Builder builder) {
        ...
        Provider<MiuiFlashlightControllerImpl> provider17 = DoubleCheck.provider(MiuiFlashlightControllerImpl_Factory.create(this.provideContextProvider));
        this.miuiFlashlightControllerImplProvider = provider17;
    ...
    private void initialize5(Builder builder) {
        ...
        Provider<MiuiStatusBarConfigurationListener> provider14 = DoubleCheck.provider(MiuiStatusBarConfigurationListener_Factory.create(this.provideConfigurationControllerProvider, this.provideContextProvider));
