    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            try {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(this, C0022R$style.AlertDialog_Theme_DayNight);
                builder.setCustomTitle(inflate);
                builder.setMessage(str);
                builder.setPositiveButton(C0021R$string.media_projection_action_text, this);
