...
public class MCCUtils {
    public static boolean isShowSpnWhenAirplaneOn(Context context, String str) {
        ...
        return getResourcesForOperation(context, str, true).getBoolean(C0009R$bool.status_bar_show_spn_when_airplane);
    }
    ...
    public static boolean isShowSpnByGidWhenAirplaneOn(Context context, String str, String str2) {
        ...
        String[] stringArray = getResourcesForOperation(context, str, true).getStringArray(C0007R$array.status_bar_show_spn_by_gid_when_airplane);
