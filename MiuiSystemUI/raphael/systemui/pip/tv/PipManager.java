...
public class PipManager implements BasePipManager, PipTaskOrganizer.PipTransitionCallback {
    ...
    public PipManager(Context context, BroadcastDispatcher broadcastDispatcher, PipBoundsHandler pipBoundsHandler, PipTaskOrganizer pipTaskOrganizer, PipSurfaceTransactionHelper pipSurfaceTransactionHelper, Divider divider) {
        ...
        if (!this.mInitialized) {
            ...
            this.mResizeAnimationDuration = context.getResources().getInteger(C0015R$integer.config_pipResizeAnimationDuration);
            ...
            if (sSettingsPackageAndClassNamePairList == null) {
                String[] stringArray = this.mContext.getResources().getStringArray(C0007R$array.tv_pip_settings_class_name);
    ...
    private void loadConfigurationsAndApply(Configuration configuration) {
        ...
        this.mSettingsPipBounds = Rect.unflattenFromString(resources.getString(C0020R$string.pip_settings_bounds));
        this.mMenuModePipBounds = Rect.unflattenFromString(resources.getString(C0020R$string.pip_menu_bounds));
    ...
    static /* synthetic */ void lambda$updatePipVisibility$0(boolean z) {
