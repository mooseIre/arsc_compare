...
public class BubbleManageEducationView extends LinearLayout {
    ...
    public void onFinishInflate() {
        ...
        this.mManageView = findViewById(C0014R$id.manage_education_view);
        this.mTitleTextView = (TextView) findViewById(C0014R$id.user_education_title);
        this.mDescTextView = (TextView) findViewById(C0014R$id.user_education_description);
    ...
    public void setLayoutDirection(int i) {
        ...
        if (getResources().getConfiguration().getLayoutDirection() == 1) {
            this.mManageView.setBackgroundResource(C0012R$drawable.bubble_stack_user_education_bg_rtl);
            this.mTitleTextView.setGravity(5);
            this.mDescTextView.setGravity(5);
            return;
        }
        this.mManageView.setBackgroundResource(C0012R$drawable.bubble_stack_user_education_bg);
