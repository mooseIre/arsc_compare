...
public class BubbleOverflow implements BubbleViewProvider {
    ...
    public void setUpOverflow(ViewGroup viewGroup, BubbleStackView bubbleStackView) {
        updateDimensions();
        BubbleExpandedView bubbleExpandedView = (BubbleExpandedView) this.mInflater.inflate(C0016R$layout.bubble_expanded_view, viewGroup, false);
    ...
    public void updateDimensions() {
        this.mBitmapSize = this.mContext.getResources().getDimensionPixelSize(C0011R$dimen.bubble_bitmap_size);
        this.mIconBitmapSize = this.mContext.getResources().getDimensionPixelSize(C0011R$dimen.bubble_overflow_icon_bitmap_size);
    ...
    public void updateIcon(Context context, ViewGroup viewGroup) {
        ...
        this.mInflater = from;
        BadgedImageView badgedImageView = (BadgedImageView) from.inflate(C0016R$layout.bubble_overflow_button, viewGroup, false);
        this.mOverflowBtn = badgedImageView;
        badgedImageView.setContentDescription(this.mContext.getResources().getString(C0020R$string.bubble_overflow_button_content_description));
        ...
        ColorDrawable colorDrawable = new ColorDrawable(resources.getColor(C0010R$color.bubbles_light));
        if ((resources.getConfiguration().uiMode & 48) == 32) {
            colorDrawable = new ColorDrawable(resources.getColor(C0010R$color.bubbles_dark));
        }
