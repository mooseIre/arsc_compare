...
public class SystemUIFactory {
    ...
    public static void createFromConfig(Context context) {
        if (mFactory == null) {
            String string = context.getString(C0020R$string.config_systemUIFactoryComponent);
    ...
    public String[] getSystemUIServiceComponents(Resources resources) {
        return resources.getStringArray(C0007R$array.config_systemUIServiceComponents);
    }

    public String[] getSystemUIServiceComponentsPerUser(Resources resources) {
        return resources.getStringArray(C0007R$array.config_systemUIServiceComponentsPerUser);
    }
