...
class GlobalActionsDialog implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener {
    ...
    public GlobalActionsDialog(Context context, GlobalActions.GlobalActionsManager globalActionsManager) {
        ...
        this.mHasVibrator = z;
        this.mShowSilentToggle = !this.mContext.getResources().getBoolean(17891562);
    ...
    private ActionsDialog createDialog() {
        ...
        this.mAirplaneModeOn = new ToggleAction(17302456, 17302458, 17040120, 17040119, 17040118) {
        ...
        String[] stringArray = this.mContext.getResources().getStringArray(17236030);
    ...
    private Action getSettingsAction() {
        return new SinglePressAction(17302809, 17040112) {
            public boolean showBeforeProvisioning() {
                return true;
            }
    ...
    private Action getEmergencyAction() {
        return new SinglePressAction(17302205, 17040104) {
            public boolean showBeforeProvisioning() {
                return true;
            }
    ...
    private Action getAssistAction() {
        return new SinglePressAction(17302286, 17040102) {
            public boolean showBeforeProvisioning() {
                return true;
            }
    ...
    private Action getVoiceAssistAction() {
        return new SinglePressAction(17302849, 17040116) {
            public boolean showBeforeProvisioning() {
                return true;
            }
    ...
    private Action getLockdownAction() {
        return new SinglePressAction(17301551, 17040106) {
            public boolean showBeforeProvisioning() {
                return false;
            }
        ...
        if (userManager.isUserSwitcherEnabled()) {
            ...
            for (final UserInfo userInfo : users) {
                if (userInfo.supportsSwitchToByUser()) {
                    ...
                    sb.append(str2);
                    sb.append(z ? " ✔" : "");
                    arrayList.add(new SinglePressAction(17302682, createFromPath, sb.toString()) {
                        public boolean showBeforeProvisioning() {
                            return false;
                        }
    ...
    private class SilentModeToggleAction extends ToggleAction {
        ...
        public SilentModeToggleAction() {
            super(17302307, 17302306, 17040115, 17040114, 17040113);
        }
