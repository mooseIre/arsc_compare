...
public final class MiuiActivityLaunchAnimator extends ActivityLaunchAnimator {
    ...
    public final ActivityLaunchAnimator.Callback mCallback;
    /* access modifiers changed from: private */
    public int mClosingActivityType;
    /* access modifiers changed from: private */
    ...
    /* compiled from: MiuiActivityLaunchAnimator.kt */
    private static final class HeadsUpExpandAnimationParameters extends ActivityLaunchAnimator.ExpandAnimationParameters {
    ...
    public final class HeadsUpNotificationAnimationRunner extends IRemoteAnimationRunner.Stub {
        ...
        /* access modifiers changed from: private */
        public boolean mIsFullScreenLaunch;
        private final float mNotificationCornerRadius;
        /* access modifiers changed from: private */
        public final HeadsUpExpandAnimationParameters mParams = new HeadsUpExpandAnimationParameters();
        /* access modifiers changed from: private */
        public final ExpandableNotificationRow mSourceNotification;
        ...
        public final void setExpandAnimationRunning(boolean z) {
            ...
            if (!z) {
                ...
                applyParamsToNotification((ActivityLaunchAnimator.ExpandAnimationParameters) null);
                applyParamsToNotificationShade((ActivityLaunchAnimator.ExpandAnimationParameters) null);
            }
            if (z) {
