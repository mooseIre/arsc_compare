...
public class MiuiNotificationDecoratedCustomViewWrapper extends MiuiNotificationCustomViewWrapper {
    ...
    private void changeChildrenHeightAndMargin() {
        ...
        if (findViewById != null && (findViewById.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ...
            marginLayoutParams.height = this.mContext.getResources().getDimensionPixelSize(C0011R$dimen.miui_notification_header_height);
            ...
            if (frameLayout != null && (frameLayout.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
                ...
                marginLayoutParams2.width = this.mContext.getResources().getDimensionPixelSize(C0011R$dimen.miui_notification_header_icon_container_width);
        ...
        if (linearLayout != null && (linearLayout.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ...
            marginLayoutParams3.topMargin = this.mContext.getResources().getDimensionPixelSize(C0011R$dimen.miui_notification_header_content_margin_top);
            marginLayoutParams3.bottomMargin = this.mContext.getResources().getDimensionPixelSize(C0011R$dimen.miui_notification_header_content_margin_bottom);
            linearLayout.setLayoutParams(marginLayoutParams3);
        }
        LinearLayout linearLayout2 = (LinearLayout) this.mView.findViewById(16909385);
        if (linearLayout2 != null && (linearLayout2.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ...
            marginLayoutParams4.topMargin = this.mContext.getResources().getDimensionPixelSize(C0011R$dimen.miui_notification_header_content_margin_top);
