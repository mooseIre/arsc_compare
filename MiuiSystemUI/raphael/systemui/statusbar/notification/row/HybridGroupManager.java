...
public class HybridGroupManager {
    ...
    public void initDimens() {
        ...
        this.mOverflowNumberSize = (float) resources.getDimensionPixelSize(C0011R$dimen.group_overflow_number_size);
        resources.getDimensionPixelSize(C0011R$dimen.group_overflow_number_padding);
    }
    ...
    private HybridNotificationView inflateHybridViewWithStyle(int i, View view, ViewGroup viewGroup) {
        ...
        if (view instanceof ConversationLayout) {
            i2 = C0016R$layout.hybrid_conversation_notification;
        } else {
            i2 = C0016R$layout.hybrid_notification;
        }
    ...
    private TextView inflateOverflowNumber(ViewGroup viewGroup) {
        TextView textView = (TextView) ((LayoutInflater) this.mContext.getSystemService(LayoutInflater.class)).inflate(C0016R$layout.hybrid_overflow_number, viewGroup, false);
    ...
    public TextView bindOverflowNumber(TextView textView, int i, ViewGroup viewGroup) {
        ...
        String string = this.mContext.getResources().getString(C0020R$string.notification_group_overflow_indicator, Integer.valueOf(i));
        if (!string.equals(textView.getText())) {
            textView.setText(string);
        }
        textView.setContentDescription(String.format(this.mContext.getResources().getQuantityString(C0018R$plurals.notification_group_overflow_description, i), Integer.valueOf(i)));
