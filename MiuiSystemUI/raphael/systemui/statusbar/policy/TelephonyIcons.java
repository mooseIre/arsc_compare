...
public class TelephonyIcons {
    ...
    static final int FLIGHT_MODE_ICON = C0012R$drawable.stat_sys_signal_flightmode;
    ...
    static final int ICON_1X = C0012R$drawable.ic_1x_mobiledata;
    static final int ICON_3G = C0012R$drawable.ic_3g_mobiledata;
    static final int ICON_4G = C0012R$drawable.ic_4g_mobiledata;
    static final int ICON_4G_PLUS = C0012R$drawable.ic_4g_plus_mobiledata;
    static final int ICON_5G = C0012R$drawable.ic_5g_mobiledata;
    static final int ICON_5G_BASIC;
    static final int ICON_5G_E = C0012R$drawable.ic_5g_e_mobiledata;
    static final int ICON_5G_PLUS = C0012R$drawable.ic_5g_plus_mobiledata;
    static final int ICON_5G_SA;
    static final int ICON_5G_UWB = C0012R$drawable.ic_5g_uwb_mobiledata;
    static final int ICON_E = C0012R$drawable.ic_e_mobiledata;
    static final int ICON_G = C0012R$drawable.ic_g_mobiledata;
    static final int ICON_H = C0012R$drawable.ic_h_mobiledata;
    static final int ICON_H_PLUS = C0012R$drawable.ic_h_plus_mobiledata;
    static final int ICON_LTE = C0012R$drawable.ic_lte_mobiledata;
    static final int ICON_LTE_PLUS = C0012R$drawable.ic_lte_plus_mobiledata;
    static final Map<String, MobileSignalController.MobileIconGroup> ICON_NAME_TO_ICON;
    static final int ICON_VOWIFI = C0012R$drawable.ic_vowifi;
    static final int ICON_VOWIFI_CALLING = C0012R$drawable.ic_vowifi_calling;
    ...
    public static final int[] TELEPHONY_SIGNAL_STRENGTH = {C0012R$drawable.stat_sys_signal_0, C0012R$drawable.stat_sys_signal_1, C0012R$drawable.stat_sys_signal_2, C0012R$drawable.stat_sys_signal_3, C0012R$drawable.stat_sys_signal_4, C0012R$drawable.stat_sys_signal_5};
    ...
    static {
        int i = C0012R$drawable.ic_5g_mobiledata;
        ICON_5G_SA = i;
        ICON_5G_BASIC = i;
        int[] iArr = AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH;
        CARRIER_NETWORK_CHANGE = new MobileSignalController.MobileIconGroup("CARRIER_NETWORK_CHANGE", null, null, iArr, 0, 0, 0, 0, iArr[0], C0020R$string.carrier_network_change_mode, 0, false, 0);
        int[] iArr2 = AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH;
        THREE_G = new MobileSignalController.MobileIconGroup("3G", null, null, iArr2, 0, 0, 0, 0, iArr2[0], C0020R$string.data_connection_3g, ICON_3G, true, 3);
        ...
        E = new MobileSignalController.MobileIconGroup("E", null, null, iArr5, 0, 0, 0, 0, iArr5[0], C0020R$string.data_connection_edge, ICON_E, false, 2);
        int[] iArr6 = AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH;
        ONE_X = new MobileSignalController.MobileIconGroup("1X", null, null, iArr6, 0, 0, 0, 0, iArr6[0], C0020R$string.data_connection_cdma, ICON_1X, true, 8);
        int[] iArr7 = AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH;
        G = new MobileSignalController.MobileIconGroup("G", null, null, iArr7, 0, 0, 0, 0, iArr7[0], C0020R$string.data_connection_gprs, ICON_G, false, 1);
        int[] iArr8 = AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH;
        H = new MobileSignalController.MobileIconGroup("H", null, null, iArr8, 0, 0, 0, 0, iArr8[0], C0020R$string.data_connection_3_5g, ICON_H, false, 4);
        int[] iArr9 = AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH;
        H_PLUS = new MobileSignalController.MobileIconGroup("H+", null, null, iArr9, 0, 0, 0, 0, iArr9[0], C0020R$string.data_connection_3_5g_plus, ICON_H_PLUS, false, 5);
        int[] iArr10 = AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH;
        FOUR_G = new MobileSignalController.MobileIconGroup("4G", null, null, iArr10, 0, 0, 0, 0, iArr10[0], C0020R$string.data_connection_4g, ICON_4G, true, 6);
        int[] iArr11 = AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH;
        FOUR_G_PLUS = new MobileSignalController.MobileIconGroup("4G+", null, null, iArr11, 0, 0, 0, 0, iArr11[0], C0020R$string.data_connection_4g_plus, ICON_4G_PLUS, true, 7);
        int[] iArr12 = AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH;
        LTE = new MobileSignalController.MobileIconGroup("LTE", null, null, iArr12, 0, 0, 0, 0, iArr12[0], C0020R$string.data_connection_lte, ICON_LTE, true, 6);
        int[] iArr13 = AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH;
        LTE_PLUS = new MobileSignalController.MobileIconGroup("LTE+", null, null, iArr13, 0, 0, 0, 0, iArr13[0], C0020R$string.data_connection_lte_plus, ICON_LTE_PLUS, true, 7);
        int[] iArr14 = AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH;
        LTE_CA_5G_E = new MobileSignalController.MobileIconGroup("5Ge", null, null, iArr14, 0, 0, 0, 0, iArr14[0], C0020R$string.data_connection_5ge_html, ICON_5G_E, true, 10);
        int[] iArr15 = AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH;
        NR_5G = new MobileSignalController.MobileIconGroup("5G", null, null, iArr15, 0, 0, 0, 0, iArr15[0], C0020R$string.data_connection_5g, ICON_5G, true, 10);
        int[] iArr16 = AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH;
        NR_5G_PLUS = new MobileSignalController.MobileIconGroup("5G_PLUS", null, null, iArr16, 0, 0, 0, 0, iArr16[0], C0020R$string.data_connection_5g_plus, ICON_5G_PLUS, true, 10);
        int[] iArr17 = AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH;
        DATA_DISABLED = new MobileSignalController.MobileIconGroup("DataDisabled", null, null, iArr17, 0, 0, 0, 0, iArr17[0], C0020R$string.cell_data_off_content_description, 0, false, 0);
        int[] iArr18 = AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH;
        NOT_DEFAULT_DATA = new MobileSignalController.MobileIconGroup("NotDefaultData", null, null, iArr18, 0, 0, 0, 0, iArr18[0], C0020R$string.not_default_data_content_description, 0, false, 0);
        int[] iArr19 = AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH;
        FIVE_G = new MobileSignalController.MobileIconGroup("5G", null, null, iArr19, 0, 0, 0, 0, iArr19[0], C0020R$string.data_connection_5g, ICON_5G, false, 10);
        int[] iArr20 = AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH;
        FIVE_G_BASIC = new MobileSignalController.MobileIconGroup("5GBasic", null, null, iArr20, 0, 0, 0, 0, iArr20[0], C0020R$string.data_connection_5g_basic, ICON_5G_BASIC, false, 10);
        int[] iArr21 = AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH;
        FIVE_G_UWB = new MobileSignalController.MobileIconGroup("5GUWB", null, null, iArr21, 0, 0, 0, 0, iArr21[0], C0020R$string.data_connection_5g_uwb, ICON_5G_UWB, false, 10);
        int[] iArr22 = AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH;
        FIVE_G_SA = new MobileSignalController.MobileIconGroup("5GSA", null, null, iArr22, 0, 0, 0, 0, iArr22[0], C0020R$string.data_connection_5g_sa, ICON_5G_SA, false, 10);
        ...
        FIVE_G_KR_ON = new MobileSignalController.MobileIconGroup("5GKrOn", null, null, iArr25, 0, 0, 0, 0, iArr25[0], C0020R$string.data_connection_5g_sa, ICON_5G_SA, false, 10);
        int[] iArr26 = AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH;
        FIVE_G_KR_OFF = new MobileSignalController.MobileIconGroup("5GKrOff", null, null, iArr26, 0, 0, 0, 0, iArr26[0], C0020R$string.data_connection_5g_sa, ICON_5G_SA, false, 10);
