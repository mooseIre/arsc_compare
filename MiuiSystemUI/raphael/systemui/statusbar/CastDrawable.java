...
public class CastDrawable extends DrawableWrapper {
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        setDrawable(resources.getDrawable(C0012R$drawable.ic_cast, theme).mutate());
        this.mFillDrawable = resources.getDrawable(C0012R$drawable.ic_cast_connected_fill, theme).mutate();
