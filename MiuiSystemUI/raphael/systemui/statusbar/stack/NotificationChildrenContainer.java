...
public class NotificationChildrenContainer extends ViewGroup {
    ...
    private void initDimens() {
        ...
        if (showGoogleStyle) {
            ...
            i = resources.getDimensionPixelSize(17105333);
        }
        ...
        this.mCollapsedBottomMargin = (float) resources.getDimensionPixelSize(17105329);
        this.mCollapsedButtonPadding = resources.getDimensionPixelSize(R.dimen.notification_collapsed_button_padding);
        this.mContentMarginTop = resources.getDimensionPixelSize(17105333);
        this.mContentMarginEnd = resources.getDimensionPixelSize(17105330);
    ...
    public void recreateNotificationHeader(View.OnClickListener onClickListener) {
        ...
        if (this.mNotificationHeader == null) {
            ...
            this.mNotificationHeader.findViewById(16908908).setVisibility(0);
    ...
    private void recreateLowPriorityHeader(Notification.Builder builder) {
        ...
        if (this.mIsLowPriority) {
            ...
            if (this.mNotificationHeaderLowPriority == null) {
                ...
                this.mNotificationHeaderLowPriority.findViewById(16908908).setVisibility(0);
