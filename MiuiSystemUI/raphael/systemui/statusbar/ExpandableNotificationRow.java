...
public class ExpandableNotificationRow extends ActivatableNotificationView implements PluginListener<NotificationMenuRowPlugin> {
    ...
    private void setIconAnimationRunningForChild(boolean z, View view) {
        if (view != null) {
            ...
            setIconRunning((ImageView) view.findViewById(16909329), z);
        }
    }
    ...
    private void updateLimitsForView(NotificationContentView notificationContentView) {
        ...
        int i2;
        boolean z = true;
        boolean z2 = (notificationContentView.getContractedChild() == null || notificationContentView.getContractedChild().getId() == 16909441) ? false : true;
        ...
        if (notificationContentView.getHeadsUpChild() == null || notificationContentView.getHeadsUpChild().getId() == 16909441) {
            z = false;
        }
        if (!z || !z4) {
    ...
    private void setChronometerRunningForChild(boolean z, View view) {
        if (view != null) {
            View findViewById = view.findViewById(16908817);
