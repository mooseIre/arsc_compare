...
public class StatusBar extends SystemUI implements DemoMode, DragDownHelper.DragDownCallback, ActivityStarter, UnlockMethodCache.OnUnlockMethodChangedListener, OnHeadsUpChangedListener, VisualStabilityManager.Callback, CommandQueue.Callbacks, SilentModeObserverController.SilentModeListener, MiuiActivityLaunchAnimator.Callback, ExpandableNotificationRow.ExpansionLogger, NotificationData.Environment, ShadeController, NotificationInflater.InflationCallback, InCallNotificationView.InCallCallback, NotificationPresenter {
    ...
    public StatusBar() {
        ...
        this.mFaceUnlockCallback = new FaceUnlockCallback() {
            public void onFaceAuthenticated() {
                if (StatusBar.this.mFaceUnlockManager.isShowMessageWhenFaceUnlockSuccess()) {
                    ...
                    boolean access$1300 = StatusBar.this.isAnyProfilePublicMode();
                    StatusBar statusBar = StatusBar.this;
                    statusBar.mStackScroller.setHideSensitive(NotificationUtil.hideNotificationsForFaceUnlock(statusBar.mContext) || access$1300, true);
            ...
            public boolean onClickHandler(final View view, final PendingIntent pendingIntent, final Intent intent) {
                ...
                StatusBar.this.dismissKeyguardThenExecute(new ActivityStarter.OnDismissAction() {
                    public boolean onDismiss() {
                        ...
                        boolean access$9700 = AnonymousClass89.this.superOnClickHandler(view, pendingIntent, intent);
                        if (access$9700) {
        ...
        this.mAllUsersReceiver = new BroadcastReceiver() {
                    ...
                    if (booleanExtra) {
                        new ArrayList(StatusBar.this.mNotificationData.getActiveNotifications()).stream().filter(new Predicate(ConcurrentHashMap.newKeySet()) {
                            ...
                            public final void accept(Object obj) {
                                StatusBar.AnonymousClass91.this.lambda$onReceive$1$StatusBar$91((NotificationData.Entry) obj);
                            }
                        });
                    }
                }
            ...
            public /* synthetic */ void lambda$onReceive$1$StatusBar$91(NotificationData.Entry entry) {
    ...
    public void clearTransient(int[] iArr) {
        try {
            ...
            IWindowManagerCompat.statusBarVisibilityChanged(this.mWindowManagerService, displayId, this.mSystemUiVisibility);
                ...
                public boolean onDismiss() {
                    new Thread() {
                        ...
                        public void run() {
                            ...
                            L_0x0007:
                                com.android.systemui.statusbar.phone.StatusBar$102 r0 = com.android.systemui.statusbar.phone.StatusBar.AnonymousClass102.this     // Catch:{ CanceledException -> 0x0019 }
                            ...
                            L_0x0030:
                                com.android.systemui.statusbar.phone.StatusBar$102 r0 = com.android.systemui.statusbar.phone.StatusBar.AnonymousClass102.this
                                android.app.PendingIntent r0 = r4
                                boolean r0 = r0.isActivity()
                                if (r0 == 0) goto L_0x0043
                                com.android.systemui.statusbar.phone.StatusBar$102 r9 = com.android.systemui.statusbar.phone.StatusBar.AnonymousClass102.this
                            ...
                            L_0x0043:
                                return
                            */
                            throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.statusbar.phone.StatusBar.AnonymousClass102.AnonymousClass1.run():void");
                        }
                    }.start();
