...
public class ScrimController implements ViewTreeObserver.OnPreDrawListener, ColorExtractor.OnColorsChangedListener, Dumpable {
    ...
    private static final int TAG_END_ALPHA = C0014R$id.scrim_alpha_end;
    static final int TAG_KEY_ANIM = C0014R$id.scrim;
    private static final int TAG_START_ALPHA = C0014R$id.scrim_alpha_start;
