...
public final class KeyboardShortcuts {
    ...
    private void loadResources(Context context) {
        ...
        this.mSpecialCharacterNames.put(R$styleable.Constraint_layout_goneMarginLeft, context.getString(C0020R$string.keyboard_key_button_template, "Z"));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_layout_goneMarginRight, context.getString(C0020R$string.keyboard_key_button_template, "L1"));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_layout_goneMarginStart, context.getString(C0020R$string.keyboard_key_button_template, "R1"));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_layout_goneMarginTop, context.getString(C0020R$string.keyboard_key_button_template, "L2"));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_motionProgress, context.getString(C0020R$string.keyboard_key_button_template, "R2"));
        this.mSpecialCharacterNames.put(108, context.getString(C0020R$string.keyboard_key_button_template, "Start"));
        this.mSpecialCharacterNames.put(109, context.getString(C0020R$string.keyboard_key_button_template, "Select"));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_transitionEasing, context.getString(C0020R$string.keyboard_key_button_template, "Mode"));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_visibilityMode, context.getString(C0020R$string.keyboard_key_forward_del));
