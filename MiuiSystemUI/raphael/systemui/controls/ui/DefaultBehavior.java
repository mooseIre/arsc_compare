...
public final class DefaultBehavior implements Behavior {
    ...
    public void bind(@NotNull ControlWithState controlWithState, int i) {
        ...
        if (controlViewHolder != null) {
            ...
            ControlViewHolder.setStatusText$default(controlViewHolder, charSequence, false, 2, (Object) null);
            ControlViewHolder controlViewHolder2 = this.cvh;
            if (controlViewHolder2 != null) {
                ControlViewHolder.applyRenderInfo$packages__apps__MiuiSystemUI__packages__SystemUI__android_common__MiuiSystemUI_core$default(controlViewHolder2, false, i, false, 4, (Object) null);
            } else {
