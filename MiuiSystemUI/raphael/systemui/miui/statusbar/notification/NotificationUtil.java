...
public class NotificationUtil {
    ...
    public static Bitmap loadBitmapFromUri(Context context, MediaMetadata mediaMetadata) {
        ...
        for (String string : new String[]{"android.media.metadata.ALBUM_ART_URI", "android.media.metadata.ART_URI", "android.media.metadata.DISPLAY_ICON_URI"}) {
            String string2 = mediaMetadata.getString(string);
            if (!TextUtils.isEmpty(string2) && (loadBitmapFromUri = loadBitmapFromUri(context, Uri.parse(string2))) != null) {
