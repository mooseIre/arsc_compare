...
public class DataBillInfo extends BaseInfo implements NetworkController.SignalCallback {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:23:0x0077 A[Catch:{ Exception -> 0x0105, all -> 0x0103 }] */
    /* JADX WARNING: Removed duplicated region for block: B:32:0x00c7 A[Catch:{ Exception -> 0x0105, all -> 0x0103 }] */
    /* JADX WARNING: Removed duplicated region for block: B:33:0x00cc A[Catch:{ Exception -> 0x0105, all -> 0x0103 }] */
    ...
    public com.android.systemui.miui.controlcenter.ExpandInfoController.Info getInfoDetail() {
        /*
            ...
            boolean r4 = r3.moveToFirst()     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            if (r4 == 0) goto L_0x0108
            int r4 = r3.getColumnCount()     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            java.lang.String r5 = "DataBillProvider"
            if (r4 <= 0) goto L_0x00fb
            r4 = 0
            r3.move(r4)     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            java.lang.String r6 = "sim_slot"
            int r6 = r3.getColumnIndex(r6)     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            int r6 = r3.getInt(r6)     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            int r7 = r11.mDataSlot     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            if (r6 != r7) goto L_0x00fb
            java.lang.String r6 = "bill_name"
            int r6 = r3.getColumnIndex(r6)     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            java.lang.String r6 = r3.getString(r6)     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            r1.title = r6     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            java.lang.String r6 = "bill_value"
            int r6 = r3.getColumnIndex(r6)     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            java.lang.String r6 = r3.getString(r6)     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            r1.status = r6     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            java.lang.String r6 = r1.title     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            boolean r6 = android.text.TextUtils.isEmpty(r6)     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            r7 = 1
            if (r6 == 0) goto L_0x0069
            java.lang.String r6 = r1.status     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            boolean r6 = android.text.TextUtils.isEmpty(r6)     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
        ...
        L_0x0069:
            r6 = r7
        L_0x006a:
            r1.available = r6     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            int r6 = r3.getColumnIndex(r0)     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            int r6 = r3.getInt(r6)     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            r8 = -1
            if (r6 == r8) goto L_0x0078
            r4 = r7
        L_0x0078:
            r1.initialized = r4     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            r4.<init>()     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            java.lang.String r6 = "packageType:"
            r4.append(r6)     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            int r0 = r3.getColumnIndex(r0)     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            int r0 = r3.getInt(r0)     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            r4.append(r0)     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            java.lang.String r0 = r4.toString()     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            android.util.Log.d(r5, r0)     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            java.lang.String r0 = "bill_unit"
            int r0 = r3.getColumnIndex(r0)     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            java.lang.String r0 = r3.getString(r0)     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            r1.unit = r0     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
        ...
        L_0x00bf:
            r0 = move-exception
            r0.printStackTrace()     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
        L_0x00c3:
            android.graphics.Bitmap r0 = r1.icon     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            if (r0 != 0) goto L_0x00cc
            android.graphics.Bitmap r0 = r11.mBpBitmap     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            r1.icon = r0     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            goto L_0x00d0
        L_0x00cc:
            android.graphics.Bitmap r0 = r1.icon     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            r11.mBpBitmap = r0     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
        L_0x00d0:
        ...
        L_0x00f7:
            r11 = move-exception
            r11.printStackTrace()     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
        L_0x00fb:
            java.lang.String r11 = r1.toString()     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            android.util.Log.d(r5, r11)     // Catch:{ Exception -> 0x0105, all -> 0x0103 }
            goto L_0x0108
        L_0x0103:
            r11 = move-exception
            goto L_0x011b
        ...
        L_0x0111:
            r11 = move-exception
        L_0x0112:
            r11.printStackTrace()     // Catch:{ all -> 0x010e }
