...
public class DataBillInfo extends BaseInfo implements NetworkController.SignalCallback {
    ...
    public com.android.systemui.miui.controlcenter.ExpandInfoController.Info getInfoDetail() {
        /*
            ...
            boolean r3 = r2.moveToFirst()     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            if (r3 == 0) goto L_0x00f4
            r3 = 0
            r4 = r3
        L_0x0023:
            int r5 = r2.getColumnCount()     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            if (r4 >= r5) goto L_0x00e5
            r2.move(r4)     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            java.lang.String r5 = "sim_slot"
            int r5 = r2.getColumnIndex(r5)     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            int r5 = r2.getInt(r5)     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            int r6 = r10.mDataSlot     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            if (r5 != r6) goto L_0x00e1
            java.lang.String r4 = "package_type"
            int r4 = r2.getColumnIndex(r4)     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            int r4 = r2.getInt(r4)     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            java.lang.String r5 = "bill_name"
            int r5 = r2.getColumnIndex(r5)     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            java.lang.String r5 = r2.getString(r5)     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            r0.title = r5     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            java.lang.String r5 = "bill_value"
            int r5 = r2.getColumnIndex(r5)     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            java.lang.String r5 = r2.getString(r5)     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            r0.status = r5     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            java.lang.String r5 = r0.title     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            boolean r5 = android.text.TextUtils.isEmpty(r5)     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            r6 = 1
            if (r5 == 0) goto L_0x0071
            java.lang.String r5 = r0.status     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            boolean r5 = android.text.TextUtils.isEmpty(r5)     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
        ...
        L_0x0071:
            r5 = r6
        L_0x0072:
            r0.available = r5     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            r5 = -1
            if (r4 == r5) goto L_0x0078
            r3 = r6
        L_0x0078:
            r0.initialized = r3     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            java.lang.String r3 = "bill_unit"
            int r3 = r2.getColumnIndex(r3)     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            java.lang.String r3 = r2.getString(r3)     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            r0.unit = r3     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
        ...
        L_0x00a3:
            r3 = move-exception
            r3.printStackTrace()     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
        L_0x00a7:
            android.graphics.Bitmap r3 = r0.icon     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            if (r3 != 0) goto L_0x00b0
            android.graphics.Bitmap r3 = r10.mBpBitmap     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            r0.icon = r3     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            goto L_0x00b4
        L_0x00b0:
            android.graphics.Bitmap r3 = r0.icon     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            r10.mBpBitmap = r3     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
        L_0x00b4:
        ...
        L_0x00dc:
            r10 = move-exception
            r10.printStackTrace()     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            goto L_0x00e5
        L_0x00e1:
            int r4 = r4 + 1
            goto L_0x0023
        L_0x00e5:
            ...
            java.lang.String r1 = r0.toString()     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            android.util.Log.d(r10, r1)     // Catch:{ Exception -> 0x00f1, all -> 0x00ef }
            goto L_0x00f4
        L_0x00ef:
            r10 = move-exception
            goto L_0x0107
        ...
        L_0x00fd:
            r10 = move-exception
        L_0x00fe:
            r10.printStackTrace()     // Catch:{ all -> 0x00fa }
