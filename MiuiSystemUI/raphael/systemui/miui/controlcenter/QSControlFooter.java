...
public class QSControlFooter extends LinearLayout implements View.OnClickListener, DialogInterface.OnClickListener {
    ...
    public void updateResources() {
        this.mFooterText.setTextAppearance(R.style.TextAppearance_QSControl_FooterText);
        this.mFooterIcon.getDrawable().setTint(this.mContext.getColor(R.color.qs_control_footer_icon_color));
    }
    ...
    public void handleRefreshState() {
        ...
        int i = (hasCACertInCurrentUser || hasCACertInWorkProfile || isNetworkLoggingEnabled) ? R.drawable.ic_qs_footer_managed : (primaryVpnName == null && workProfileVpnName == null) ? R.drawable.ic_info_outline : R.drawable.ic_qs_vpn;
    ...
    public CharSequence getVpnMessage(boolean z, boolean z2, String str, String str2) {
        ...
        if (z) {
            if (str == null || str2 == null) {
                ...
                objArr[0] = str;
                spannableStringBuilder.append(context.getString(R.string.monitoring_description_named_vpn, objArr));
            } else {
