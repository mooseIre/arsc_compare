...
public class DataUsageInfo extends BaseInfo implements NetworkController.SignalCallback {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x006e, code lost:
        if (r2.getInt(r2.getColumnIndex("package_type")) == -1) goto L_0x0071;
     */
    ...
    public com.android.systemui.miui.controlcenter.ExpandInfoController.Info getInfoDetail() {
        /*
            ...
            boolean r3 = r2.moveToFirst()     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            if (r3 == 0) goto L_0x00e4
            r3 = 0
            r4 = r3
        L_0x0023:
            int r5 = r2.getColumnCount()     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            if (r4 >= r5) goto L_0x00d5
            r2.move(r4)     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            java.lang.String r5 = "sim_slot"
            int r5 = r2.getColumnIndex(r5)     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            int r5 = r2.getInt(r5)     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            int r6 = r10.mDataSlot     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            if (r5 != r6) goto L_0x00d1
            java.lang.String r4 = "traffic_name"
            int r4 = r2.getColumnIndex(r4)     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            java.lang.String r4 = r2.getString(r4)     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            r0.title = r4     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            java.lang.String r4 = "traffic_value"
            int r4 = r2.getColumnIndex(r4)     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            java.lang.String r4 = r2.getString(r4)     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            r0.status = r4     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            java.lang.String r4 = "traffic_unit"
            int r4 = r2.getColumnIndex(r4)     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            java.lang.String r4 = r2.getString(r4)     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            r0.unit = r4     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            java.lang.String r4 = "package_type"
            int r4 = r2.getColumnIndex(r4)     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            int r4 = r2.getInt(r4)     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            r5 = -1
            r6 = 1
            if (r4 == r5) goto L_0x0071
            r3 = r6
        L_0x0071:
            r0.initialized = r3     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            r0.available = r6     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            java.lang.String r3 = "traffic_icon"
            int r3 = r2.getColumnIndex(r3)     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            java.lang.String r3 = r2.getString(r3)     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
        ...
        L_0x0093:
            r3 = move-exception
            r3.printStackTrace()     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
        L_0x0097:
            android.graphics.Bitmap r3 = r0.icon     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            if (r3 != 0) goto L_0x00a0
            android.graphics.Bitmap r3 = r10.mBpBitmap     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            r0.icon = r3     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            goto L_0x00a4
        L_0x00a0:
            android.graphics.Bitmap r3 = r0.icon     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            r10.mBpBitmap = r3     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
        L_0x00a4:
        ...
        L_0x00cc:
            r10 = move-exception
            r10.printStackTrace()     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            goto L_0x00d5
        L_0x00d1:
            int r4 = r4 + 1
            goto L_0x0023
        L_0x00d5:
            ...
            java.lang.String r1 = r0.toString()     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            android.util.Log.d(r10, r1)     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            goto L_0x00e4
        L_0x00df:
            r10 = move-exception
            goto L_0x00f7
        ...
        L_0x00ed:
            r10 = move-exception
        L_0x00ee:
            r10.printStackTrace()     // Catch:{ all -> 0x00ea }
