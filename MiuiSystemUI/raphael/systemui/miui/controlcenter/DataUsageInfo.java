...
public class DataUsageInfo extends BaseInfo implements NetworkController.SignalCallback {
    ...
    public com.android.systemui.miui.controlcenter.ExpandInfoController.Info getInfoDetail() {
        ...
        L_0x0023:
            ...
            int r5 = r2.getColumnIndex(r5)     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            java.lang.String r5 = r2.getString(r5)     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            r0.title = r5     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            java.lang.String r5 = "traffic_value"
            int r5 = r2.getColumnIndex(r5)     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            java.lang.String r5 = r2.getString(r5)     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            r0.status = r5     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            java.lang.String r5 = "traffic_unit"
            int r5 = r2.getColumnIndex(r5)     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            java.lang.String r5 = r2.getString(r5)     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            r0.unit = r5     // Catch:{ Exception -> 0x00e1, all -> 0x00df }
            r5 = -1
            r6 = 1
