...
public class KeyguardClockSwitch extends RelativeLayout {
    ...
    public KeyguardClockSwitch(Context context, AttributeSet attributeSet, StatusBarStateController statusBarStateController, SysuiColorExtractor sysuiColorExtractor, ClockManager clockManager) {
        ...
        clockVisibilityTransition.addTarget(C0014R$id.default_clock_view);
        ...
        clockVisibilityTransition2.addTarget(C0014R$id.default_clock_view_bold);
    ...
    public void onFinishInflate() {
        ...
        this.mClockView = (TextClock) findViewById(C0014R$id.default_clock_view);
        this.mClockViewBold = (TextClock) findViewById(C0014R$id.default_clock_view_bold);
        this.mSmallClockFrame = (FrameLayout) findViewById(C0014R$id.clock_view);
        this.mKeyguardStatusArea = findViewById(C0014R$id.keyguard_status_area);
    }
    ...
    public void setKeyguardShowingHeader(boolean z) {
        if (this.mShowingHeader != z) {
            ...
            if (!hasCustomClock()) {
                float dimensionPixelSize = (float) ((RelativeLayout) this).mContext.getResources().getDimensionPixelSize(C0011R$dimen.widget_small_font_size);
                float dimensionPixelSize2 = (float) ((RelativeLayout) this).mContext.getResources().getDimensionPixelSize(C0011R$dimen.widget_big_font_size);
                ...
                int dimensionPixelSize3 = ((RelativeLayout) this).mContext.getResources().getDimensionPixelSize(z ? C0011R$dimen.widget_vertical_padding_clock : C0011R$dimen.title_clock_padding);
