...
public class HomeUtils {
    ...
    public static java.lang.String getCurrentWallpaperInfo(android.content.Context r9) {
        /*
            r0 = 0
            android.os.UserHandle r1 = android.os.UserHandle.OWNER     // Catch:{ Exception -> 0x0057, all -> 0x0050 }
            android.content.ContentResolver r2 = r9.getContentResolverForUser(r1)     // Catch:{ Exception -> 0x0057, all -> 0x0050 }
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x0057, all -> 0x0050 }
            r9.<init>()     // Catch:{ Exception -> 0x0057, all -> 0x0050 }
            java.lang.String r1 = "content://"
            r9.append(r1)     // Catch:{ Exception -> 0x0057, all -> 0x0050 }
            java.lang.String r1 = HOME_LAUNCHER_SETTINGS_AUTHORITY     // Catch:{ Exception -> 0x0057, all -> 0x0050 }
            r9.append(r1)     // Catch:{ Exception -> 0x0057, all -> 0x0050 }
            java.lang.String r1 = "/"
            r9.append(r1)     // Catch:{ Exception -> 0x0057, all -> 0x0050 }
            java.lang.String r1 = "preference"
            r9.append(r1)     // Catch:{ Exception -> 0x0057, all -> 0x0050 }
            java.lang.String r9 = r9.toString()     // Catch:{ Exception -> 0x0057, all -> 0x0050 }
            android.net.Uri r3 = android.net.Uri.parse(r9)     // Catch:{ Exception -> 0x0057, all -> 0x0050 }
            java.lang.String r9 = "currentWallpaperInfo"
            java.lang.String[] r4 = new java.lang.String[]{r9}     // Catch:{ Exception -> 0x0057, all -> 0x0050 }
            r5 = 0
            r6 = 0
            r7 = 0
            android.database.Cursor r9 = r2.query(r3, r4, r5, r6, r7)     // Catch:{ Exception -> 0x0057, all -> 0x0050 }
