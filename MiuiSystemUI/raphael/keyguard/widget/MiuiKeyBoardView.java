...
public class MiuiKeyBoardView extends FrameLayout implements View.OnClickListener, View.OnTouchListener {
    ...
    public MiuiKeyBoardView(Context context, AttributeSet attributeSet, int i) {
        ...
        View.inflate(context, C0016R$layout.keyboard_letter_board, this);
        View.inflate(this.mContext, C0016R$layout.keyboard_symbol_board, this);
        View.inflate(this.mContext, C0016R$layout.keyboard_number_board, this);
        View.inflate(this.mContext, C0016R$layout.keyboard_key_preview_text, this);
    ...
    public void onFinishInflate() {
        ...
        this.mPaddingTop = resources.getDimensionPixelSize(C0011R$dimen.keyboard_padding_top);
        this.mPaddingLeft = resources.getDimensionPixelSize(C0011R$dimen.keyboard_padding_left);
        AnimationUtils.loadAnimation(getContext(), C0006R$anim.stretch_from_bottom);
        AnimationUtils.loadAnimation(getContext(), C0006R$anim.shrink_to_bottom);
        this.mKeyboardListeners = new ArrayList<>();
        setClipChildren(false);
        setClipToPadding(false);
        this.mPreviewText = (TextView) findViewById(C0014R$id.preview_text);
        FrameLayout frameLayout = (FrameLayout) findViewById(C0014R$id.keyboard_letter);
        this.mLetterBoard = frameLayout;
        frameLayout.setVisibility(0);
        this.mBtnCapsLock = findViewById(C0014R$id.btn_caps_lock);
        this.mBtnLetterDelete = findViewById(C0014R$id.btn_letter_delete);
        this.mBtnToSymbolBoard = findViewById(C0014R$id.btn_shift2symbol);
        this.mBtnToNumberBoard = findViewById(C0014R$id.btn_shift2number);
        this.mBtnLetterSpace = findViewById(C0014R$id.btn_letter_space);
        this.mBtnLetterOK = findViewById(C0014R$id.btn_letter_ok);
        FrameLayout frameLayout2 = (FrameLayout) findViewById(C0014R$id.keyboard_symbol);
        this.mSymbolBoard = frameLayout2;
        frameLayout2.setVisibility(4);
        this.mBtnSymbolDelete = findViewById(C0014R$id.btn_symbol_delete);
        this.mBtnSymbolLock = findViewById(C0014R$id.btn_symbol_lock);
        this.mBtnToLetterBoard = findViewById(C0014R$id.btn_shift2letter);
        this.mBtnSymbolSpace = findViewById(C0014R$id.btn_symbol_space);
        this.mBtnSymbolOK = findViewById(C0014R$id.btn_symbol_ok);
        FrameLayout frameLayout3 = (FrameLayout) findViewById(C0014R$id.keyboard_number);
        this.mNumberBoard = frameLayout3;
        frameLayout3.setVisibility(4);
        this.mBtnNumberDelete = findViewById(C0014R$id.btn_number_delete);
        this.mBtnBack = findViewById(C0014R$id.btn_back);
    ...
    private void calcAndStartShowPreviewAnim(View view) {
        if (view instanceof KeyButton) {
            ...
            this.mPopupViewWidth = (int) this.mContext.getResources().getDimension(C0011R$dimen.keyboard_key_preview_radius);
            this.mPopupViewHeight = (int) this.mContext.getResources().getDimension(C0011R$dimen.keyboard_key_preview_radius);
    ...
    private void shiftSymbolLock() {
        ...
        if (z) {
            this.mBtnSymbolLock.setBackgroundResource(C0012R$drawable.keyboard_lock_pressed_list);
        } else {
            this.mBtnSymbolLock.setBackgroundResource(C0012R$drawable.keyboard_lock_list);
        }
    }
    ...
    private void shiftLetterBoard() {
        ...
        this.mIsUpperMode = z;
        if (z) {
            this.mBtnCapsLock.setBackgroundResource(C0012R$drawable.keyboard_caps_lock_pressed_list);
        } else {
            this.mBtnCapsLock.setBackgroundResource(C0012R$drawable.keyboard_caps_lock_list);
        }
    }
}
