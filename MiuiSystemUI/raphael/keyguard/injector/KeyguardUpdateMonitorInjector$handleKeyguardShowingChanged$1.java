...
public final class KeyguardUpdateMonitorInjector$handleKeyguardShowingChanged$1 extends Lambda implements Function1<MiuiKeyguardUpdateMonitorCallback, Unit> {
    final /* synthetic */ boolean $showing;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    KeyguardUpdateMonitorInjector$handleKeyguardShowingChanged$1(boolean z) {
        super(1);
        this.$showing = z;
    }
    ...
    public final void invoke(@NotNull MiuiKeyguardUpdateMonitorCallback miuiKeyguardUpdateMonitorCallback) {
        ...
        miuiKeyguardUpdateMonitorCallback.onKeyguardShowingChanged(this.$showing);
    }
}
