...
public class WechatPayItem extends IQuickOpenItem {
    ...
    public WechatPayItem(RectF rectF, Region region, Context context) {
        ...
        imageView.setImageResource(C0012R$drawable.gxzw_quick_open_wechat_pay);
    ...
    public String getTitle() {
        return this.mContext.getString(C0020R$string.gxzw_quick_open_wechat_pay);
    }

    @Override // com.android.keyguard.fod.item.IQuickOpenItem
    public String getSubTitle() {
        return this.mContext.getString(C0020R$string.gxzw_quick_open_wechat_pay_sub);
    }
}
