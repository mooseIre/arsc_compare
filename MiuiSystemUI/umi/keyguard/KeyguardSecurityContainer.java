...
public class KeyguardSecurityContainer extends FrameLayout implements KeyguardSecurityView {
    ...
    public void onFinishInflate() {
        ...
        KeyguardSecurityViewFlipper keyguardSecurityViewFlipper = (KeyguardSecurityViewFlipper) findViewById(C0012R$id.view_flipper);
    ...
    private void showDialog(String str, String str2) {
        ...
        AlertDialog create = new AlertDialog.Builder(this.mContext).setTitle(str).setMessage(str2).setCancelable(false).setNeutralButton(C0018R$string.ok, (DialogInterface.OnClickListener) null).create();
    ...
    private void showAlmostAtWipeDialog(int i, int i2, int i3) {
        String str;
        if (i3 == 1) {
            str = this.mContext.getString(C0018R$string.kg_failed_attempts_almost_at_wipe, new Object[]{Integer.valueOf(i), Integer.valueOf(i2)});
        } else if (i3 == 2) {
            str = this.mContext.getString(C0018R$string.kg_failed_attempts_almost_at_erase_profile, new Object[]{Integer.valueOf(i), Integer.valueOf(i2)});
        } else if (i3 != 3) {
            str = null;
        } else {
            str = this.mContext.getString(C0018R$string.kg_failed_attempts_almost_at_erase_user, new Object[]{Integer.valueOf(i), Integer.valueOf(i2)});
        }
    ...
    private void showWipeDialog(int i, int i2) {
        String str;
        if (i2 == 1) {
            str = this.mContext.getString(C0018R$string.kg_failed_attempts_now_wiping, new Object[]{Integer.valueOf(i)});
        } else if (i2 == 2) {
            str = this.mContext.getString(C0018R$string.kg_failed_attempts_now_erasing_profile, new Object[]{Integer.valueOf(i)});
        } else if (i2 != 3) {
            str = null;
        } else {
            str = this.mContext.getString(C0018R$string.kg_failed_attempts_now_erasing_user, new Object[]{Integer.valueOf(i)});
        }
        showDialog((String) null, str);
    }
    ...
    public void showLockoutView(long j) {
        ...
        final TextView textView = (TextView) this.mLockoutView.findViewById(C0012R$id.phone_locked_timeout_id);
    ...
    public void updateCountDown(TextView textView, long j) {
        if (j <= 60) {
            textView.setText(getResources().getQuantityString(C0016R$plurals.phone_locked_timeout_seconds_string, (int) j, new Object[]{Long.valueOf(j)}));
            return;
        }
        textView.setText(getResources().getQuantityString(C0016R$plurals.phone_locked_timeout_minutes_string, ((int) j) / 60, new Object[]{Long.valueOf(j / 60)}));
    }
    ...
    private void loadLockoutView() {
        View inflate = View.inflate(getContext(), C0014R$layout.miui_unlockscreen_lockout, (ViewGroup) null);
        ((ViewGroup) getParent()).addView(inflate);
        View findViewById = inflate.findViewById(C0012R$id.unlockscreen_lockout_id);
        this.mLockoutView = findViewById;
        Button button = (Button) findViewById.findViewById(C0012R$id.foget_password);
        this.mFogetPasswordMethod = this.mLockoutView.findViewById(C0012R$id.forget_password_hint_container);
        this.mFogetPasswordSuggestion = this.mLockoutView.findViewById(C0012R$id.forget_password_suggesstion);
        this.mForgetPasswordMethodBack = (TextView) this.mFogetPasswordMethod.findViewById(C0012R$id.forget_password_method_back);
        this.mForgetPasswordMethodNext = (TextView) this.mFogetPasswordMethod.findViewById(C0012R$id.forget_password_method_next);
        if (getLayoutDirection() == 1) {
            this.mForgetPasswordMethodBack.setBackgroundResource(C0010R$drawable.miui_keyguard_forget_password_suggestion_right);
            this.mForgetPasswordMethodNext.setBackgroundResource(C0010R$drawable.miui_keyguard_forget_password_suggestion_left);
        }
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                ((TextView) KeyguardSecurityContainer.this.mFogetPasswordMethod.findViewById(C0012R$id.forget_password_method_content)).setText(Html.fromHtml(KeyguardSecurityContainer.this.getResources().getString(C0018R$string.phone_locked_foget_password_method_content)));
            }
        });
        ...
        this.mForgetPasswordMethodNext.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                ((TextView) KeyguardSecurityContainer.this.mFogetPasswordSuggestion.findViewById(C0012R$id.forget_password_suggesstion_one)).setText(Html.fromHtml(KeyguardSecurityContainer.this.getResources().getString(C0018R$string.phone_locked_forget_password_suggesstion_one_content), new Html.ImageGetter() {
                    public Drawable getDrawable(String str) {
                        if (str == null) {
                            return null;
                        }
                        Drawable drawable = KeyguardSecurityContainer.this.getResources().getDrawable(C0010R$drawable.miui_keyguard_forget_password_mi);
                        drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
                        return drawable;
                    }
                }, (Html.TagHandler) null));
                ((TextView) KeyguardSecurityContainer.this.mFogetPasswordSuggestion.findViewById(C0012R$id.forget_password_suggesstion_two)).setText(Html.fromHtml(KeyguardSecurityContainer.this.getResources().getString(C0018R$string.phone_locked_forget_password_suggesstion_two_content)));
            }
        });
        ...
        this.mFogetPasswordSuggestion.findViewById(C0012R$id.forget_password_suggesstion_ok).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
    ...
    public void setLockoutViewVisible(int i) {
        this.mLockoutView.findViewById(C0012R$id.phone_locked_textview).setVisibility(i);
        this.mLockoutView.findViewById(C0012R$id.phone_locked_timeout_id).setVisibility(i);
        this.mLockoutView.findViewById(C0012R$id.foget_password).setVisibility(i);
    }
    ...
    private int getSecurityViewIdForMode(KeyguardSecurityModel.SecurityMode securityMode) {
        ...
        if (i == 1) {
            return C0012R$id.keyguard_pattern_view;
        }
        if (i == 2) {
            return C0012R$id.keyguard_pin_view;
        }
        if (i == 3) {
            return C0012R$id.keyguard_password_view;
        }
        if (i == 6) {
            return C0012R$id.keyguard_sim_pin_view;
        }
        if (i != 7) {
            return 0;
        }
        return C0012R$id.keyguard_sim_puk_view;
    }

    public int getLayoutIdFor(KeyguardSecurityModel.SecurityMode securityMode) {
        int i = AnonymousClass11.$SwitchMap$com$android$keyguard$KeyguardSecurityModel$SecurityMode[securityMode.ordinal()];
        if (i == 1) {
            return C0014R$layout.keyguard_pattern_view;
        }
        if (i == 2) {
            return C0014R$layout.keyguard_pin_view;
        }
        if (i == 3) {
            return C0014R$layout.keyguard_password_view;
        }
        if (i == 6) {
            return C0014R$layout.keyguard_sim_pin_view;
        }
        if (i != 7) {
            return 0;
        }
        return C0014R$layout.keyguard_sim_puk_view;
    }
