...
abstract class MiuiGxzwAnimItem {
    private static final MiuiGxzwAnimRes DEFALUT_AOD_BACK = new MiuiGxzwAnimRes(new int[]{R.drawable.finger_image_aod}, false, 30);
    private static final MiuiGxzwAnimRes DEFAULT_AOD_ICON = new MiuiGxzwAnimRes(35, "gxzw_aod_icon_anim_", false, 30, false);
    private static final MiuiGxzwAnimRes DEFAULT_LIGHT_BACK = new MiuiGxzwAnimRes(new int[]{R.drawable.finger_image_light}, false, 30);
    private static final MiuiGxzwAnimRes DEFAULT_LIGHT_ICON = new MiuiGxzwAnimRes(35, "gxzw_light_icon_anim_", false, 30, false);
    private static final MiuiGxzwAnimRes DEFAULT_NORMAL_BACK = new MiuiGxzwAnimRes(new int[]{R.drawable.finger_image_normal}, false, 30);
    ...
    public int getFalseTipTranslationY(Context context) {
        return context.getResources().getDimensionPixelOffset(R.dimen.gxzw_normal_false_tip_translation_y);
    }
