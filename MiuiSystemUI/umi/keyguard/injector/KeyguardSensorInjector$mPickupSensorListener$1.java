...
public final class KeyguardSensorInjector$mPickupSensorListener$1 implements SensorEventListener {
    ...
    public void onSensorChanged(@NotNull SensorEvent sensorEvent) {
        ...
        if (fArr == null || fArr[0] != 1.0f) {
            ...
            if ((fArr2[0] == 2.0f || fArr2[0] == 0.0f) && KeyguardSensorInjector.access$getMWakeupByPickUp$p(this.this$0) && this.this$0.getMKeyguardViewMediator().isShowingAndNotOccluded() && !this.this$0.getMKeyguardViewMediator().isLidShowing()) {
            ...
            if (access$getMDisplay$p2 == null) {
                Intrinsics.throwNpe();
                throw null;
            } else if ((access$getMDisplay$p2.getState() != 2 || !((MiuiKeyguardWallpaperControllerImpl) Dependency.get(MiuiKeyguardWallpaperControllerImpl.class)).isAodUsingSuperWallpaper()) && !this.this$0.getMKeyguardViewMediator().isLidShowing()) {
