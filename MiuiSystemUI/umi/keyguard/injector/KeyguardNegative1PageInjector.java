...
public final class KeyguardNegative1PageInjector implements RegionController.Callback {
    ...
    public final void onFinishInflate(@NotNull View view) {
        ...
        View findViewById = view.findViewById(C0012R$id.left_view_bg);
        ...
        this.mKeyguardLeftView = (MiuiKeyguardMoveLeftViewContainer) view.findViewById(C0012R$id.keyguard_left_view);
