...
final class KeyguardUpdateMonitorInjector$onSuperSaveModeChange$1 extends Lambda implements Function1<MiuiKeyguardUpdateMonitorCallback, Unit> {
    final /* synthetic */ boolean $on;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    KeyguardUpdateMonitorInjector$onSuperSaveModeChange$1(boolean z) {
        super(1);
        this.$on = z;
    }
    ...
    public final void invoke(@NotNull MiuiKeyguardUpdateMonitorCallback miuiKeyguardUpdateMonitorCallback) {
        ...
        miuiKeyguardUpdateMonitorCallback.onSuperSavePowerChanged(this.$on);
    }
}
