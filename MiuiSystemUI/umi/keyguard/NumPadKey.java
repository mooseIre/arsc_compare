...
public class NumPadKey extends ViewGroup {
    ...
    public NumPadKey(Context context, AttributeSet attributeSet, int i) {
        this(context, attributeSet, i, C0016R$layout.keyguard_num_pad_key);
    }
    ...
    protected NumPadKey(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        try {
            ...
            TextView textView = (TextView) findViewById(C0014R$id.digit_text);
            this.mDigitText = textView;
            textView.setText(Integer.toString(this.mDigit));
            this.mDigitText.setTextSize(0, getResources().getDimension(C0011R$dimen.lock_screen_numeric_keyboard_number_text_size));
            this.mDigitText.setTextColor(getResources().getColor(C0010R$color.lock_screen_numeric_keyboard_number_text_color));
            ...
            TextView textView2 = (TextView) findViewById(C0014R$id.klondike_text);
            this.mKlondikeText = textView2;
            textView2.setTextSize(0, getResources().getDimension(C0011R$dimen.lock_screen_numeric_keyboard_alphabet_text_size));
            this.mKlondikeText.setTextColor(getResources().getColor(C0010R$color.lock_screen_numeric_keyboard_alphabet_text_color));
            ...
            if (this.mDigit >= 0) {
                if (sKlondike == null) {
                    sKlondike = getResources().getStringArray(C0007R$array.lockscreen_num_pad_klondike);
                }
            ...
            if (!obtainStyledAttributes2.hasValueOrEmpty(13)) {
                setBackground(((ViewGroup) this).mContext.getDrawable(C0012R$drawable.ripple_drawable_pin));
            }
