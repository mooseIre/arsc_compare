...
public class OutlineView extends View {
    ...
    private void updateSizeForScreenSizeChange() {
        ...
        this.mOuterCircleWidth = (int) (6.0f * f);
        int i2 = (int) (4.0f * f);
        this.mOuterSecCircleWidth = i2;
        this.mOuterThrCircleWidth = i2;
        this.mOuterCircleRadius = (int) (378.0f * f);
        this.mOuterSecCircleRadius = (int) (358.0f * f);
        this.mOuterThrCircleRadius = (int) (338.0f * f);
        int i3 = this.mOuterCircleWidth;
        int i4 = this.mOuterCircleRadius;
        this.mOuterCircleCenterX = i3 + i4;
        int i5 = this.mOuterCircleCenterX;
        this.mOuterCircleCenterY = i5;
        this.mViewWidth = (i3 + i4) * 2;
        int i6 = this.mOuterCircleCenterY;
        this.mViewHeight = (i / 2) + i6;
        int i7 = (int) (475.0f * f);
        int i8 = (int) (455.0f * f);
        int i9 = (int) (435.0f * f);
        int i10 = (int) (f * 122.0f);
        int i11 = i10 / 2;
        this.mTrackLeftX = i5 - i11;
        this.mTrackRightX = i5 + i11;
        this.mTrackTopY = i6 + i7;
        this.mSecTrackTopY = i6 + i8;
        this.mThrTrackTopY = i6 + i9;
        float f2 = (float) i7;
        float f3 = ((float) i10) / 2.0f;
        float f4 = (float) i4;
        float f5 = f3 * f3;
        this.mArcCircleRadius = (((f2 * f2) + f5) - (f4 * f4)) / ((f4 - f3) * 2.0f);
        this.mArcAngleDegree = (float) (((double) (((float) Math.atan((double) ((this.mArcCircleRadius + f3) / f2))) * 180.0f)) / 3.141592653589793d);
        float f6 = this.mArcCircleRadius;
        this.mArcLeftCircleCenterX = ((float) this.mTrackLeftX) - f6;
        this.mArcRightCircleCenterX = ((float) this.mTrackRightX) + f6;
        this.mArcCircleCenterY = (float) this.mTrackTopY;
        float f7 = (float) i8;
        float f8 = (float) this.mOuterSecCircleRadius;
        this.mSecArcCircleRadius = (((f7 * f7) + f5) - (f8 * f8)) / ((f8 - f3) * 2.0f);
        this.mSecArcAngleDegree = (float) (((double) (((float) Math.atan((double) ((this.mSecArcCircleRadius + f3) / f7))) * 180.0f)) / 3.141592653589793d);
        float f9 = this.mSecArcCircleRadius;
        this.mSecArcLeftCircleCenterX = ((float) this.mTrackLeftX) - f9;
        this.mSecArcRightCircleCenterX = ((float) this.mTrackRightX) + f9;
        this.mSecArcCircleCenterY = (float) this.mSecTrackTopY;
        float f10 = (float) i9;
        float f11 = (float) this.mOuterThrCircleRadius;
        this.mThrArcCircleRadius = (((f10 * f10) + f5) - (f11 * f11)) / ((f11 - f3) * 2.0f);
        this.mThrArcAngleDegree = (float) (((double) (((float) Math.atan((double) ((this.mThrArcCircleRadius + f3) / f10))) * 180.0f)) / 3.141592653589793d);
        float f12 = this.mThrArcCircleRadius;
        this.mThrArcLeftCircleCenterX = ((float) this.mTrackLeftX) - f12;
        this.mThrArcRightCircleCenterX = ((float) this.mTrackRightX) + f12;
    ...
    private void init(Context context) {
        ...
        this.mOutThrCirclePaint.setAlpha(R.styleable.AppCompatTheme_textAppearanceListItemSecondary);
