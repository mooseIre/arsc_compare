...
public class VolumeDialogImpl implements VolumeDialog, ConfigurationController.ConfigurationListener {
    ...
    public VolumeDialogImpl(Context context) {
        this.mContext = new ContextThemeWrapper(context, C0019R$style.qs_theme);
    ...
    private void initDialog() {
        ...
        attributes.gravity = this.mContext.getResources().getInteger(C0013R$integer.volume_dialog_gravity);
        this.mWindow.setAttributes(attributes);
        this.mWindow.setLayout(-2, -2);
        this.mDialog.setContentView(C0014R$layout.volume_dialog);
        ViewGroup viewGroup = (ViewGroup) this.mDialog.findViewById(C0012R$id.volume_dialog);
        ...
        this.mDialogRowsView = (ViewGroup) this.mDialog.findViewById(C0012R$id.volume_dialog_rows);
        ViewGroup viewGroup2 = (ViewGroup) this.mDialog.findViewById(C0012R$id.ringer);
        this.mRinger = viewGroup2;
        if (viewGroup2 != null) {
            this.mRingerIcon = (ImageButton) viewGroup2.findViewById(C0012R$id.ringer_icon);
            this.mZenIcon = (FrameLayout) this.mRinger.findViewById(C0012R$id.dnd_icon);
        }
        ViewGroup viewGroup3 = (ViewGroup) this.mDialog.findViewById(C0012R$id.odi_captions);
        this.mODICaptionsView = viewGroup3;
        if (viewGroup3 != null) {
            this.mODICaptionsIcon = (CaptionsToggleImageButton) viewGroup3.findViewById(C0012R$id.odi_captions_icon);
        }
        ViewStub viewStub = (ViewStub) this.mDialog.findViewById(C0012R$id.odi_captions_tooltip_stub);
        ...
        this.mSettingsView = this.mDialog.findViewById(C0012R$id.settings_container);
        this.mSettingsIcon = (ImageButton) this.mDialog.findViewById(C0012R$id.settings);
        if (this.mRows.isEmpty()) {
            if (!AudioSystem.isSingleVolume(this.mContext)) {
                int i = C0010R$drawable.ic_volume_accessibility;
                addRow(10, i, i, true, false);
            }
            addRow(3, C0010R$drawable.ic_volume_media, C0010R$drawable.ic_volume_media_mute, true, true);
            if (!AudioSystem.isSingleVolume(this.mContext)) {
                addRow(2, C0010R$drawable.ic_volume_ringer, C0010R$drawable.ic_volume_ringer_mute, true, false);
                addRow(4, C0010R$drawable.ic_alarm, C0010R$drawable.ic_volume_alarm_mute, true, false);
                addRow(0, 17302808, 17302808, false, false);
                int i2 = C0010R$drawable.ic_volume_bt_sco;
                addRow(6, i2, i2, false, false);
                addRow(1, C0010R$drawable.ic_volume_system, C0010R$drawable.ic_volume_system_mute, false, false);
            }
        } else {
            addExistingRows();
        }
    ...
    private void initRow(VolumeRow volumeRow, int i, int i2, int i3, boolean z, boolean z2) {
        ...
        View unused6 = volumeRow.view = this.mDialog.getLayoutInflater().inflate(C0014R$layout.volume_dialog_row, (ViewGroup) null);
        volumeRow.view.setId(volumeRow.stream);
        volumeRow.view.setTag(volumeRow);
        TextView unused7 = volumeRow.header = (TextView) volumeRow.view.findViewById(C0012R$id.volume_row_header);
        volumeRow.header.setId(volumeRow.stream * 20);
        if (i == 10) {
            volumeRow.header.setFilters(new InputFilter[]{new InputFilter.LengthFilter(13)});
        }
        FrameLayout unused8 = volumeRow.dndIcon = (FrameLayout) volumeRow.view.findViewById(C0012R$id.dnd_icon);
        SeekBar unused9 = volumeRow.slider = (SeekBar) volumeRow.view.findViewById(C0012R$id.volume_row_slider);
        ...
        ImageButton unused11 = volumeRow.icon = (ImageButton) volumeRow.view.findViewById(C0012R$id.volume_row_icon);
    ...
    public void showCaptionsTooltip() {
        ...
        if (!this.mHasSeenODICaptionsTooltip && (viewStub = this.mODICaptionsTooltipViewStub) != null) {
            ...
            inflate.findViewById(C0012R$id.dismiss).setOnClickListener(new View.OnClickListener() {
                public final void onClick(View view) {
    ...
    public void tryToRemoveCaptionsTooltip() {
        if (this.mHasSeenODICaptionsTooltip && this.mODICaptionsTooltipView != null) {
            ((ViewGroup) this.mDialog.findViewById(C0012R$id.volume_dialog_container)).removeView(this.mODICaptionsTooltipView);
    ...
    private void maybeShowToastH(int i) {
        ...
        if (i2 <= 12) {
            ...
            if (i == 0) {
                ...
                VolumeDialogController.StreamState streamState = this.mState.states.get(2);
                if (streamState != null) {
                    str = this.mContext.getString(C0018R$string.volume_dialog_ringer_guidance_ring, new Object[]{Utils.formatPercentage((long) streamState.level, (long) streamState.levelMax)});
                }
            }
    ...
    public void updateRingerH() {
        ...
        if (this.mRinger != null && (state = this.mState) != null && (streamState = state.states.get(2)) != null) {
            ...
            int i2 = this.mState.ringerModeInternal;
            if (i2 == 0) {
                this.mRingerIcon.setImageResource(C0010R$drawable.ic_volume_ringer_mute);
                this.mRingerIcon.setTag(2);
                addAccessibilityDescription(this.mRingerIcon, 0, this.mContext.getString(C0018R$string.volume_ringer_hint_unmute));
            } else if (i2 != 1) {
                if ((this.mAutomute && streamState.level == 0) || streamState.muted) {
                    z = true;
                }
                if (z2 || !z) {
                    this.mRingerIcon.setImageResource(C0010R$drawable.ic_volume_ringer);
                    if (this.mController.hasVibrator()) {
                        addAccessibilityDescription(this.mRingerIcon, 2, this.mContext.getString(C0018R$string.volume_ringer_hint_vibrate));
                    } else {
                        addAccessibilityDescription(this.mRingerIcon, 2, this.mContext.getString(C0018R$string.volume_ringer_hint_mute));
                    }
                    this.mRingerIcon.setTag(1);
                    return;
                }
                this.mRingerIcon.setImageResource(C0010R$drawable.ic_volume_ringer_mute);
                addAccessibilityDescription(this.mRingerIcon, 2, this.mContext.getString(C0018R$string.volume_ringer_hint_unmute));
                this.mRingerIcon.setTag(2);
            } else {
                this.mRingerIcon.setImageResource(C0010R$drawable.ic_volume_ringer_vibrate);
                addAccessibilityDescription(this.mRingerIcon, 1, this.mContext.getString(C0018R$string.volume_ringer_hint_mute));
    ...
    private void addAccessibilityDescription(View view, int i, final String str) {
        int i2;
        if (i == 0) {
            i2 = C0018R$string.volume_ringer_status_silent;
        } else if (i != 1) {
            i2 = C0018R$string.volume_ringer_status_normal;
        } else {
            i2 = C0018R$string.volume_ringer_status_vibrate;
        }
        ...
        for (int i2 = 0; i2 < state.states.size(); i2++) {
            ...
            if (state.states.valueAt(i2).dynamic) {
                ...
                if (findRow(keyAt) == null) {
                    addRow(keyAt, C0010R$drawable.ic_volume_remote, C0010R$drawable.ic_volume_remote_mute, true, false, true);
                }
            }
        }
    ...
    public CharSequence composeWindowTitle() {
        return this.mContext.getString(C0018R$string.volume_dialog_title, new Object[]{getStreamLabelH(getActiveRow().ss)});
    }
    ...
    private void updateVolumeRowH(VolumeRow volumeRow) {
        ...
        if (state != null && (streamState = state.states.get(volumeRow.stream)) != null) {
            ...
            if (z7) {
                i = C0010R$drawable.ic_volume_ringer_vibrate;
            } else if (z8 || z) {
                i = volumeRow.iconMuteRes;
            } else if (streamState.routedToBluetooth) {
                i = isStreamMuted(streamState) ? C0010R$drawable.ic_volume_media_bt_mute : C0010R$drawable.ic_volume_media_bt;
            } else {
                i = isStreamMuted(streamState) ? volumeRow.iconMuteRes : volumeRow.iconRes;
            }
            volumeRow.icon.setImageResource(i);
            if (i == C0010R$drawable.ic_volume_ringer_vibrate) {
                i7 = 3;
            } else if (!(i == C0010R$drawable.ic_volume_media_bt_mute || i == volumeRow.iconMuteRes)) {
                i7 = (i == C0010R$drawable.ic_volume_media_bt || i == volumeRow.iconRes) ? 1 : 0;
            }
            ...
            if (!z12) {
                ...
                if (z7) {
                    volumeRow.icon.setContentDescription(this.mContext.getString(C0018R$string.volume_stream_content_description_unmute, new Object[]{getStreamLabelH(streamState)}));
                } else if (this.mController.hasVibrator()) {
                    ImageButton access$1300 = volumeRow.icon;
                    Context context = this.mContext;
                    if (this.mShowA11yStream) {
                        i4 = C0018R$string.volume_stream_content_description_vibrate_a11y;
                    } else {
                        i4 = C0018R$string.volume_stream_content_description_vibrate;
                    }
                    ...
                    if (this.mShowA11yStream) {
                        i3 = C0018R$string.volume_stream_content_description_mute_a11y;
                    } else {
                        i3 = C0018R$string.volume_stream_content_description_mute;
                    }
                ...
                if (this.mShowA11yStream) {
                    i2 = C0018R$string.volume_stream_content_description_mute_a11y;
                } else {
                    i2 = C0018R$string.volume_stream_content_description_mute;
                }
    ...
    private final class CustomDialog extends Dialog implements DialogInterface {
        public CustomDialog(Context context) {
            super(context, C0019R$style.qs_theme);
        }
