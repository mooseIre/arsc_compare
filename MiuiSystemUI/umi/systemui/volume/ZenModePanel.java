...
public class ZenModePanel extends FrameLayout {
    ...
    public ZenModePanel(Context context, AttributeSet attributeSet) {
        ...
        this.mZenModeConditionLayoutId = C0014R$layout.zen_mode_condition;
        this.mZenModeButtonLayoutId = C0014R$layout.zen_mode_button;
        if (DEBUG) {
    ...
    public void createZenButtons() {
        SegmentedButtons segmentedButtons = (SegmentedButtons) findViewById(C0012R$id.zen_buttons);
        this.mZenButtons = segmentedButtons;
        segmentedButtons.addButton(C0018R$string.interruption_level_none_twoline, C0018R$string.interruption_level_none_with_warning, 2);
        this.mZenButtons.addButton(C0018R$string.interruption_level_alarms_twoline, C0018R$string.interruption_level_alarms, 3);
        this.mZenButtons.addButton(C0018R$string.interruption_level_priority_twoline, C0018R$string.interruption_level_priority, 1);
    ...
    public void onFinishInflate() {
        ...
        createZenButtons();
        this.mZenIntroduction = findViewById(C0012R$id.zen_introduction);
        this.mZenIntroductionMessage = (TextView) findViewById(C0012R$id.zen_introduction_message);
        View findViewById = findViewById(C0012R$id.zen_introduction_confirm);
        ...
        TextView textView = (TextView) findViewById(C0012R$id.zen_introduction_customize);
        ...
        this.mConfigurableTexts.add(this.mZenIntroductionCustomize, C0018R$string.zen_priority_customize_button);
        this.mZenConditions = (LinearLayout) findViewById(C0012R$id.zen_conditions);
        this.mZenAlarmWarning = (TextView) findViewById(C0012R$id.zen_alarm_warning);
        this.mZenRadioGroup = (RadioGroup) findViewById(C0012R$id.zen_radio_buttons);
        this.mZenRadioGroupContent = (LinearLayout) findViewById(C0012R$id.zen_radio_buttons_content);
        this.mEdit = (ViewGroup) findViewById(C0012R$id.edit_container);
        ...
        View findViewById3 = findViewById(C0012R$id.auto_rule);
    ...
    public void updateWidgets() {
        ...
        if (z) {
            if (z2) {
                i = C0018R$string.zen_priority_introduction;
            } else if (z4) {
                i = C0018R$string.zen_alarms_introduction;
            } else if (this.mVoiceCapable) {
                i = C0018R$string.zen_silence_introduction_voice;
            } else {
                i = C0018R$string.zen_silence_introduction;
            }
    ...
    private String computeAlarmWarningText(boolean z) {
        ...
        if (condition == null || isForever(condition)) {
            i = C0018R$string.zen_alarm_warning_indef;
        } else {
            long tryParseCountdownConditionId = ZenModeConfig.tryParseCountdownConditionId(this.mSessionExitCondition.id);
            i = (tryParseCountdownConditionId <= currentTimeMillis || nextAlarm >= tryParseCountdownConditionId) ? 0 : C0018R$string.zen_alarm_warning;
        }
        if (i == 0) {
            return null;
        }
        ...
        return getResources().getString(i, new Object[]{getResources().getString(z2 ? C0018R$string.alarm_template : C0018R$string.alarm_template_far, new Object[]{DateFormat.format(DateFormat.getBestDateTimePattern(Locale.getDefault(), z2 ? is24HourFormat ? "Hm" : "hma" : is24HourFormat ? "EEEHm" : "EEEhma"), nextAlarm)})});
    }
    ...
    private static String foreverSummary(Context context) {
        return context.getString(17041653);
    }
    ...
    public void announceConditionSelection(ConditionTag conditionTag) {
        ...
        int selectedZen = getSelectedZen(0);
        if (selectedZen == 1) {
            str = this.mContext.getString(C0018R$string.interruption_level_priority);
        } else if (selectedZen == 2) {
            str = this.mContext.getString(C0018R$string.interruption_level_none);
        } else if (selectedZen == 3) {
            str = this.mContext.getString(C0018R$string.interruption_level_alarms);
        } else {
            return;
        }
        announceForAccessibility(this.mContext.getString(C0018R$string.zen_mode_and_condition, new Object[]{str, conditionTag.line1.getText()}));
    }

    /* access modifiers changed from: private */
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0053, code lost:
        r0.mBucketIndex = r5;
        r3 = android.service.notification.ZenModeConfig.toTimeCondition(r0.mContext, r14, r16, android.app.ActivityManager.getCurrentUser(), false);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void onClickTimeButton(android.view.View r20, com.android.systemui.volume.ZenModePanel.ConditionTag r21, boolean r22, int r23) {
        /*
            r19 = this;
            r0 = r19
            r1 = r21
    ...
    private final class ZenPrefs implements SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        private ZenPrefs() {
            this.mNoneDangerousThreshold = ZenModePanel.this.mContext.getResources().getInteger(C0013R$integer.zen_mode_alarm_warning_threshold);
