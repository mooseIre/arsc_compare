...
public class PowerUI extends SystemUI implements CommandQueue.Callbacks {
    ...
    public synchronized void doSkinThermalEventListenerRegistration() {
        ...
        boolean z3 = true;
        boolean z4 = Settings.Global.getInt(this.mContext.getContentResolver(), "show_temperature_warning", this.mContext.getResources().getInteger(C0015R$integer.config_showTemperatureWarning)) != 0;
    ...
    public synchronized void doUsbThermalEventListenerRegistration() {
        ...
        boolean z3 = true;
        boolean z4 = Settings.Global.getInt(this.mContext.getContentResolver(), "show_usb_temperature_alarm", this.mContext.getResources().getInteger(C0015R$integer.config_showUsbPortAlarm)) != 0;
