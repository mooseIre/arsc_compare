...
public class PipMenuActivity extends Activity implements PipManager.Listener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        Animator loadAnimator = AnimatorInflater.loadAnimator(this, C0006R$anim.tv_pip_menu_fade_in_animation);
        this.mFadeInAnimation = loadAnimator;
        loadAnimator.setTarget(this.mPipControlsViewController.getView());
        Animator loadAnimator2 = AnimatorInflater.loadAnimator(this, C0006R$anim.tv_pip_menu_fade_out_animation);
