...
public class PipControlsView extends LinearLayout {
    ...
    public PipControlsView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        ((LayoutInflater) getContext().getSystemService("layout_inflater")).inflate(C0014R$layout.tv_pip_controls, this);
        setOrientation(0);
        setGravity(49);
    }
    ...
    public PipControlButtonView getFullButtonView() {
        return (PipControlButtonView) findViewById(C0012R$id.full_button);
    }

    /* access modifiers changed from: package-private */
    public PipControlButtonView getCloseButtonView() {
        return (PipControlButtonView) findViewById(C0012R$id.close_button);
    }

    /* access modifiers changed from: package-private */
    public PipControlButtonView getPlayPauseButtonView() {
        return (PipControlButtonView) findViewById(C0012R$id.play_pause_button);
    }
}
