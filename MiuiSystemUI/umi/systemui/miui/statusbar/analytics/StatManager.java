...
public class StatManager {
    ...
    private static class MiStatImpl implements Stat {
            ...
            if (!"status_bar_settings_status".equals(str)) {
                ...
                if (list == null || list.isEmpty()) {
                    ...
                    map.forEach(new BiConsumer(miStatParams) {
                        public final /* synthetic */ MiStatParams f$1;
        ...
        /* access modifiers changed from: private */
        /* renamed from: optPut */
        public MiStatParams lambda$track$0(MiStatParams miStatParams, String str, Object obj) {
            if (obj instanceof Integer) {
    ...
    private static class OneTrackImpl implements Stat {
        public Map<String, Object> mDefaultParams;
