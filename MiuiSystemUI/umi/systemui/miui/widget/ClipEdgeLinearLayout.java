...
public class ClipEdgeLinearLayout extends LinearLayout {
    ...
    public ClipEdgeLinearLayout(Context context, AttributeSet attributeSet, int i) {
    ...
    public void dispatchDraw(android.graphics.Canvas r3) {
        ...
        L_0x0026:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.miui.widget.ClipEdgeLinearLayout.dispatchDraw(android.graphics.Canvas):void");
    }

    public void setClipEdge(boolean z) {
        this.mClipEdge = z;
    }
}
