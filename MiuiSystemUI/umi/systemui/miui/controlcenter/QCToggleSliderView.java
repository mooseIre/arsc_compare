...
public class QCToggleSliderView extends RelativeLayout implements ToggleSlider {
    ...
    public QCToggleSliderView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mSeekListener = new SeekBar.OnSeekBarChangeListener() {
            public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                if (QCToggleSliderView.this.mListener != null) {
                    ...
                    access$000.onChanged(qCToggleSliderView, qCToggleSliderView.mTracking, i, false);
                }
            }
            ...
            public void onStartTrackingTouch(SeekBar seekBar) {
                ...
                if (QCToggleSliderView.this.mListener != null) {
                    ...
                    ToggleSlider.Listener access$000 = QCToggleSliderView.this.mListener;
                    QCToggleSliderView qCToggleSliderView = QCToggleSliderView.this;
                    access$000.onChanged(qCToggleSliderView, qCToggleSliderView.mTracking, QCToggleSliderView.this.mSlider.getProgress(), false);
                }
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                if (QCToggleSliderView.this.mListener != null) {
                    ToggleSlider.Listener access$000 = QCToggleSliderView.this.mListener;
                    QCToggleSliderView qCToggleSliderView = QCToggleSliderView.this;
                    access$000.onChanged(qCToggleSliderView, qCToggleSliderView.mTracking, QCToggleSliderView.this.mSlider.getProgress(), true);
        ...
        this.mLow = (ImageView) findViewById(R.id.low);
    ...
    public void updateResources() {
        this.mSlider.setProgressDrawable(this.mContext.getDrawable(R.drawable.qs_control_brightness_toggle_progress));
        this.mLow.setImageDrawable(this.mContext.getDrawable(R.drawable.qs_control_low_brightness));
