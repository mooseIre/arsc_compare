...
public class CCQSIconViewImpl extends QSIconView {
    ...
    public void updateIcon(ImageView imageView, QSTile.State state) {
        ...
        if (drawable2 != null) {
            ...
            if (num == null || num.intValue() != state.state || !Objects.equals(state.icon, imageView.getTag(R.id.qs_icon_tag))) {
                drawable2.mutate();
                ...
                if ((!this.mAnimationEnabled || (i2 = state.state) == 0 || (i == 0 && i2 == 1) || i == state.state) ? false : true) {
                    ...
                    Drawable drawable3 = getResources().getDrawable(R.drawable.ic_cc_qs_bg_inactive);
                    ...
                    int i5 = state.state;
                    if (i5 == 0) {
                        drawable = getResources().getDrawable(R.drawable.ic_cc_qs_bg_unavailable);
                    } else if (i5 == 2) {
                        drawable = getResources().getDrawable(getActiveBgDrawable(state));
                    } else {
                        drawable = getResources().getDrawable(R.drawable.ic_cc_qs_bg_inactive);
                    }
                    if (drawable2 instanceof AnimatedVectorDrawable) {
    ...
    private int getActiveBgDrawable(QSTile.State state) {
        ...
        if (i != 1) {
            return i != 2 ? R.drawable.ic_cc_qs_bg_active_normal : R.drawable.ic_cc_qs_bg_active_auto_brightness;
        }
        return R.drawable.ic_cc_qs_bg_active_battery_related;
    }
