package com.android.systemui.miui.controlcenter.policy;
...
public class QCBrightnessMirrorController {
    ...
    public void showMirror() {
        if (this.mQSBrightness == null) {
            this.mQSBrightness = this.mContent.findViewById(R.id.qs_brightness);
        }
    ...
    public void updateResources() {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(R.dimen.qs_control_brightness_width);
