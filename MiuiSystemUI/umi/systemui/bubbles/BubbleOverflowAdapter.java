...
public class BubbleOverflowAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        LinearLayout linearLayout = (LinearLayout) LayoutInflater.from(viewGroup.getContext()).inflate(C0016R$layout.bubble_overflow_view, viewGroup, false);
        ...
        ((TextView) linearLayout.findViewById(C0014R$id.bubble_view_name)).setTextColor(ensureTextContrast);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        if (title == null) {
            title = this.mContext.getResources().getString(C0020R$string.notification_bubble_title);
        }
        viewHolder.iconView.setContentDescription(this.mContext.getResources().getString(C0020R$string.bubble_content_description_single, title, bubble.getAppName()));
        viewHolder.iconView.setAccessibilityDelegate(new View.AccessibilityDelegate() {
            ...
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, BubbleOverflowAdapter.this.mContext.getResources().getString(C0020R$string.bubble_accessibility_action_add_back)));
            }
        });
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(LinearLayout linearLayout) {
            super(linearLayout);
            this.iconView = (BadgedImageView) linearLayout.findViewById(C0014R$id.bubble_view);
            this.textView = (TextView) linearLayout.findViewById(C0014R$id.bubble_view_name);
        }
    }
}
