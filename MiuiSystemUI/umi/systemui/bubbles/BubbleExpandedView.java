...
public class BubbleExpandedView extends LinearLayout {
    ...
    public void updateDimensions() {
        ...
        this.mMinHeight = resources.getDimensionPixelSize(C0009R$dimen.bubble_expanded_default_height);
        this.mOverflowHeight = resources.getDimensionPixelSize(C0009R$dimen.bubble_overflow_height);
        this.mPointerMargin = resources.getDimensionPixelSize(C0009R$dimen.bubble_pointer_margin);
    }
    ...
    public void onFinishInflate() {
        ...
        Resources resources = getResources();
        this.mPointerView = findViewById(C0012R$id.pointer_view);
        this.mPointerWidth = resources.getDimensionPixelSize(C0009R$dimen.bubble_pointer_width);
        this.mPointerHeight = resources.getDimensionPixelSize(C0009R$dimen.bubble_pointer_height);
        ...
        this.mSettingsIconHeight = getContext().getResources().getDimensionPixelSize(C0009R$dimen.bubble_manage_button_height);
        this.mSettingsIcon = (AlphaOptimizedButton) findViewById(C0012R$id.settings_button);
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(C0009R$dimen.bubble_expanded_view_padding);
    ...
    public void setManageClickListener(View.OnClickListener onClickListener) {
        findViewById(C0012R$id.settings_button).setOnClickListener(onClickListener);
    }
    ...
    public void applyThemeAttrs() {
        ...
        if (i == 16) {
            this.mPointerDrawable.setTint(getResources().getColor(C0008R$color.bubbles_light));
        } else if (i == 32) {
            this.mPointerDrawable.setTint(getResources().getColor(C0008R$color.bubbles_dark));
        }
    ...
    public void update(Bubble bubble) {
        ...
        if (z || (bubble != null && bubble.getKey().equals(this.mBubble.getKey()))) {
            this.mBubble = bubble;
            this.mSettingsIcon.setContentDescription(getResources().getString(C0018R$string.bubbles_settings_button_description, new Object[]{bubble.getAppName()}));
