...
public class BubbleFlyoutView extends FrameLayout {
    ...
    public BubbleFlyoutView(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(C0014R$layout.bubble_flyout, this, true);
        this.mFlyoutTextContainer = (ViewGroup) findViewById(C0012R$id.bubble_flyout_text_container);
        this.mSenderText = (TextView) findViewById(C0012R$id.bubble_flyout_name);
        this.mSenderAvatar = (ImageView) findViewById(C0012R$id.bubble_flyout_avatar);
        this.mMessageText = (TextView) this.mFlyoutTextContainer.findViewById(C0012R$id.bubble_flyout_text);
        Resources resources = getResources();
        this.mFlyoutPadding = resources.getDimensionPixelSize(C0009R$dimen.bubble_flyout_padding_x);
        this.mFlyoutSpaceFromBubble = resources.getDimensionPixelSize(C0009R$dimen.bubble_flyout_space_from_bubble);
        this.mPointerSize = resources.getDimensionPixelSize(C0009R$dimen.bubble_flyout_pointer_size);
        this.mBubbleSize = resources.getDimensionPixelSize(C0009R$dimen.individual_bubble_size);
        int dimensionPixelSize = resources.getDimensionPixelSize(C0009R$dimen.bubble_bitmap_size);
        ...
        this.mFlyoutElevation = resources.getDimensionPixelSize(C0009R$dimen.bubble_flyout_elevation);
