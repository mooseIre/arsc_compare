...
public final class DualToneHandler {
    ...
    public final void setColorsFromContext(@NotNull Context context) {
        Intrinsics.checkParameterIsNotNull(context, "context");
        ContextThemeWrapper contextThemeWrapper = new ContextThemeWrapper(context, Utils.getThemeAttr(context, C0006R$attr.darkIconTheme));
        ContextThemeWrapper contextThemeWrapper2 = new ContextThemeWrapper(context, Utils.getThemeAttr(context, C0006R$attr.lightIconTheme));
        this.darkColor = new Color(Utils.getColorAttrDefaultColor(contextThemeWrapper, C0006R$attr.singleToneColor), Utils.getColorAttrDefaultColor(contextThemeWrapper, C0006R$attr.backgroundColor), Utils.getColorAttrDefaultColor(contextThemeWrapper, C0006R$attr.fillColor));
        this.lightColor = new Color(Utils.getColorAttrDefaultColor(contextThemeWrapper2, C0006R$attr.singleToneColor), Utils.getColorAttrDefaultColor(contextThemeWrapper2, C0006R$attr.backgroundColor), Utils.getColorAttrDefaultColor(contextThemeWrapper2, C0006R$attr.fillColor));
    }
