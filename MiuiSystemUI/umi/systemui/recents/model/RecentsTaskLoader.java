...
public class RecentsTaskLoader {
    ...
    public RecentsTaskLoader(Context context) {
        ...
        int integer = resources.getInteger(R.integer.config_recents_max_icon_count);
        this.mMaxIconCacheSize = integer;
        int i = this.mMaxThumbnailCacheSize;
        Bitmap createBitmap = Bitmap.createBitmap(1, 1, Bitmap.Config.ALPHA_8);
        createBitmap.eraseColor(0);
        Bitmap createBitmap2 = Bitmap.createBitmap(1, 1, Bitmap.Config.ARGB_8888);
        this.mDefaultThumbnail = createBitmap2;
        ...
        this.mThumbnailCache = new TaskKeyLruCache<>(i);
        this.mSnapshotCache = new TaskKeyLruCache<>(i);
