...
public class GlobalActionsPopupMenu extends ListPopupWindow {
    ...
    public GlobalActionsPopupMenu(Context context, boolean z) {
        ...
        setBackgroundDrawable(resources.getDrawable(C0012R$drawable.rounded_bg_full, context.getTheme()));
        this.mIsDropDownMode = z;
        setWindowLayoutType(2020);
        setInputMethodMode(2);
        setModal(true);
        this.mGlobalActionsSidePadding = resources.getDimensionPixelSize(C0011R$dimen.global_actions_side_margin);
        if (!z) {
            this.mMenuVerticalPadding = resources.getDimensionPixelSize(C0011R$dimen.control_menu_vertical_padding);
        }
    }
    ...
    public void show() {
        ...
        if (this.mIsDropDownMode) {
            listView.setDividerHeight(resources.getDimensionPixelSize(C0011R$dimen.control_list_divider));
            listView.setDivider(resources.getDrawable(C0012R$drawable.controls_list_divider_inset));
