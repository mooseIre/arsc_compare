...
public abstract class GlobalActionsLayout extends MultiListLayout {
    ...
    private void setBackgrounds() {
        ...
        HardwareBgDrawable backgroundDrawable2 = getBackgroundDrawable(getResources().getColor(C0010R$color.global_actions_grid_background, null));
        if (backgroundDrawable2 != null) {
            listView.setBackground(backgroundDrawable2);
        }
        if (getSeparatedView() != null && (backgroundDrawable = getBackgroundDrawable(getResources().getColor(C0010R$color.global_actions_separated_background, null))) != null) {
    ...
    public ViewGroup getSeparatedView() {
        return (ViewGroup) findViewById(C0014R$id.separated_button);
    }
