...
public class ScreenshotActionChip extends FrameLayout {
    ...
    public ScreenshotActionChip(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mIconColor = context.getColor(C0008R$color.global_screenshot_button_icon);
    }

    /* access modifiers changed from: protected */
    public void onFinishInflate() {
        this.mIcon = (ImageView) findViewById(C0012R$id.screenshot_action_chip_icon);
        this.mText = (TextView) findViewById(C0012R$id.screenshot_action_chip_text);
    }
