...
public class SwipeHelper implements Gefingerpoken {
    ...
    public SwipeHelper(int i, Callback callback, Context context, FalsingManager falsingManager) {
        ...
        this.mFalsingThreshold = resources.getDimensionPixelSize(C0009R$dimen.swipe_helper_falsing_threshold);
        this.mFadeDependingOnAmountSwiped = resources.getBoolean(C0007R$bool.config_fadeDependingOnAmountSwiped);
