...
public class WindowMagnificationController implements View.OnTouchListener, SurfaceHolder.Callback, MirrorWindowControl.MirrorWindowDelegate {
    ...
    WindowMagnificationController(Context context, MirrorWindowControl mirrorWindowControl) {
        ...
        this.mBorderSize = (int) resources.getDimension(C0011R$dimen.magnification_border_size);
        this.mScale = (float) resources.getInteger(C0015R$integer.magnification_default_scale);
    ...
    private void createOverlayWindow() {
        ...
        layoutParams.setTitle(this.mContext.getString(C0020R$string.magnification_overlay_title));
    ...
    private void createMirrorWindow() {
        WindowManager.LayoutParams layoutParams = new WindowManager.LayoutParams(this.mMagnificationFrame.width() + (this.mBorderSize * 2), this.mMagnificationFrame.height() + ((int) this.mContext.getResources().getDimension(C0011R$dimen.magnification_drag_view_height)) + (this.mBorderSize * 2), 1000, 40, -2);
        layoutParams.gravity = 51;
        ...
        layoutParams.setTitle(this.mContext.getString(C0020R$string.magnification_window_title));
        View inflate = LayoutInflater.from(this.mContext).inflate(C0016R$layout.window_magnifier_view, (ViewGroup) null);
        this.mMirrorView = inflate;
        SurfaceView surfaceView = (SurfaceView) inflate.findViewById(C0014R$id.surface_view);
    ...
    private void addDragTouchListeners() {
        this.mDragView = this.mMirrorView.findViewById(C0014R$id.drag_handle);
        this.mLeftDrag = this.mMirrorView.findViewById(C0014R$id.left_handle);
        this.mTopDrag = this.mMirrorView.findViewById(C0014R$id.top_handle);
        this.mRightDrag = this.mMirrorView.findViewById(C0014R$id.right_handle);
        this.mBottomDrag = this.mMirrorView.findViewById(C0014R$id.bottom_handle);
