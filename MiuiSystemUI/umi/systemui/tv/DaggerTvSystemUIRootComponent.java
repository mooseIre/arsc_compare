...
public final class DaggerTvSystemUIRootComponent implements TvSystemUIRootComponent {
    ...
    private void initialize2(Builder builder) {
        ...
        Provider<CommandQueue> provider2 = DoubleCheck.provider(StatusBarDependenciesModule_ProvideCommandQueueFactory.create(this.contextProvider, provider));
        ...
        Provider<AppOpsControllerImpl> provider5 = DoubleCheck.provider(AppOpsControllerImpl_Factory.create(this.contextProvider, this.provideBgLooperProvider, this.dumpManagerProvider));
        ...
        Provider<DarkIconDispatcherImpl> provider12 = DoubleCheck.provider(DarkIconDispatcherImpl_Factory.create(this.contextProvider, this.provideCommandQueueProvider));
        this.darkIconDispatcherImplProvider = provider12;
        this.lightBarControllerProvider = DoubleCheck.provider(LightBarController_Factory.create(this.contextProvider, provider12, this.provideBatteryControllerProvider, this.navigationModeControllerProvider));
        ...
        Provider<NotificationRoundnessManager> provider13 = DoubleCheck.provider(NotificationRoundnessManager_Factory.create(this.keyguardBypassControllerProvider, this.miuiNotificationSectionsFeatureManagerProvider));
        this.notificationRoundnessManagerProvider = provider13;
        this.pulseExpansionHandlerProvider = DoubleCheck.provider(PulseExpansionHandler_Factory.create(this.contextProvider, this.notificationWakeUpCoordinatorProvider, this.keyguardBypassControllerProvider, this.provideHeadsUpManagerPhoneProvider, provider13, this.statusBarStateControllerImplProvider, this.falsingManagerProxyProvider));
        ...
        Provider<ChannelEditorDialogController> provider14 = DoubleCheck.provider(ChannelEditorDialogController_Factory.create(this.contextProvider, this.provideINotificationManagerProvider, ChannelEditorDialog_Builder_Factory.create()));
        this.channelEditorDialogControllerProvider = provider14;
        this.provideNotificationGutsManagerProvider = DoubleCheck.provider(NotificationsModule_ProvideNotificationGutsManagerFactory.create(this.contextProvider, this.provideVisualStabilityManagerProvider, this.provideStatusBarProvider, this.provideMainHandlerProvider, this.provideBgHandlerProvider, this.provideAccessibilityManagerProvider, this.highPriorityProvider, this.provideINotificationManagerProvider, this.provideLauncherAppsProvider, this.provideShortcutManagerProvider, provider14, this.provideCurrentUserContextTrackerProvider, PriorityOnboardingDialogController_Builder_Factory.create(), this.newBubbleControllerProvider, this.provideUiEventLoggerProvider));
        ...
        Provider<ActivityStarterDelegate> provider16 = DoubleCheck.provider(ActivityStarterDelegate_Factory.create(access$400));
        this.activityStarterDelegateProvider = provider16;
        this.userSwitcherControllerProvider = DoubleCheck.provider(UserSwitcherController_Factory.create(this.contextProvider, this.keyguardStateControllerImplProvider, this.provideMainHandlerProvider, provider16, this.providesBroadcastDispatcherProvider, this.provideUiEventLoggerProvider));
        ...
        Provider<NetworkScoreManager> provider17 = DoubleCheck.provider(SystemServicesModule_ProvideNetworkScoreManagerFactory.create(this.contextProvider));
        this.provideNetworkScoreManagerProvider = provider17;
        this.networkControllerImplProvider = DoubleCheck.provider(NetworkControllerImpl_Factory.create(this.contextProvider, this.provideBgLooperProvider, this.deviceProvisionedControllerImplProvider, this.providesBroadcastDispatcherProvider, this.provideConnectivityManagagerProvider, this.provideTelephonyManagerProvider, this.provideWifiManagerProvider, provider17));
        ...
        Provider<SysUiState> provider18 = DoubleCheck.provider(SystemUIModule_ProvideSysUiStateFactory.create());
        this.provideSysUiStateProvider = provider18;
        this.assistHandleLikeHomeBehaviorProvider = DoubleCheck.provider(AssistHandleLikeHomeBehavior_Factory.create(this.statusBarStateControllerImplProvider, this.wakefulnessLifecycleProvider, provider18));
        ...
        Provider<DisplayController> provider19 = DoubleCheck.provider(DisplayController_Factory.create(this.contextProvider, this.provideMainHandlerProvider, this.provideIWindowManagerProvider));
        this.displayControllerProvider = provider19;
        this.pipBoundsHandlerProvider = DoubleCheck.provider(PipBoundsHandler_Factory.create(this.contextProvider, this.pipSnapAlgorithmProvider, provider19));
    }
    ...
    private void initialize3(Builder builder) {
        ...
        Provider<ControlPanelController> provider20 = DoubleCheck.provider(ControlPanelController_Factory.create(this.contextProvider, this.newKeyguardViewMediatorProvider));
        ...
        delegateFactory3.setDelegatedProvider(provider21);
        ...
        delegateFactory4.setDelegatedProvider(provider30);
    ...
    private void initialize4(Builder builder) {
        ...
        Provider<SettingsObserverImpl> provider15 = DoubleCheck.provider(SettingsObserverImpl_Factory.create(this.contextProvider, this.providesBroadcastDispatcherProvider));
        this.settingsObserverImplProvider = provider15;
        this.superSaveModeControllerProvider = DoubleCheck.provider(SuperSaveModeController_Factory.create(this.contextProvider, provider15));
        ...
        Provider<ManagedProfileControllerImpl> provider16 = DoubleCheck.provider(ManagedProfileControllerImpl_Factory.create(this.contextProvider, this.providesBroadcastDispatcherProvider));
        ...
        Provider<FlashlightControllerImpl> provider17 = DoubleCheck.provider(FlashlightControllerImpl_Factory.create(this.contextProvider));
        ...
        this.paperModeControllerImplProvider = PaperModeControllerImpl_Factory.create(this.contextProvider, this.provideBgLooperProvider, this.providesBroadcastDispatcherProvider);
    }

    private void initialize5(Builder builder) {
        this.paperModeTileProvider = PaperModeTile_Factory.create(this.qSTileHostProvider, this.paperModeControllerImplProvider);
        ...
        this.controlPanelWindowManagerProvider = DoubleCheck.provider(ControlPanelWindowManager_Factory.create(this.contextProvider, this.provideStatusBarProvider, this.controlPanelControllerProvider, this.provideHeadsUpManagerPhoneProvider));
        ...
        Provider<PackageEventController> provider8 = DoubleCheck.provider(PackageEventController_Factory.create(this.contextProvider, this.provideMainHandlerProvider));
        this.packageEventControllerProvider = provider8;
        this.miuiWallpaperZoomOutServiceProvider = DoubleCheck.provider(MiuiWallpaperZoomOutService_Factory.create(this.contextProvider, this.provideStatusBarProvider, this.deviceProvisionedControllerImplProvider, this.providesBroadcastDispatcherProvider, provider8));
        ...
        this.miuiVendorServicesProvider = DoubleCheck.provider(MiuiVendorServices_Factory.create(this.contextProvider, this.miuiWallpaperZoomOutServiceProvider, this.miuiHeadsUpPolicyProvider, this.miuiGxzwPolicyProvider, this.notificationAlertControllerProvider, this.notificationDynamicFpsControllerProvider, provider10));
        ...
        this.foregroundServiceNotificationListenerProvider = DoubleCheck.provider(ForegroundServiceNotificationListener_Factory.create(this.contextProvider, this.foregroundServiceControllerProvider, this.provideNotificationEntryManagerProvider, this.notifPipelineProvider, create2, this.bindSystemClockProvider));
        ...
        this.cloudDataManagerProvider = DoubleCheck.provider(CloudDataManager_Factory.create(this.contextProvider, this.dumpManagerProvider));
        ...
        this.keyguardNotificationControllerProvider = DoubleCheck.provider(KeyguardNotificationController_Factory.create(this.contextProvider, this.provideNotificationEntryManagerProvider, this.notificationGroupManagerProvider, this.keyguardStateControllerImplProvider));
        this.notificationSettingsManagerProvider = DoubleCheck.provider(NotificationSettingsManager_Factory.create(this.contextProvider, this.cloudDataManagerProvider));
        ...
        Provider<KeyguardUpdateMonitorInjector> provider12 = DoubleCheck.provider(KeyguardUpdateMonitorInjector_Factory.create(this.contextProvider, this.superSaveModeControllerProvider));
        this.keyguardUpdateMonitorInjectorProvider = provider12;
        this.notificationSensitiveControllerProvider = DoubleCheck.provider(NotificationSensitiveController_Factory.create(this.contextProvider, this.miuiFaceUnlockManagerProvider, this.keyguardUpdateMonitorProvider, provider12, this.userSwitcherControllerProvider, this.provideNotificationViewHierarchyManagerProvider));
        ...
        this.appMiniWindowManagerProvider = DoubleCheck.provider(AppMiniWindowManager_Factory.create(this.contextProvider, this.provideDividerProvider, this.provideHeadsUpManagerPhoneProvider, this.notificationSettingsManagerProvider));
        ...
        this.modalControllerProvider = DoubleCheck.provider(ModalController_Factory.create(this.contextProvider, this.provideStatusBarProvider, provider13));
        ...
        this.mediaViewControllerProvider = MediaViewController_Factory.create(this.contextProvider, this.provideConfigurationControllerProvider, provider14);
    }

    private void initialize6(Builder builder) {
        Provider<RepeatableExecutor> provider = DoubleCheck.provider(ConcurrencyModule_ProvideBackgroundRepeatableExecutorFactory.create(this.provideBackgroundDelayableExecutorProvider));
        this.provideBackgroundRepeatableExecutorProvider = provider;
        SeekBarViewModel_Factory create = SeekBarViewModel_Factory.create(provider);
        this.seekBarViewModelProvider = create;
        this.miuiMediaControlPanelProvider = MiuiMediaControlPanel_Factory.create(this.contextProvider, this.provideBackgroundExecutorProvider, this.activityStarterDelegateProvider, this.mediaViewControllerProvider, create);
        ...
        Provider<MediaDeviceManager> provider2 = DoubleCheck.provider(MediaDeviceManager_Factory.create(this.contextProvider, this.localMediaManagerFactoryProvider, create2, this.provideMainExecutorProvider, this.mediaDataManagerProvider, this.dumpManagerProvider));
        this.mediaDeviceManagerProvider = provider2;
        Provider<MediaDataCombineLatest> provider3 = DoubleCheck.provider(MediaDataCombineLatest_Factory.create(this.mediaDataManagerProvider, provider2));
        this.mediaDataCombineLatestProvider = provider3;
        Provider<MediaDataFilter> provider4 = DoubleCheck.provider(MediaDataFilter_Factory.create(provider3, this.providesBroadcastDispatcherProvider, this.mediaResumeListenerProvider, this.mediaDataManagerProvider, this.notificationLockscreenUserManagerImplProvider, this.provideMainExecutorProvider));
        this.mediaDataFilterProvider = provider4;
        Provider<MediaCarouselController> provider5 = DoubleCheck.provider(MediaCarouselController_Factory.create(this.contextProvider, this.miuiMediaControlPanelProvider, this.provideVisualStabilityManagerProvider, this.mediaHostStatesManagerProvider, this.activityStarterDelegateProvider, this.provideMainDelayableExecutorProvider, provider4, this.provideConfigurationControllerProvider, this.falsingManagerProxyProvider));
        this.mediaCarouselControllerProvider = provider5;
        this.mediaHierarchyManagerProvider = DoubleCheck.provider(MediaHierarchyManager_Factory.create(this.contextProvider, this.statusBarStateControllerImplProvider, this.keyguardStateControllerImplProvider, this.keyguardBypassControllerProvider, provider5, this.notificationLockscreenUserManagerImplProvider, this.wakefulnessLifecycleProvider));
        MediaHost_Factory create3 = MediaHost_Factory.create(MediaHost_MediaHostStateHolder_Factory.create(), this.mediaHierarchyManagerProvider, this.mediaDataFilterProvider, this.mediaHostStatesManagerProvider);
        this.mediaHostProvider = create3;
        this.keyguardMediaControllerProvider = DoubleCheck.provider(KeyguardMediaController_Factory.create(create3, this.keyguardBypassControllerProvider, this.statusBarStateControllerImplProvider, this.notificationLockscreenUserManagerImplProvider));
