...
public final class DaggerTvSystemUIRootComponent implements TvSystemUIRootComponent {
    ...
    private void initialize3(Builder builder) {
        ...
        Provider<SettingsObserverImpl> provider20 = DoubleCheck.provider(SettingsObserverImpl_Factory.create(this.contextProvider, this.providesBroadcastDispatcherProvider));
        this.settingsObserverImplProvider = provider20;
        Provider<ControlPanelController> provider21 = DoubleCheck.provider(ControlPanelController_Factory.create(this.contextProvider, this.newKeyguardViewMediatorProvider, this.providesBroadcastDispatcherProvider, provider20));
        ...
        Provider<MediaResumeListener> provider23 = DoubleCheck.provider(MediaResumeListener_Factory.create(this.contextProvider, this.providesBroadcastDispatcherProvider, this.provideBackgroundExecutorProvider, this.tunerServiceImplProvider));
        ...
        Provider<TrustManager> provider26 = DoubleCheck.provider(SystemServicesModule_ProvideTrustManagerFactory.create(this.contextProvider));
    ...
    private void initialize4(Builder builder) {
        ...
        Provider<ManagedProfileControllerImpl> provider15 = DoubleCheck.provider(ManagedProfileControllerImpl_Factory.create(this.contextProvider, this.providesBroadcastDispatcherProvider));
        ...
        Provider<MiuiFlashlightHelper> provider16 = DoubleCheck.provider(MiuiFlashlightHelper_Factory.create(this.contextProvider));
        this.miuiFlashlightHelperProvider = provider16;
        Provider<FlashlightControllerImpl> provider17 = DoubleCheck.provider(FlashlightControllerImpl_Factory.create(this.contextProvider, provider16));
    ...
    private void initialize5(Builder builder) {
        ...
        this.controlPanelWindowManagerProvider = DoubleCheck.provider(ControlPanelWindowManager_Factory.create(this.contextProvider, this.provideStatusBarProvider, this.controlPanelControllerProvider, this.provideHeadsUpManagerPhoneProvider, this.statusBarStateControllerImplProvider));
        ...
        Provider<CloudDataManager> provider10 = DoubleCheck.provider(CloudDataManager_Factory.create(this.contextProvider, this.dumpManagerProvider));
        this.cloudDataManagerProvider = provider10;
        Provider<NotificationSettingsManager> provider11 = DoubleCheck.provider(NotificationSettingsManager_Factory.create(this.contextProvider, provider10));
        this.notificationSettingsManagerProvider = provider11;
        this.notificationFilterControllerProvider = DoubleCheck.provider(NotificationFilterController_Factory.create(this.contextProvider, this.provideNotificationListenerProvider, this.provideNotificationEntryManagerProvider, provider11, this.providesBroadcastDispatcherProvider));
        ...
        this.miuiNotificationShadePolicyProvider = DoubleCheck.provider(MiuiNotificationShadePolicy_Factory.create(this.contextProvider, this.provideBgHandlerProvider, this.provideHeadsUpManagerPhoneProvider, this.notificationShadeWindowControllerProvider));
        ...
        Provider<MemoryMonitor> provider12 = DoubleCheck.provider(MemoryMonitor_Factory.create(this.contextProvider, this.provideBgLooperProvider, this.dumpManagerProvider));
        ...
        Provider<KeyguardUpdateMonitorInjector> provider15 = DoubleCheck.provider(KeyguardUpdateMonitorInjector_Factory.create(this.contextProvider, this.superSaveModeControllerProvider));
        this.keyguardUpdateMonitorInjectorProvider = provider15;
        this.notificationSensitiveControllerProvider = DoubleCheck.provider(NotificationSensitiveController_Factory.create(this.contextProvider, this.miuiFaceUnlockManagerProvider, this.keyguardUpdateMonitorProvider, provider15, this.userSwitcherControllerProvider, this.provideNotificationViewHierarchyManagerProvider));
        ...
        this.modalControllerProvider = DoubleCheck.provider(ModalController_Factory.create(this.contextProvider, this.provideStatusBarProvider, provider16));
    }

    private void initialize6(Builder builder) {
        this.appMiniWindowManagerProvider = DoubleCheck.provider(AppMiniWindowManager_Factory.create(this.contextProvider, this.provideDividerProvider, this.provideHeadsUpManagerPhoneProvider, this.provideMainHandlerProvider, this.modalControllerProvider, this.notificationSettingsManagerProvider));
        ...
        this.mediaViewControllerProvider = MediaViewController_Factory.create(this.contextProvider, this.provideConfigurationControllerProvider, provider);
        ...
        Provider<MiuiMediaTransferManager> provider3 = DoubleCheck.provider(MiuiMediaTransferManager_Factory.create(this.contextProvider));
        this.miuiMediaTransferManagerProvider = provider3;
        this.miuiMediaControlPanelProvider = MiuiMediaControlPanel_Factory.create(this.contextProvider, this.provideBackgroundExecutorProvider, this.activityStarterDelegateProvider, this.mediaViewControllerProvider, this.seekBarViewModelProvider, provider3);
        ...
        Provider<MediaDeviceManager> provider4 = DoubleCheck.provider(MediaDeviceManager_Factory.create(this.contextProvider, this.localMediaManagerFactoryProvider, create, this.provideMainExecutorProvider, this.mediaDataManagerProvider, this.dumpManagerProvider));
    ...
    private final class DependencyInjectorImpl implements Dependency.DependencyInjector {
        ...
        private void initialize() {
            ...
            this.nCSwitchControllerProvider = NCSwitchController_Factory.create(DaggerTvSystemUIRootComponent.this.contextProvider, DaggerTvSystemUIRootComponent.this.statusBarStateControllerImplProvider, DaggerTvSystemUIRootComponent.this.controlPanelControllerProvider, DaggerTvSystemUIRootComponent.this.notificationShadeWindowControllerProvider, DaggerTvSystemUIRootComponent.this.systemUIStatProvider);
        }
