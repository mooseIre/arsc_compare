...
import com.android.systemui.dagger.MiuiLogModule_ProvideMediaControlLogBufferFactory;
import com.android.systemui.dagger.MiuiLogModule_ProvidePanelViewLogBufferFactory;
...
public final class DaggerTvSystemUIRootComponent implements TvSystemUIRootComponent {
    ...
    private void initialize(Builder builder) {
        ...
        Provider<MiuiBrightnessController> provider7 = DoubleCheck.provider(MiuiBrightnessController_Factory.create(this.contextProvider, this.providesBroadcastDispatcherProvider));
        ...
        Provider<CurrentUserContextTracker> provider8 = DoubleCheck.provider(SettingsModule_ProvideCurrentUserContextTrackerFactory.create(this.contextProvider, this.providesBroadcastDispatcherProvider));
        ...
        Provider<TunerServiceImpl> provider10 = DoubleCheck.provider(TunerServiceImpl_Factory.create(this.contextProvider, this.provideMainHandlerProvider, provider9, this.providesBroadcastDispatcherProvider));
        ...
        Provider<AsyncSensorManager> provider12 = DoubleCheck.provider(AsyncSensorManager_Factory.create(this.contextProvider, this.providePluginManagerProvider));
        ...
        Provider<AudioManager> provider13 = DoubleCheck.provider(SystemServicesModule_ProvideAudioManagerFactory.create(this.contextProvider));
        ...
        Provider<DeviceProvisionedControllerImpl> provider14 = DoubleCheck.provider(DeviceProvisionedControllerImpl_Factory.create(this.contextProvider, this.provideMainHandlerProvider, this.providesBroadcastDispatcherProvider));
        this.deviceProvisionedControllerImplProvider = provider14;
        this.navigationModeControllerProvider = DoubleCheck.provider(NavigationModeController_Factory.create(this.contextProvider, provider14, this.provideConfigurationControllerProvider, this.provideUiBackgroundExecutorProvider));
        ...
        Provider<NotificationManager> provider15 = DoubleCheck.provider(SystemServicesModule_ProvideNotificationManagerFactory.create(this.contextProvider));
        this.provideNotificationManagerProvider = provider15;
        this.provideNotificationListenerProvider = DoubleCheck.provider(StatusBarDependenciesModule_ProvideNotificationListenerFactory.create(this.contextProvider, provider15, this.provideMainHandlerProvider));
        ...
        Provider<ExtensionControllerImpl> provider17 = DoubleCheck.provider(ExtensionControllerImpl_Factory.create(this.contextProvider, this.provideLeakDetectorProvider, this.providePluginManagerProvider, this.tunerServiceImplProvider, this.provideConfigurationControllerProvider));
        ...
        Provider<KeyguardManager> provider21 = DoubleCheck.provider(SystemServicesModule_ProvideKeyguardManagerFactory.create(this.contextProvider));
        ...
        Provider<KeyguardBypassController> provider23 = DoubleCheck.provider(KeyguardBypassController_Factory.create(this.contextProvider, this.tunerServiceImplProvider, this.statusBarStateControllerImplProvider, provider22, this.keyguardStateControllerImplProvider, this.dumpManagerProvider));
        this.keyguardBypassControllerProvider = provider23;
        this.provideHeadsUpManagerPhoneProvider = DoubleCheck.provider(SystemUIDefaultModule_ProvideHeadsUpManagerPhoneFactory.create(this.contextProvider, this.statusBarStateControllerImplProvider, provider23, this.notificationGroupManagerProvider, this.provideConfigurationControllerProvider));
        ...
        Provider<LogBufferEulogizer> provider27 = DoubleCheck.provider(LogBufferEulogizer_Factory.create(this.contextProvider, this.dumpManagerProvider, this.bindSystemClockProvider, provider26));
        ...
        Provider<ConversationNotificationManager> provider31 = DoubleCheck.provider(ConversationNotificationManager_Factory.create(this.provideNotificationEntryManagerProvider, this.notificationGroupManagerProvider, this.contextProvider, this.provideMainHandlerProvider));
    ...
    private void initialize2(Builder builder) {
        ...
        this.provideBatteryControllerProvider = DoubleCheck.provider(SystemUIDefaultModule_ProvideBatteryControllerFactory.create(this.contextProvider, this.enhancedEstimatesImplProvider, this.providePowerManagerProvider, this.providesBroadcastDispatcherProvider, this.provideMainHandlerProvider, create2));
        ...
        IconBuilder_Factory create3 = IconBuilder_Factory.create(this.contextProvider);
        ...
        this.provideNotificationsControllerProvider = DoubleCheck.provider(NotificationsModule_ProvideNotificationsControllerFactory.create(this.contextProvider, this.notificationsControllerImplProvider, create9));
        this.darkIconDispatcherImplProvider = DoubleCheck.provider(DarkIconDispatcherImpl_Factory.create(this.contextProvider, this.provideCommandQueueProvider));
        this.provideLightBarControllerProvider = DoubleCheck.provider(MiuiStatusBarModule_ProvideLightBarControllerFactory.create(builder.miuiStatusBarModule, this.contextProvider, this.darkIconDispatcherImplProvider, this.provideBatteryControllerProvider, this.navigationModeControllerProvider));
        ...
        Provider<ChannelEditorDialogController> provider12 = DoubleCheck.provider(ChannelEditorDialogController_Factory.create(this.contextProvider, this.provideINotificationManagerProvider, ChannelEditorDialog_Builder_Factory.create()));
        ...
        this.userSwitcherControllerProvider = DoubleCheck.provider(UserSwitcherController_Factory.create(this.contextProvider, this.keyguardStateControllerImplProvider, this.provideMainHandlerProvider, provider14, this.providesBroadcastDispatcherProvider, this.provideUiEventLoggerProvider));
        ...
        Provider<NetworkScoreManager> provider15 = DoubleCheck.provider(SystemServicesModule_ProvideNetworkScoreManagerFactory.create(this.contextProvider));
    ...
    private void initialize3(Builder builder) {
        Provider<DisplayController> provider = DoubleCheck.provider(DisplayController_Factory.create(this.contextProvider, this.provideMainHandlerProvider, this.provideIWindowManagerProvider));
        this.displayControllerProvider = provider;
        this.pipBoundsHandlerProvider = DoubleCheck.provider(PipBoundsHandler_Factory.create(this.contextProvider, this.pipSnapAlgorithmProvider, provider));
        ...
        Provider<Recents> provider2 = DoubleCheck.provider(SystemUIDefaultModule_ProvideRecentsFactory.create(this.contextProvider, create, this.provideCommandQueueProvider));
        ...
        Provider<PipUiEventLogger> provider5 = DoubleCheck.provider(PipUiEventLogger_Factory.create(this.provideUiEventLoggerProvider));
        this.pipUiEventLoggerProvider = provider5;
        Provider<PipTaskOrganizer> provider6 = DoubleCheck.provider(PipTaskOrganizer_Factory.create(this.contextProvider, this.pipBoundsHandlerProvider, this.pipSurfaceTransactionHelperProvider, this.provideDividerProvider, this.displayControllerProvider, this.pipAnimationControllerProvider, provider5));
        this.pipTaskOrganizerProvider = provider6;
        Provider<PipManager> provider7 = DoubleCheck.provider(PipManager_Factory.create(this.contextProvider, this.providesBroadcastDispatcherProvider, this.pipBoundsHandlerProvider, provider6, this.pipSurfaceTransactionHelperProvider, this.provideDividerProvider));
        this.pipManagerProvider = provider7;
        this.pipUIProvider = DoubleCheck.provider(PipUI_Factory.create(this.contextProvider, this.provideCommandQueueProvider, provider7));
        ...
        Provider<PackageManagerWrapper> provider8 = DoubleCheck.provider(SystemServicesModule_ProvidePackageManagerWrapperFactory.create());
        this.providePackageManagerWrapperProvider = provider8;
        Provider provider9 = DoubleCheck.provider(AssistHandleReminderExpBehavior_Factory.create(this.provideSystemClockProvider, this.provideBackgroundHandlerProvider, this.deviceConfigHelperProvider, this.statusBarStateControllerImplProvider, this.provideActivityManagerWrapperProvider, this.overviewProxyServiceProvider, this.provideSysUiStateProvider, this.wakefulnessLifecycleProvider, provider8, this.providesBroadcastDispatcherProvider, this.bootCompleteCacheImplProvider));
        this.assistHandleReminderExpBehaviorProvider = provider9;
        Provider provider10 = DoubleCheck.provider(AssistModule_ProvideAssistHandleBehaviorControllerMapFactory.create(this.assistHandleOffBehaviorProvider, this.assistHandleLikeHomeBehaviorProvider, provider9));
        this.provideAssistHandleBehaviorControllerMapProvider = provider10;
        this.assistHandleBehaviorControllerProvider = DoubleCheck.provider(AssistHandleBehaviorController_Factory.create(this.contextProvider, this.provideAssistUtilsProvider, this.provideBackgroundHandlerProvider, this.provideAssistHandleViewControllerProvider, this.deviceConfigHelperProvider, provider10, this.navigationModeControllerProvider, this.provideAccessibilityManagerProvider, this.dumpManagerProvider));
        Provider<PhoneStateMonitor> provider11 = DoubleCheck.provider(PhoneStateMonitor_Factory.create(this.contextProvider, this.providesBroadcastDispatcherProvider, this.optionalOfLazyOfStatusBarProvider, this.bootCompleteCacheImplProvider));
        this.phoneStateMonitorProvider = provider11;
        Provider<AssistLogger> provider12 = DoubleCheck.provider(AssistLogger_Factory.create(this.contextProvider, this.provideUiEventLoggerProvider, this.provideAssistUtilsProvider, provider11, this.assistHandleBehaviorControllerProvider));
        this.assistLoggerProvider = provider12;
        Provider<DefaultUiController> provider13 = DoubleCheck.provider(DefaultUiController_Factory.create(this.contextProvider, provider12));
        this.defaultUiControllerProvider = provider13;
        this.assistManagerProvider = DoubleCheck.provider(AssistManager_Factory.create(this.deviceProvisionedControllerImplProvider, this.contextProvider, this.provideAssistUtilsProvider, this.assistHandleBehaviorControllerProvider, this.provideCommandQueueProvider, this.phoneStateMonitorProvider, this.overviewProxyServiceProvider, this.provideConfigurationControllerProvider, this.provideSysUiStateProvider, provider13, this.assistLoggerProvider));
        ...
        Provider<LogBuffer> provider16 = DoubleCheck.provider(LogModule_ProvideDozeLogBufferFactory.create(this.provideLogcatEchoTrackerProvider, this.dumpManagerProvider));
        this.provideDozeLogBufferProvider = provider16;
        DozeLogger_Factory create3 = DozeLogger_Factory.create(provider16);
        this.dozeLoggerProvider = create3;
        Provider<DozeLog> provider17 = DoubleCheck.provider(DozeLog_Factory.create(this.keyguardUpdateMonitorProvider, this.dumpManagerProvider, create3));
        this.dozeLogProvider = provider17;
        Provider<DozeScrimController> provider18 = DoubleCheck.provider(DozeScrimController_Factory.create(this.dozeParametersProvider, provider17));
        this.dozeScrimControllerProvider = provider18;
        Provider<BiometricUnlockController> provider19 = DoubleCheck.provider(BiometricUnlockController_Factory.create(this.contextProvider, provider18, this.newKeyguardViewMediatorProvider, this.scrimControllerProvider, this.provideStatusBarProvider, this.shadeControllerImplProvider, this.notificationShadeWindowControllerProvider, this.keyguardStateControllerImplProvider, ConcurrencyModule_ProvideHandlerFactory.create(), this.keyguardUpdateMonitorProvider, this.provideResourcesProvider, this.keyguardBypassControllerProvider, this.dozeParametersProvider, this.provideMetricsLoggerProvider, this.dumpManagerProvider));
        this.biometricUnlockControllerProvider = provider19;
        this.miuiDozeServiceHostProvider = DoubleCheck.provider(MiuiDozeServiceHost_Factory.create(this.dozeLogProvider, this.providePowerManagerProvider, this.wakefulnessLifecycleProvider, this.statusBarStateControllerImplProvider, this.deviceProvisionedControllerImplProvider, this.provideHeadsUpManagerPhoneProvider, this.provideBatteryControllerProvider, this.scrimControllerProvider, provider19, this.newKeyguardViewMediatorProvider, this.assistManagerProvider, this.dozeScrimControllerProvider, this.keyguardUpdateMonitorProvider, this.provideVisualStabilityManagerProvider, this.pulseExpansionHandlerProvider, this.notificationShadeWindowControllerProvider, this.notificationWakeUpCoordinatorProvider, this.lockscreenLockIconControllerProvider, this.settingsManagerProvider));
        ...
        Provider<VolumeDialogControllerImpl> provider20 = DoubleCheck.provider(VolumeDialogControllerImpl_Factory.create(this.contextProvider, this.providesBroadcastDispatcherProvider, this.optionalOfLazyOfStatusBarProvider, this.ringerModeTrackerImplProvider));
        this.volumeDialogControllerImplProvider = provider20;
        this.volumeDialogComponentProvider = DoubleCheck.provider(VolumeDialogComponent_Factory.create(this.contextProvider, this.newKeyguardViewMediatorProvider, provider20));
        ...
        Provider<Choreographer> provider21 = DoubleCheck.provider(DependencyProvider_ProvidesChoreographerFactory.create(builder.dependencyProvider));
        this.providesChoreographerProvider = provider21;
        this.notificationShadeDepthControllerProvider = DoubleCheck.provider(NotificationShadeDepthController_Factory.create(this.statusBarStateControllerImplProvider, this.blurUtilsProvider, this.biometricUnlockControllerProvider, this.keyguardStateControllerImplProvider, provider21, this.provideWallpaperManagerProvider, this.notificationShadeWindowControllerProvider, this.dozeParametersProvider, this.dumpManagerProvider));
        ...
        Provider<SettingsObserverImpl> provider22 = DoubleCheck.provider(SettingsObserverImpl_Factory.create(this.contextProvider, this.providesBroadcastDispatcherProvider, this.provideBgHandlerProvider));
        this.settingsObserverImplProvider = provider22;
        Provider<ControlPanelController> provider23 = DoubleCheck.provider(ControlPanelController_Factory.create(this.contextProvider, this.newKeyguardViewMediatorProvider, this.providesBroadcastDispatcherProvider, provider22, this.keyguardStateControllerImplProvider, this.shadeControllerImplProvider));
        this.controlPanelControllerProvider = provider23;
        ...
        delegateFactory2.setDelegatedProvider(provider24);
        ...
        Provider<MediaResumeListener> provider25 = DoubleCheck.provider(MediaResumeListener_Factory.create(this.contextProvider, this.providesBroadcastDispatcherProvider, this.provideBackgroundExecutorProvider, this.tunerServiceImplProvider));
        this.mediaResumeListenerProvider = provider25;
        this.mediaDataManagerProvider = DoubleCheck.provider(MediaDataManager_Factory.create(this.contextProvider, this.provideBackgroundExecutorProvider, this.provideMainExecutorProvider, this.mediaControllerFactoryProvider, this.dumpManagerProvider, this.providesBroadcastDispatcherProvider, this.mediaTimeoutListenerProvider, provider25));
        ...
        this.provideNotificationMediaManagerProvider = provider26;
        ((DelegateFactory) this.provideNotificationMediaManagerProvider).setDelegatedProvider(provider26);
        Provider<StatusBarKeyguardViewManager> provider27 = DoubleCheck.provider(StatusBarKeyguardViewManager_Factory.create(this.contextProvider, this.providesViewMediatorCallbackProvider, this.provideLockPatternUtilsProvider, this.statusBarStateControllerImplProvider, this.provideConfigurationControllerProvider, this.keyguardUpdateMonitorProvider, this.navigationModeControllerProvider, this.dockManagerImplProvider, this.notificationShadeWindowControllerProvider, this.keyguardStateControllerImplProvider, this.provideNotificationMediaManagerProvider));
        this.statusBarKeyguardViewManagerProvider = provider27;
        ((DelegateFactory) this.statusBarKeyguardViewManagerProvider).setDelegatedProvider(provider27);
        Provider<TrustManager> provider28 = DoubleCheck.provider(SystemServicesModule_ProvideTrustManagerFactory.create(this.contextProvider));
        this.provideTrustManagerProvider = provider28;
        Provider<KeyguardViewMediator> provider29 = DoubleCheck.provider(KeyguardModule_NewKeyguardViewMediatorFactory.create(this.contextProvider, this.falsingManagerProxyProvider, this.provideLockPatternUtilsProvider, this.providesBroadcastDispatcherProvider, this.statusBarKeyguardViewManagerProvider, this.dismissCallbackRegistryProvider, this.keyguardUpdateMonitorProvider, this.dumpManagerProvider, this.providePowerManagerProvider, provider28, this.provideUiBackgroundExecutorProvider, DeviceConfigProxy_Factory.create(), this.navigationModeControllerProvider));
        this.newKeyguardViewMediatorProvider = provider29;
        ((DelegateFactory) this.newKeyguardViewMediatorProvider).setDelegatedProvider(provider29);
        Provider<NotificationShadeWindowController> provider30 = DoubleCheck.provider(NotificationShadeWindowController_Factory.create(this.contextProvider, this.provideWindowManagerProvider, this.provideIActivityManagerProvider, this.dozeParametersProvider, this.statusBarStateControllerImplProvider, this.provideConfigurationControllerProvider, this.newKeyguardViewMediatorProvider, this.keyguardBypassControllerProvider, this.sysuiColorExtractorProvider, this.dumpManagerProvider));
        this.notificationShadeWindowControllerProvider = provider30;
        ((DelegateFactory) this.notificationShadeWindowControllerProvider).setDelegatedProvider(provider30);
        ...
        this.bubblePersistentRepositoryProvider = DoubleCheck.provider(BubblePersistentRepository_Factory.create(this.contextProvider));
    }
    ...
    private void initialize4(Builder builder) {
        ...
        this.controlsListingControllerImplProvider = DoubleCheck.provider(ControlsListingControllerImpl_Factory.create(this.contextProvider, provider3));
        ...
        Provider<GlobalActionsComponent> provider6 = DoubleCheck.provider(GlobalActionsComponent_Factory.create(this.contextProvider, this.provideCommandQueueProvider, this.extensionControllerImplProvider, create2, this.statusBarKeyguardViewManagerProvider));
        ...
        Provider<GlobalScreenshot> provider11 = DoubleCheck.provider(GlobalScreenshot_Factory.create(this.contextProvider, this.provideResourcesProvider, create5, this.provideUiEventLoggerProvider));
        ...
        Provider<LeakReporter> provider15 = DoubleCheck.provider(LeakReporter_Factory.create(this.contextProvider, this.provideLeakDetectorProvider, provider14));
        this.leakReporterProvider = provider15;
        Provider<GarbageMonitor> provider16 = DoubleCheck.provider(GarbageMonitor_Factory.create(this.contextProvider, this.provideBgLooperProvider, this.provideLeakDetectorProvider, provider15));
        this.garbageMonitorProvider = provider16;
        this.serviceProvider = DoubleCheck.provider(GarbageMonitor_Service_Factory.create(this.contextProvider, provider16));
        ...
        this.expandInfoControllerImplProvider = DoubleCheck.provider(ExpandInfoControllerImpl_Factory.create(this.contextProvider, this.provideBackgroundExecutorProvider));
        ...
        Provider<SlaveWifiHelper> provider17 = DoubleCheck.provider(SlaveWifiHelper_Factory.create(this.contextProvider));
        ...
        Provider<ManagedProfileControllerImpl> provider18 = DoubleCheck.provider(ManagedProfileControllerImpl_Factory.create(this.contextProvider, this.providesBroadcastDispatcherProvider));
        ...
        Provider<MiuiFlashlightControllerImpl> provider19 = DoubleCheck.provider(MiuiFlashlightControllerImpl_Factory.create(this.contextProvider));
        ...
        DriveModeControllerImpl_Factory create6 = DriveModeControllerImpl_Factory.create(this.contextProvider, this.provideCCBgLooperProvider, provider21, this.provideMainExecutorProvider);
    ...
    private void initialize5(Builder builder) {
        ...
        PaperModeControllerImpl_Factory create = PaperModeControllerImpl_Factory.create(this.contextProvider, this.provideCCBgLooperProvider, this.providesBroadcastDispatcherProvider);
        ...
        Provider<MiuiQSTileHostInjector> provider5 = DoubleCheck.provider(MiuiQSTileHostInjector_Factory.create(this.contextProvider, this.providePluginManagerProvider, this.tunerServiceImplProvider, this.controlPanelControllerProvider, this.superSaveModeControllerProvider, provider4, this.deviceProvisionedControllerImplProvider, this.provideBgHandlerProvider));
        this.miuiQSTileHostInjectorProvider = provider5;
        DelegateFactory delegateFactory = (DelegateFactory) this.qSTileHostProvider;
        Provider<QSTileHost> provider6 = DoubleCheck.provider(QSTileHost_Factory.create(this.contextProvider, this.statusBarIconControllerImplProvider, this.qSFactoryImplProvider, this.provideMainHandlerProvider, this.provideCCBgLooperProvider, this.provideCCBackgroundExecutorProvider, this.providePluginManagerProvider, this.tunerServiceImplProvider, this.autoTileManagerProvider, this.dumpManagerProvider, this.providesBroadcastDispatcherProvider, this.optionalOfStatusBarProvider, this.qSLoggerProvider, this.provideUiEventLoggerProvider, this.statusBarStateControllerImplProvider, provider5, this.controlPanelControllerProvider));
        ...
        Provider<EventTracker> provider13 = DoubleCheck.provider(EventTracker_Factory.create(this.contextProvider));
        this.eventTrackerProvider = provider13;
        this.codeBlueServiceProvider = DoubleCheck.provider(CodeBlueService_Factory.create(this.contextProvider, this.provideBgLooperProvider, this.provideNotificationEntryManagerProvider, provider13));
        ...
        this.keyguardBottomAreaInjectorProvider = DoubleCheck.provider(KeyguardBottomAreaInjector_Factory.create(this.contextProvider, this.dumpManagerProvider));
        Provider<MiuiKeyguardWallpaperControllerImpl> provider16 = DoubleCheck.provider(MiuiKeyguardWallpaperControllerImpl_Factory.create(this.contextProvider, this.providesBroadcastDispatcherProvider));
        this.miuiKeyguardWallpaperControllerImplProvider = provider16;
        this.keyguardNegative1PageInjectorProvider = DoubleCheck.provider(KeyguardNegative1PageInjector_Factory.create(this.contextProvider, provider16));
    ...
    private void initialize6(Builder builder) {
        ...
        Provider<ModalController> provider2 = DoubleCheck.provider(ModalController_Factory.create(this.contextProvider, this.provideStatusBarProvider, this.statusBarStateControllerImplProvider, this.miPlayPluginManagerProvider, provider, this.provideControlCenterProvider));
        ...
        Provider<SystemUIStat> provider4 = DoubleCheck.provider(SystemUIStat_Factory.create(this.contextProvider, this.eventTrackerProvider));
        this.systemUIStatProvider = provider4;
        this.nCSwitchControllerProvider = DoubleCheck.provider(NCSwitchController_Factory.create(this.contextProvider, this.statusBarStateControllerImplProvider, this.controlPanelControllerProvider, this.shadeControllerImplProvider, this.provideHeadsUpManagerPhoneProvider, this.provideMainHandlerProvider, this.panelViewLoggerProvider, provider4));
        ...
        this.foldNotifControllerProvider = DoubleCheck.provider(FoldNotifController_Factory.create(this.contextProvider, this.statusBarStateControllerImplProvider));
        ...
        this.mediaViewControllerProvider = MediaViewController_Factory.create(this.contextProvider, this.provideConfigurationControllerProvider, provider5);
        ...
        this.miuiMediaTransferManagerProvider = DoubleCheck.provider(MiuiMediaTransferManager_Factory.create(this.contextProvider, this.controlPanelControllerProvider));
        ...
        this.miuiMediaControlPanelProvider = MiuiMediaControlPanel_Factory.create(this.contextProvider, this.provideBackgroundExecutorProvider, this.activityStarterDelegateProvider, this.mediaViewControllerProvider, this.seekBarViewModelProvider, this.miuiMediaTransferManagerProvider, create);
        ...
        SystemServicesModule_ProvideMediaRouter2ManagerFactory create2 = SystemServicesModule_ProvideMediaRouter2ManagerFactory.create(this.contextProvider);
        this.provideMediaRouter2ManagerProvider = create2;
        Provider<MediaDeviceManager> provider8 = DoubleCheck.provider(MediaDeviceManager_Factory.create(this.contextProvider, this.localMediaManagerFactoryProvider, create2, this.provideMainExecutorProvider, this.mediaDataManagerProvider, this.dumpManagerProvider));
    ...
    private final class DependencyInjectorImpl implements Dependency.DependencyInjector {
        ...
        private Dependency injectDependency(Dependency dependency) {
            ...
            Dependency_MembersInjector.injectMLightBarController(dependency, DoubleCheck.lazy(DaggerTvSystemUIRootComponent.this.provideLightBarControllerProvider));
            ...
            Dependency_MembersInjector.injectMCodeBlueService(dependency, DoubleCheck.lazy(DaggerTvSystemUIRootComponent.this.codeBlueServiceProvider));
            ...
            Dependency_MembersInjector.injectMMiuiQuickConnectController(dependency, DoubleCheck.lazy(DaggerTvSystemUIRootComponent.this.miuiQuickConnectControllerProvider));
            ...
            Dependency_MembersInjector.injectMExpandInfoController(dependency, DoubleCheck.lazy(DaggerTvSystemUIRootComponent.this.expandInfoControllerImplProvider));
            ...
            Dependency_MembersInjector.injectMMiPlayPluginManager(dependency, DoubleCheck.lazy(DaggerTvSystemUIRootComponent.this.miPlayPluginManagerProvider));
            ...
            Dependency_MembersInjector.injectMNCSwitchController(dependency, DoubleCheck.lazy(DaggerTvSystemUIRootComponent.this.nCSwitchControllerProvider));
            ...
            Dependency_MembersInjector.injectMMiuiActivityUtil(dependency, DoubleCheck.lazy(DaggerTvSystemUIRootComponent.this.miuiActivityUtilProvider));
            Dependency_MembersInjector.injectMUnimportantSdk(dependency, DoubleCheck.lazy(DaggerTvSystemUIRootComponent.this.unimportantSdkProvider));
            Dependency_MembersInjector.injectMFoldNotifController(dependency, DoubleCheck.lazy(DaggerTvSystemUIRootComponent.this.foldNotifControllerProvider));
            return dependency;
        }
    }
    ...
    private final class FragmentCreatorImpl implements FragmentService.FragmentCreator {
        ...
        public MiuiQSFragment createQSFragment() {
            return new MiuiQSFragment((RemoteInputQuickSettingsDisabler) DaggerTvSystemUIRootComponent.this.remoteInputQuickSettingsDisablerProvider.get(), (InjectionInflationController) DaggerTvSystemUIRootComponent.this.injectionInflationControllerProvider.get(), (QSTileHost) DaggerTvSystemUIRootComponent.this.qSTileHostProvider.get(), (StatusBarStateController) DaggerTvSystemUIRootComponent.this.statusBarStateControllerImplProvider.get(), (CommandQueue) DaggerTvSystemUIRootComponent.this.provideCommandQueueProvider.get(), (ControlPanelController) DaggerTvSystemUIRootComponent.this.controlPanelControllerProvider.get(), DaggerTvSystemUIRootComponent.this.context, DaggerTvSystemUIRootComponent.this.getBackgroundHandler(), DaggerTvSystemUIRootComponent.this.getMainExecutor(), (StatusBar) DaggerTvSystemUIRootComponent.this.provideStatusBarProvider.get());
        }
    }
    ...
    public final class ViewCreatorImpl implements InjectionInflationController.ViewCreator {
        ...
        private final class ViewInstanceCreatorImpl implements InjectionInflationController.ViewInstanceCreator {
            ...
            private TileQueryHelper getTileQueryHelper() {
                return new TileQueryHelper(DaggerTvSystemUIRootComponent.this.context, DaggerTvSystemUIRootComponent.this.getMainExecutor(), (Executor) DaggerTvSystemUIRootComponent.this.provideCCBackgroundExecutorProvider.get());
            }

            private CCTileQueryHelper getCCTileQueryHelper() {
                return new CCTileQueryHelper(DaggerTvSystemUIRootComponent.this.context, DaggerTvSystemUIRootComponent.this.getMainExecutor(), (Executor) DaggerTvSystemUIRootComponent.this.provideCCBackgroundExecutorProvider.get());
            }
            ...
            public MiuiQSContainer createMiuiQSContainer() {
                return new MiuiQSContainer(DaggerTvSystemUIRootComponent.this.context, InjectionInflationController_ViewAttributeProvider_ProvideAttributeSetFactory.proxyProvideAttributeSet(this.viewAttributeProvider), (BroadcastDispatcher) DaggerTvSystemUIRootComponent.this.providesBroadcastDispatcherProvider.get(), (InjectionInflationController) DaggerTvSystemUIRootComponent.this.injectionInflationControllerProvider.get(), (TunerService) DaggerTvSystemUIRootComponent.this.tunerServiceImplProvider.get(), (MiuiBrightnessController) DaggerTvSystemUIRootComponent.this.miuiBrightnessControllerProvider.get());
            }

            @Override // com.android.systemui.util.InjectionInflationController.ViewInstanceCreator
            public QSFooterDataUsage createQSFooterDataUsage() {
                return new QSFooterDataUsage(DaggerTvSystemUIRootComponent.this.context, InjectionInflationController_ViewAttributeProvider_ProvideAttributeSetFactory.proxyProvideAttributeSet(this.viewAttributeProvider), (ActivityStarter) DaggerTvSystemUIRootComponent.this.activityStarterDelegateProvider.get(), ConcurrencyModule_ProvideMainLooperFactory.proxyProvideMainLooper(), (Looper) DaggerTvSystemUIRootComponent.this.provideCCBgLooperProvider.get());
            }

            @Override // com.android.systemui.util.InjectionInflationController.ViewInstanceCreator
            public ControlCenterPanelView createControlCenterPanelView() {
                return new ControlCenterPanelView(InjectionInflationController_ViewAttributeProvider_ProvideContextFactory.proxyProvideContext(this.viewAttributeProvider), InjectionInflationController_ViewAttributeProvider_ProvideAttributeSetFactory.proxyProvideAttributeSet(this.viewAttributeProvider), ConcurrencyModule_ProvideMainLooperFactory.proxyProvideMainLooper(), (ConfigurationController) DaggerTvSystemUIRootComponent.this.provideConfigurationControllerProvider.get(), (ControlsPluginManager) DaggerTvSystemUIRootComponent.this.controlsPluginManagerProvider.get(), (MiPlayPluginManager) DaggerTvSystemUIRootComponent.this.miPlayPluginManagerProvider.get(), (ControlPanelController) DaggerTvSystemUIRootComponent.this.controlPanelControllerProvider.get(), (NCSwitchController) DaggerTvSystemUIRootComponent.this.nCSwitchControllerProvider.get(), (StatusBarStateController) DaggerTvSystemUIRootComponent.this.statusBarStateControllerImplProvider.get());
            }
