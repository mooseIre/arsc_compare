...
public class DataUsageGraph extends View {
    ...
    public DataUsageGraph(Context context, AttributeSet attributeSet) {
        ...
        this.mTrackColor = Utils.getColorStateListDefaultColor(context, C0010R$color.data_usage_graph_track);
        this.mWarningColor = Utils.getColorStateListDefaultColor(context, C0010R$color.data_usage_graph_warning);
        this.mUsageColor = Utils.getColorAccentDefaultColor(context);
        this.mOverlimitColor = Utils.getColorErrorDefaultColor(context);
        this.mMarkerWidth = resources.getDimensionPixelSize(C0011R$dimen.data_usage_graph_marker_width);
    }
