...
public final class IndicatorDrawable extends Drawable {
    ...
    public IndicatorDrawable(@NotNull Context context) {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(C0011R$dimen.qs_panel_expand_indicator_stroke_width);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C0011R$dimen.qs_panel_expand_indicator_shadow_spread);
        this.mCaretPaint.setColor(context.getColor(C0010R$color.qs_panel_expand_indicator_color));
        ...
        this.mShadowPaint.setColor(context.getColor(C0010R$color.qs_tile_divider));
        ...
        this.mCaretWidth = resources.getDimensionPixelSize(C0011R$dimen.qs_panel_expand_indicator_width);
        this.mCaretHeight = resources.getDimensionPixelSize(C0011R$dimen.qs_panel_expand_indicator_height);
    }
