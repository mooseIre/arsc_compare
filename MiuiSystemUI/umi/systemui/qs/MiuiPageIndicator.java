...
public final class MiuiPageIndicator extends ViewGroup {
    ...
    public MiuiPageIndicator(@Nullable Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.mPageDotSize = (int) resources.getDimension(C0011R$dimen.qs_page_indicator_dot_size);
        this.mPageDotSpace = (int) resources.getDimension(C0011R$dimen.qs_page_indicator_dot_space);
    }
    ...
    public final void setNumPages(int i) {
        if (i != getChildCount()) {
            ...
            while (i > getChildCount()) {
                ...
                imageView.setImageResource(C0012R$drawable.qs_page_indicator_dot);
                addView(imageView);
            }
