...
public class QSFooterImpl extends FrameLayout implements QSFooter, View.OnClickListener, UserInfoController.OnUserInfoChangedListener {
    ...
    public void onFinishInflate() {
        ...
        this.mPageIndicator = (MiuiPageIndicator) findViewById(C0012R$id.footer_page_indicator);
        this.mSettingsButton = (SettingsButton) findViewById(C0012R$id.settings_button);
        this.mSettingsContainer = findViewById(C0012R$id.settings_button_container);
        this.mSettingsButton.setOnClickListener(this);
        MultiUserSwitch multiUserSwitch = (MultiUserSwitch) findViewById(C0012R$id.multi_user_switch);
        this.mMultiUserSwitch = multiUserSwitch;
        this.mMultiUserAvatar = (ImageView) multiUserSwitch.findViewById(C0012R$id.multi_user_avatar);
        this.mActionsContainer = findViewById(C0012R$id.qs_footer_actions_container);
        this.mEditContainer = findViewById(C0012R$id.qs_footer_actions_edit_container);
    ...
    public void setBuildText() {
        TextView textView = (TextView) findViewById(C0012R$id.build);
        if (textView != null) {
            if (DevelopmentSettingsEnabler.isDevelopmentSettingsEnabled(this.mContext)) {
                textView.setText(this.mContext.getString(17039791, new Object[]{Build.VERSION.RELEASE_OR_CODENAME, Build.ID}));
    ...
    private void updateAnimator(int i) {
        ...
        int dimensionPixelSize = (i - ((this.mContext.getResources().getDimensionPixelSize(C0009R$dimen.qs_quick_tile_size) - this.mContext.getResources().getDimensionPixelSize(C0009R$dimen.qs_quick_tile_padding)) * i2)) / (i2 - 1);
        int dimensionPixelOffset = this.mContext.getResources().getDimensionPixelOffset(C0009R$dimen.default_gear_space);
    ...
    private void miuiUpdateVisibilities() {
        ...
        this.mSettingsContainer.findViewById(C0012R$id.tuner_icon).setVisibility(4);
    ...
    public /* synthetic */ void lambda$onClick$6$QSFooterImpl() {
        if (TunerService.isTunerEnabled(this.mContext)) {
            ...
            Toast.makeText(getContext(), C0018R$string.tuner_toast, 1).show();
