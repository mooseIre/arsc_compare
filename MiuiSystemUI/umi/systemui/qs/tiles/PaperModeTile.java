...
public class PaperModeTile extends QSTileImpl<QSTile.BooleanState> implements PaperModeController.PaperModeListener {
    ...
    public CharSequence getTileLabel() {
        return this.mContext.getString(C0020R$string.quick_settings_papermode_label);
    }

    /* access modifiers changed from: protected */
    public void handleUpdateState(QSTile.BooleanState booleanState, Object obj) {
        booleanState.label = this.mContext.getString(C0020R$string.quick_settings_papermode_label);
        if (!this.mPaperModeController.isAvailable()) {
            booleanState.icon = QSTileImpl.ResourceIcon.get(C0012R$drawable.ic_qs_paper_mode_off);
        ...
        if (booleanState.value) {
            booleanState.icon = QSTileImpl.ResourceIcon.get(C0012R$drawable.ic_qs_paper_mode_on);
