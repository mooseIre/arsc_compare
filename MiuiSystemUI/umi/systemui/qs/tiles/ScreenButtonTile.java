...
public class ScreenButtonTile extends QSTileImpl<QSTile.BooleanState> {
    ...
    protected class ClickRunnable implements Runnable {
        ...
        public void run() {
            if (this.value == 0) {
                AlertDialog create = new AlertDialog.Builder(((QSTileImpl) ScreenButtonTile.this).mContext, C0021R$style.Theme_Dialog_Alert).setMessage(286195789).setPositiveButton(17039370, (DialogInterface.OnClickListener) null).create();
