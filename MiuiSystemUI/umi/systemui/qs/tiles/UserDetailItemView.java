...
public class UserDetailItemView extends LinearLayout {
    protected static int layoutResId = C0016R$layout.qs_user_detail_item;
    ...
    public void onFinishInflate() {
        this.mAvatar = (UserAvatarView) findViewById(C0014R$id.user_picture);
        TextView textView = (TextView) findViewById(C0014R$id.user_name);
        this.mName = textView;
        ...
        updateTextStyle();
        this.mRestrictedPadlock = findViewById(C0014R$id.restricted_padlock);
    }
    ...
    public int getFontSizeDimen() {
        return C0011R$dimen.qs_detail_item_secondary_text_size;
    }
}
