...
public class QSCarrier extends LinearLayout {
    ...
    public void onFinishInflate() {
        ...
        findViewById(C0014R$id.mobile_combo);
        this.mMobileSignal = (ImageView) findViewById(C0014R$id.mobile_signal);
        ImageView imageView = (ImageView) findViewById(C0014R$id.mobile_roaming);
        TextView textView = (TextView) findViewById(C0014R$id.qs_carrier_text);
