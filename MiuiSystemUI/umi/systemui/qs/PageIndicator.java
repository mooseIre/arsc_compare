...
public class PageIndicator extends ViewGroup {
    ...
    private final int mPageIndicatorHeight = ((int) this.mContext.getResources().getDimension(C0009R$dimen.qs_page_indicator_height));
    private final int mPageIndicatorWidth = ((int) this.mContext.getResources().getDimension(C0009R$dimen.qs_page_indicator_width));
    ...
    public void setNumPages(int i, int i2) {
        ...
        if (i != getChildCount()) {
            ...
            while (i > getChildCount()) {
                ...
                imageView.setImageResource(C0010R$drawable.minor_a_b);
    ...
    private void setIndex(int i) {
        ...
        while (i2 < childCount) {
            ...
            imageView.setImageResource(C0010R$drawable.major_a_b);
    ...
    private int getTransition(boolean z, boolean z2, boolean z3) {
        if (z3) {
            if (z) {
                if (z2) {
                    return C0010R$drawable.major_b_a_animation;
                }
                return C0010R$drawable.major_b_c_animation;
            } else if (z2) {
                return C0010R$drawable.major_a_b_animation;
            } else {
                return C0010R$drawable.major_c_b_animation;
            }
        } else if (z) {
            if (z2) {
                return C0010R$drawable.minor_b_c_animation;
            }
            return C0010R$drawable.minor_b_a_animation;
        } else if (z2) {
            return C0010R$drawable.minor_c_b_animation;
        } else {
            return C0010R$drawable.minor_a_b_animation;
        }
    }
