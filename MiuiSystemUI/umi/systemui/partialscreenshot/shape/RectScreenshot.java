...
public class RectScreenshot extends PartialScreenshotShape {
    ...
    public void draw(Canvas canvas) {
        ...
        if (rect == null) {
            ...
            canvas2.drawRect((float) rect2.left, (float) rect2.top, (float) rect2.right, (float) rect2.bottom, this.mPaintSelection);
    ...
    public Bitmap getPartialBitmap(Bitmap bitmap) {
        ...
        canvas.drawRect(0.0f, 0.0f, (float) (rect5.right - rect5.left), (float) (rect5.bottom - rect5.top), paint);
