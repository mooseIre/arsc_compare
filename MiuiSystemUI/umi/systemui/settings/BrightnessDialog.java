...
public class BrightnessDialog extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(LayoutInflater.from(this).inflate(C0016R$layout.quick_settings_brightness_dialog, (ViewGroup) null));
        this.mBrightnessController = new MiuiBrightnessController(this, (ToggleSliderView) findViewById(C0014R$id.brightness_slider), this.mBroadcastDispatcher);
    }
