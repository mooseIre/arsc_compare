...
public class FsGestureDemoSwipeView extends FrameLayout {
    ...
    private void init() {
        LayoutInflater.from(getContext()).inflate(C0016R$layout.fs_gesture_swipe_view, this);
        setAlpha(0.0f);
        DisplayMetrics displayMetrics = new DisplayMetrics();
        ((WindowManager) getContext().getSystemService("window")).getDefaultDisplay().getRealMetrics(displayMetrics);
        this.mDisplayWidth = displayMetrics.widthPixels;
        this.mDisplayHeight = displayMetrics.heightPixels;
        this.mFinalTranslate = getResources().getDimension(C0011R$dimen.fsgesture_swipe_final_translateX);
    }
    ...
    public void prepare(int i) {
        ...
        switch (i) {
            case 0:
                setTranslationY(getResources().getDimension(C0011R$dimen.fsgesture_swipe_translateY));
            ...
            case 6:
                ...
                return;
            case 3:
                setTranslationY(getResources().getDimension(C0011R$dimen.fsgesture_swipe_drawer_translateY));
                setTranslationX((float) ((-getWidth()) / 2));
                return;
            default:
                return;
