...
public class DndNotificationWarnings {
    ...
    private void showNotification() {
        ...
        builder.setSmallIcon(17303652).setAutoCancel(false).setGroup(NotificationChannels.DND).setVisibility(1).setCustomContentView(new RemoteViews(this.mContext.getPackageName(), R.layout.dnd_notification)).setContentIntent(PendingIntent.getActivity(this.mContext, 0, Util.getSilentModeIntent(), 0));
