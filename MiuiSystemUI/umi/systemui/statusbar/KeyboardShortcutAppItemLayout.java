...
public class KeyboardShortcutAppItemLayout extends RelativeLayout {
    ...
    public void onMeasure(int i, int i2) {
        if (View.MeasureSpec.getMode(i) == 1073741824) {
            ImageView imageView = (ImageView) findViewById(C0012R$id.keyboard_shortcuts_icon);
            TextView textView = (TextView) findViewById(C0012R$id.keyboard_shortcuts_keyword);
