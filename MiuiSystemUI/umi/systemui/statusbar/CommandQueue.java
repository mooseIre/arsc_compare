...
public class CommandQueue extends CompatibilityCommandQueue {
    ...
    public void setSystemUiVisibility(int i, int i2, int i3, int i4, Rect rect, Rect rect2, boolean z) {
        setSystemUiVisibility(i, i2, i3, i4, -1, rect, rect2, z);
    }
    ...
    public void showToast(SomeArgs someArgs) {
        synchronized (this.mLock) {
            this.mHandler.obtainMessage(19726336, someArgs).sendToTarget();
        }
    }
    ...
    public void hideToast(String str, IBinder iBinder) {
        synchronized (this.mLock) {
            ...
            obtain.arg1 = str;
            obtain.arg2 = iBinder;
            this.mHandler.obtainMessage(19791872, obtain).sendToTarget();
        }
    }

    public void suppressAmbientDisplay(boolean z) {
        synchronized (this.mLock) {
            this.mHandler.obtainMessage(26279936, z ? 1 : 0, 0).sendToTarget();
        }
    }
