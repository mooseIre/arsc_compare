...
public class SuperStatusBarViewFactory {
    ...
    public NotificationShadeWindowView getNotificationShadeWindowView() {
        ...
        NotificationShadeWindowView notificationShadeWindowView2 = (NotificationShadeWindowView) this.mInjectionInflationController.injectable(LayoutInflater.from(this.mContext)).inflate(C0016R$layout.super_notification_shade, (ViewGroup) null);
        this.mNotificationShadeWindowView = notificationShadeWindowView2;
        if (notificationShadeWindowView2 != null) {
            LockIcon lockIcon = (LockIcon) notificationShadeWindowView2.findViewById(C0014R$id.lock_icon);
            if (lockIcon != null) {
    ...
    public StatusBarWindowView getStatusBarWindowView() {
        ...
        StatusBarWindowView statusBarWindowView2 = (StatusBarWindowView) this.mInjectionInflationController.injectable(LayoutInflater.from(this.mContext)).inflate(C0016R$layout.super_status_bar, (ViewGroup) null);
    ...
    public NotificationShelf getNotificationShelf(ViewGroup viewGroup) {
        ...
        NotificationShelf notificationShelf2 = (NotificationShelf) this.mInjectionInflationController.injectable(LayoutInflater.from(this.mContext)).inflate(C0016R$layout.status_bar_notification_shelf, viewGroup, false);
