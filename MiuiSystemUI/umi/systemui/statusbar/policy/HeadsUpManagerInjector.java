...
public class HeadsUpManagerInjector {
    ...
    private static void showToast(Context context, int i) {
        if (i != 2) {
            ...
            sb.append(context.getString(C0020R$string.miui_snooze_to_settings));
    ...
    static /* synthetic */ void lambda$showDialog$1(Context context, DialogInterface dialogInterface, int i) {
        ...
        sUserSelected = true;
        Toast.makeText(context, context.getString(C0020R$string.miui_snooze_user_set_success), 1).show();
    ...
    static /* synthetic */ void lambda$showDialog$2(Context context, DialogInterface dialogInterface) {
        if (!sUserSelected) {
            Toast.makeText(context, context.getString(C0020R$string.miui_snooze_user_set_fail), 1).show();
    ...
    private static String[] initSnoozeSummary(Context context) {
        return new String[]{context.getResources().getString(C0020R$string.miui_snooze_default_time, 1), context.getResources().getString(C0020R$string.miui_snooze_until_unlock_screen), context.getResources().getString(C0020R$string.miui_snooze_always_float)};
    }

    private static String initSnoozeHint(Context context, int i) {
        if (i != 0) {
            return context.getResources().getString(C0020R$string.miui_snooze_toast_hint_until_unlock_screen);
        }
        return context.getResources().getString(C0020R$string.miui_snooze_toast_hint_default, 1);
    }
}
