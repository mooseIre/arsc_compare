...
public class KeyguardUserSwitcher {
    ...
    private void reinflateViews() {
        ...
        LayoutInflater.from(this.mUserSwitcherContainer.getContext()).inflate(C0016R$layout.keyguard_user_switcher_inner, this.mUserSwitcherContainer);
        ViewGroup viewGroup2 = (ViewGroup) this.mUserSwitcherContainer.findViewById(C0014R$id.keyguard_user_switcher_inner);
    ...
    public static class Adapter extends UserSwitcherController.BaseUserAdapter implements View.OnClickListener {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (!(view instanceof UserDetailItemView) || !(view.getTag() instanceof UserSwitcherController.UserRecord)) {
                view = LayoutInflater.from(this.mContext).inflate(C0016R$layout.keyguard_user_switcher_item, viewGroup, false);
            ...
            if (item.picture == null) {
                ...
                CircleFramedDrawable circleFramedDrawable = new CircleFramedDrawable(item.picture, (int) this.mContext.getResources().getDimension(C0011R$dimen.kg_framed_avatar_size));
        ...
        private static Drawable getDrawable(Context context, UserSwitcherController.UserRecord userRecord) {
            ...
            if (userRecord.isCurrent) {
                i = C0010R$color.kg_user_switcher_selected_avatar_icon_color;
            } else if (!userRecord.isSwitchToEnabled) {
                i = C0010R$color.GM2_grey_600;
            } else {
                i = C0010R$color.kg_user_switcher_avatar_icon_color;
            }
            iconDrawable.setTint(context.getResources().getColor(i, context.getTheme()));
            if (!userRecord.isCurrent) {
                return iconDrawable;
            }
            return new LayerDrawable(new Drawable[]{context.getDrawable(C0012R$drawable.bg_avatar_selected), iconDrawable});
        }
