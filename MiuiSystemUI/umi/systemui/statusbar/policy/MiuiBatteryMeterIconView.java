...
public class MiuiBatteryMeterIconView extends ImageView {
    ...
    public MiuiBatteryMeterIconView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mUseTint = false;
        this.mDark = false;
        this.mIconId = C0017R$raw.stat_sys_battery;
    ...
    private void updateProgressDrawable() {
        ...
        LayerDrawable layerDrawable = (LayerDrawable) getContext().getResources().getDrawable(C0010R$drawable.battery_meter);
        ...
        Drawable drawable = getResources().getDrawable(C0010R$drawable.battery_meter_progress_normal);
        drawable.mutate();
        ...
        clipDrawable.mutate();
        this.mLayerDrawable.setDrawableByLayerId(C0012R$id.progress, this.mProgressClipDrawable);
        LayerDrawable layerDrawable2 = this.mLayerDrawable;
        layerDrawable2.setLayerGravity(layerDrawable2.findIndexByLayerId(C0012R$id.progress), 17);
        LayerDrawable layerDrawable3 = this.mLayerDrawable;
        layerDrawable3.setLayerInset(layerDrawable3.findIndexByLayerId(C0012R$id.progress), 0, 0, (int) (this.mProgressCenterLeftOffset * 2.0f), 0);
    ...
    private void updateResources() {
        ...
        this.mMaskScale = resources.getDimension(C0009R$dimen.battery_meter_charging_mask_scale);
        this.mProgressCenterLeftOffset = resources.getDimension(C0009R$dimen.battery_meter_progress_center_left_offset);
        this.mProgressOrientationPortrait = resources.getBoolean(C0007R$bool.battery_meter_progress_oriention_portrait);
        this.mProgressGravityStart = resources.getBoolean(C0007R$bool.battery_meter_progress_gravity_start);
        this.mWhiteBg = resources.getDrawable(C0010R$drawable.battery_meter_bg);
        this.mDarkBg = resources.getDrawable(C0010R$drawable.battery_meter_bg_dark);
        Matrix matrix = new Matrix();
        float f = this.mMaskScale;
        matrix.setScale(f, f);
        this.mMaskCharging = resources.getBoolean(C0007R$bool.battery_meter_mask_charging);
        this.mMaskProgress = resources.getBoolean(C0007R$bool.battery_meter_mask_progress);
        if (this.mMaskCharging) {
            try {
                this.mChargingMaskPath = PathParser.createPathFromPathData(resources.getString(C0018R$string.battery_meter_charging_mask_path));
                this.mChargingMask = resources.getDrawable(C0010R$drawable.battery_meter_charging_mask);
            ...
            try {
                this.mQuickChargingMaskPath = PathParser.createPathFromPathData(resources.getString(C0018R$string.battery_meter_quick_charging_mask_path));
                this.mQuickChargingMask = resources.getDrawable(C0010R$drawable.battery_meter_quick_charging_mask);
        ...
        if (this.mMaskProgress) {
            try {
                this.mProgressMaskPath = PathParser.createPathFromPathData(resources.getString(C0018R$string.battery_meter_progress_mask_path));
                this.mRoundProgress = resources.getDrawable(C0010R$drawable.battery_meter_progress_mask);
        ...
        this.mProgressMaskMin = resources.getInteger(C0013R$integer.battery_meter_progress_mask_min);
        this.mProgressMaskMax = resources.getInteger(C0013R$integer.battery_meter_progress_mask_max);
        this.mProgressDrawables.clear();
        this.mProgressDarkDrawables.clear();
        this.mBatteryLowColor = resources.getColor(C0008R$color.status_bar_battery_low);
        this.mBatteryNormalLightColor = resources.getColor(C0008R$color.status_bar_battery_normal_light);
        this.mBatteryNormalDarkColor = resources.getColor(C0008R$color.status_bar_battery_normal_dark);
        this.mBatteryNormalDigitLightColor = resources.getColor(C0008R$color.status_bar_battery_normal_digit_light);
        this.mBatteryNormalDigitDarkColor = resources.getColor(C0008R$color.status_bar_battery_normal_digit_dark);
        this.mBatteryChargingColor = resources.getColor(C0008R$color.status_bar_battery_charging);
        this.mBatteryPowerSaveColor = resources.getColor(C0008R$color.status_bar_battery_power_save);
        this.mProgressDrawables.put(BatteryStatus.LOW, resources.getDrawable(C0010R$drawable.battery_meter_progress_low));
        this.mProgressDarkDrawables.put(BatteryStatus.LOW, resources.getDrawable(C0010R$drawable.battery_meter_progress_low_dark));
        this.mProgressDrawables.put(BatteryStatus.LOW_DIGIT, resources.getDrawable(C0010R$drawable.battery_meter_progress_low_digit));
        this.mProgressDarkDrawables.put(BatteryStatus.LOW_DIGIT, resources.getDrawable(C0010R$drawable.battery_meter_progress_low_digit_dark));
        this.mProgressDrawables.put(BatteryStatus.NORMAL, resources.getDrawable(C0010R$drawable.battery_meter_progress_normal));
        this.mProgressDarkDrawables.put(BatteryStatus.NORMAL, resources.getDrawable(C0010R$drawable.battery_meter_progress_normal_dark));
        this.mProgressDrawables.put(BatteryStatus.NORMAL_DIGIT, resources.getDrawable(C0010R$drawable.battery_meter_progress_normal_digit));
        this.mProgressDarkDrawables.put(BatteryStatus.NORMAL_DIGIT, resources.getDrawable(C0010R$drawable.battery_meter_progress_normal_digit_dark));
        this.mProgressDrawables.put(BatteryStatus.CHARGING, resources.getDrawable(C0010R$drawable.battery_meter_progress_charging));
        this.mProgressDarkDrawables.put(BatteryStatus.CHARGING, resources.getDrawable(C0010R$drawable.battery_meter_progress_charging_dark));
        this.mProgressDrawables.put(BatteryStatus.CHARGING_DIGIT, resources.getDrawable(C0010R$drawable.battery_meter_progress_charging_digit));
        this.mProgressDarkDrawables.put(BatteryStatus.CHARGING_DIGIT, resources.getDrawable(C0010R$drawable.battery_meter_progress_charging_digit_dark));
        this.mProgressDrawables.put(BatteryStatus.POWER_SAVE, resources.getDrawable(C0010R$drawable.battery_meter_progress_power_save));
        this.mProgressDarkDrawables.put(BatteryStatus.POWER_SAVE, resources.getDrawable(C0010R$drawable.battery_meter_progress_power_save_dark));
        this.mProgressDrawables.put(BatteryStatus.POWER_SAVE_DIGIT, resources.getDrawable(C0010R$drawable.battery_meter_progress_power_save_digit));
        this.mProgressDarkDrawables.put(BatteryStatus.POWER_SAVE_DIGIT, resources.getDrawable(C0010R$drawable.battery_meter_progress_power_save_digit_dark));
    }
    ...
    public void onDarkChanged(Rect rect, float f, int i, int i2, int i3, boolean z, boolean z2) {
        ...
        if (z4 || z2) {
            if (z) {
                Drawable drawable2 = getContext().getDrawable(C0010R$drawable.battery_meter_bg_tint);
                this.mTintBgDrawable = drawable2;
                if (drawable2 != null) {
                    drawable2.mutate();
                    this.mLayerDrawable.setDrawableByLayerId(C0012R$id.background, this.mTintBgDrawable);
                }
                Drawable drawable3 = getContext().getDrawable(C0010R$drawable.battery_meter_progress_tint);
                if (drawable3 != null) {
                    drawable3.mutate();
                ...
                this.mLayerDrawable.setDrawableByLayerId(C0012R$id.background, this.mDark ? this.mDarkBg : this.mWhiteBg);
                if (this.mDark) {
    ...
    private Drawable getLegacyDrawable(boolean z) {
        int i = this.mIconId;
        if (i == C0017R$raw.stat_sys_battery_power_save) {
            if (z) {
        ...
        } else if (i == C0017R$raw.stat_sys_battery_power_save_digit) {
            if (z) {
        ...
        } else if (i == C0017R$raw.stat_sys_battery_charge) {
            if (z) {
        ...
        } else if (i == C0017R$raw.stat_sys_battery_charge_digit) {
            if (z) {
        ...
        } else if (i == C0017R$raw.stat_sys_battery) {
            if (z) {
        ...
        } else if (i != C0017R$raw.stat_sys_battery_digital) {
            return null;
        } else {
            if (z) {
