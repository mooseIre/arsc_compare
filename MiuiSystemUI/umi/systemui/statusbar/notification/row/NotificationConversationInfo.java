...
public class NotificationConversationInfo extends LinearLayout implements NotificationGuts.GutsContent {
    ...
    public void bindNotification(ShortcutManager shortcutManager, PackageManager packageManager, INotificationManager iNotificationManager, VisualStabilityManager visualStabilityManager, String str, NotificationChannel notificationChannel, NotificationEntry notificationEntry, Notification.BubbleMetadata bubbleMetadata, OnSettingsClickListener onSettingsClickListener, OnSnoozeClickListener onSnoozeClickListener, ConversationIconFactory conversationIconFactory, Context context, Provider<PriorityOnboardingDialogController.Builder> provider, boolean z, Handler handler, Handler handler2, OnConversationSettingsClickListener onConversationSettingsClickListener, BubbleController bubbleController) {
        ...
        if (shortcutInfo != null) {
            ...
            bindHeader();
            bindActions();
            View findViewById = findViewById(C0012R$id.done);
    ...
    private void bindActions() {
        if (this.mAppBubble == 1) {
            ((TextView) findViewById(C0012R$id.default_summary)).setText(getResources().getString(C0018R$string.notification_channel_summary_default_with_bubbles, new Object[]{this.mAppName}));
        }
        findViewById(C0012R$id.priority).setOnClickListener(this.mOnFavoriteClick);
        findViewById(C0012R$id.default_behavior).setOnClickListener(this.mOnDefaultClick);
        findViewById(C0012R$id.silence).setOnClickListener(this.mOnMuteClick);
        View findViewById = findViewById(C0012R$id.info);
    ...
    private void bindConversationDetails() {
        ((TextView) findViewById(C0012R$id.parent_channel_name)).setText(this.mNotificationChannel.getName());
        bindGroup();
        bindPackage();
    ...
    private void bindIcon(boolean z) {
        ((ImageView) findViewById(C0012R$id.conversation_icon)).setImageDrawable(this.mIconFactory.getConversationDrawable(this.mShortcutInfo, this.mPackageName, this.mAppUid, z));
    }
    ...
    private void bindGroup() {
        ...
        TextView textView = (TextView) findViewById(C0012R$id.group_name);
    ...
    public void onFinishInflate() {
        ...
        this.mPriorityDescriptionView = (TextView) findViewById(C0012R$id.priority_summary);
        this.mDefaultDescriptionView = (TextView) findViewById(C0012R$id.default_summary);
    ...
    private void updateToggleActions(int i, boolean z) {
        ...
        View findViewById = findViewById(C0012R$id.priority);
        View findViewById2 = findViewById(C0012R$id.default_behavior);
    ...
    private void showPriorityOnboarding() {
        boolean z;
        View inflate = LayoutInflater.from(this.mContext).inflate(C0014R$layout.priority_onboarding_half_shell, (ViewGroup) null);
        boolean z2 = true;
        try {
