...
public class HybridConversationNotificationView extends HybridNotificationView {
    ...
    public void onFinishInflate() {
        ...
        this.mConversationSenderName = (TextView) requireViewById(C0012R$id.conversation_notification_sender);
        this.mFacePileSize = getResources().getDimensionPixelSize(C0009R$dimen.conversation_single_line_face_pile_size);
        this.mConversationIconSize = getResources().getDimensionPixelSize(C0009R$dimen.conversation_single_line_avatar_size);
        this.mFacePileProtectionWidth = getResources().getDimensionPixelSize(C0009R$dimen.conversation_single_line_face_pile_protection_width);
