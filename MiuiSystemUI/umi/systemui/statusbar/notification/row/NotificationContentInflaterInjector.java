...
public class NotificationContentInflaterInjector {
    ...
    static RemoteViews createMiuiPublicView(Notification.Builder builder, Context context) {
        ...
        buildBaseContent.setTextViewText(C0012R$id.title, builder.loadHeaderAppName());
        buildBaseContent.setViewVisibility(C0012R$id.title, 0);
        buildBaseContent.setTextViewText(C0012R$id.text, context.getString(C0018R$string.notification_hidden_text));
        buildBaseContent.setViewVisibility(C0012R$id.text, 0);
    ...
    private static RemoteViews buildBaseContent(Notification notification, Context context) {
        BuilderRemoteViews builderRemoteViews = new BuilderRemoteViews(context.getApplicationInfo(), C0014R$layout.miui_notification_template_material_base);
    ...
    private static RemoteViews buildBigBaseContent(Notification notification, boolean z, boolean z2, Context context) {
        BuilderRemoteViews builderRemoteViews = new BuilderRemoteViews(context.getApplicationInfo(), C0014R$layout.miui_notification_template_material_big_base);
    ...
    private static RemoteViews buildBigPictureContent(Notification notification, Bitmap bitmap, Context context) {
        BuilderRemoteViews builderRemoteViews = new BuilderRemoteViews(context.getApplicationInfo(), C0014R$layout.miui_notification_template_material_big_picture);
        resetStandardTemplateWithActions(builderRemoteViews);
        boolean handleProgressBar = handleProgressBar(builderRemoteViews, notification);
        if (!handleProgressBar) {
            handleChronometerAndTime(builderRemoteViews, notification);
        ...
        if (notification.extras.containsKey("android.summaryText")) {
            builderRemoteViews.setTextViewText(C0012R$id.text, processTextSpans(notification.extras.getCharSequence("android.summaryText"), context));
            builderRemoteViews.setViewVisibility(C0012R$id.text, 0);
        }
        builderRemoteViews.setImageViewBitmap(C0012R$id.big_picture, bitmap);
        handleActions(builderRemoteViews, notification, context);
        return builderRemoteViews;
    }

    private static RemoteViews buildBigTextContent(Notification notification, boolean z, Context context) {
        BuilderRemoteViews builderRemoteViews = new BuilderRemoteViews(context.getApplicationInfo(), C0014R$layout.miui_notification_template_material_big_text);
        resetStandardTemplateWithActions(builderRemoteViews);
        handleLargeIcon(builderRemoteViews, notification);
        boolean handleProgressBar = handleProgressBar(builderRemoteViews, notification);
        if (!handleProgressBar) {
    ...
    private static RemoteViews buildInboxContent(Notification notification, ArrayList<CharSequence> arrayList, Context context) {
        BuilderRemoteViews builderRemoteViews = new BuilderRemoteViews(context.getApplicationInfo(), C0014R$layout.miui_notification_template_material_inbox);
        resetStandardTemplateWithActions(builderRemoteViews);
        boolean handleProgressBar = handleProgressBar(builderRemoteViews, notification);
        if (!handleProgressBar) {
            handleChronometerAndTime(builderRemoteViews, notification);
    ...
    private static RemoteViews buildOneLineContent(Notification notification, boolean z, Context context) {
        BuilderRemoteViews builderRemoteViews = new BuilderRemoteViews(context.getApplicationInfo(), C0014R$layout.miui_notification_template_material_one_line);
        resetStandardTemplate(builderRemoteViews);
        boolean gameModeEnabled = ((SettingsManager) Dependency.get(SettingsManager.class)).getGameModeEnabled();
        boolean handleMiuiAction = handleMiuiAction(builderRemoteViews, notification);
        if (z) {
            builderRemoteViews.setTextColor(C0012R$id.miui_action, context.getColor(gameModeEnabled ? C0008R$color.optimized_game_heads_up_notification_action_text : C0008R$color.optimized_heads_up_notification_action_text));
        }
        CharSequence charSequence = notification.extras.getCharSequence("android.title");
        if (charSequence != null) {
            builderRemoteViews.setViewVisibility(C0012R$id.title, 0);
            builderRemoteViews.setTextViewText(C0012R$id.title, processTextSpans(charSequence, context));
            if (z) {
                builderRemoteViews.setTextColor(C0012R$id.title, context.getColor(gameModeEnabled ? C0008R$color.optimized_game_heads_up_notification_text : C0008R$color.optimized_heads_up_notification_text));
            }
        }
        CharSequence charSequence2 = notification.extras.getCharSequence("android.text");
        if (!handleMiuiAction && charSequence2 != null) {
            builderRemoteViews.setTextViewText(C0012R$id.text, processTextSpans(charSequence2, context));
            builderRemoteViews.setViewVisibility(C0012R$id.text, 0);
            if (z) {
                builderRemoteViews.setTextColor(C0012R$id.text, context.getColor(gameModeEnabled ? C0008R$color.optimized_game_heads_up_notification_text : C0008R$color.optimized_heads_up_notification_text));
            }
        }
        return builderRemoteViews;
    }
    ...
    private static void resetStandardTemplate(RemoteViews remoteViews) {
        remoteViews.setImageViewBitmap(C0012R$id.app_icon, (Bitmap) null);
        remoteViews.setViewVisibility(C0012R$id.time_line_1, 8);
        remoteViews.setViewVisibility(C0012R$id.chronometer, 8);
        remoteViews.setViewVisibility(C0012R$id.time, 8);
        remoteViews.setViewVisibility(C0012R$id.right_icon, 8);
        remoteViews.setViewVisibility(C0012R$id.title, 8);
        remoteViews.setTextViewText(C0012R$id.title, (CharSequence) null);
        remoteViews.setViewVisibility(C0012R$id.text, 8);
        remoteViews.setTextViewText(C0012R$id.text, (CharSequence) null);
        remoteViews.setViewVisibility(C0012R$id.text_line_1, 8);
        remoteViews.setTextViewText(C0012R$id.text_line_1, (CharSequence) null);
        remoteViews.setViewVisibility(C0012R$id.miui_action, 8);
        remoteViews.setTextViewText(C0012R$id.miui_action, (CharSequence) null);
    }
    ...
    private static void resetStandardTemplateWithActions(RemoteViews remoteViews) {
        ...
        remoteViews.setViewVisibility(C0012R$id.text_line_1, 8);
        remoteViews.setTextViewText(C0012R$id.text_line_1, (CharSequence) null);
        remoteViews.setViewVisibility(C0012R$id.actions, 8);
        remoteViews.removeAllViews(C0012R$id.actions);
    }
    ...
    private static boolean handleLargeIcon(RemoteViews remoteViews, Notification notification) {
        ...
        if (z) {
            remoteViews.setViewVisibility(C0012R$id.right_icon, 0);
            remoteViews.setImageViewIcon(C0012R$id.right_icon, largeIcon);
        }
        return z;
    }
    ...
    private static boolean handleProgressBar(RemoteViews remoteViews, Notification notification) {
        ...
        boolean z2 = i != 0 || z;
        if (z2) {
            remoteViews.setViewVisibility(C0012R$id.progress, 0);
            remoteViews.setProgressBar(C0012R$id.progress, i, i2, z);
            remoteViews.setProgressTintList(C0012R$id.progress, (ColorStateList) null);
            remoteViews.setProgressIndeterminateTintList(C0012R$id.progress, (ColorStateList) null);
        } else {
            remoteViews.setViewVisibility(C0012R$id.progress, 8);
        }
        return z2;
    }
    ...
    private static void handleBigContentTitle(RemoteViews remoteViews, Notification notification, boolean z, Context context) {
        ...
        if (charSequence2 == null || !charSequence2.equals("")) {
            remoteViews.setViewVisibility(C0012R$id.line1, 0);
        } else {
            remoteViews.setViewVisibility(C0012R$id.line1, 8);
        }
    }

    private static void handleTitle(RemoteViews remoteViews, CharSequence charSequence, boolean z, Context context) {
        if (charSequence != null) {
            remoteViews.setViewVisibility(C0012R$id.title, 0);
            remoteViews.setTextViewText(C0012R$id.title, processTextSpans(charSequence, context));
            remoteViews.setViewLayoutWidth(C0012R$id.title, z ? -2 : -1);
        }
    }
    ...
    private static void handleText(RemoteViews remoteViews, Notification notification, boolean z, Context context) {
        ...
        if (charSequence != null) {
            int i = z ? C0012R$id.text_line_1 : C0012R$id.text;
    ...
    private static void handleBigText(RemoteViews remoteViews, Notification notification, Context context) {
        ...
        remoteViews.setTextViewText(C0012R$id.big_text, processTextSpans(charSequence, context));
        remoteViews.setViewVisibility(C0012R$id.big_text, 0);
    }
    ...
    private static void handleInboxText(RemoteViews remoteViews, Notification notification, ArrayList<CharSequence> arrayList, Context context) {
        int i;
        int i2 = 7;
        int[] iArr = {C0012R$id.inbox_text0, C0012R$id.inbox_text1, C0012R$id.inbox_text2, C0012R$id.inbox_text3, C0012R$id.inbox_text4, C0012R$id.inbox_text5, C0012R$id.inbox_text6};
    ...
    private static boolean handleMiuiAction(RemoteViews remoteViews, Notification notification) {
        ...
        if (isShowMiuiAction) {
            remoteViews.setViewVisibility(C0012R$id.miui_action, 0);
            remoteViews.setTextViewText(C0012R$id.miui_action, MiuiNotificationCompat.getMiuiActionTitle(notification));
            remoteViews.setOnClickPendingIntent(C0012R$id.miui_action, notification.actions[0].actionIntent);
        }
    ...
    private static boolean handleChronometerAndTime(RemoteViews remoteViews, Notification notification) {
        ...
        if (z) {
            remoteViews.setViewVisibility(C0012R$id.time_line_1, 0);
            if (notification.extras.getBoolean("android.showChronometer")) {
                remoteViews.setViewVisibility(C0012R$id.chronometer, 0);
                remoteViews.setLong(C0012R$id.chronometer, "setBase", notification.when + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                remoteViews.setBoolean(C0012R$id.chronometer, "setStarted", true);
                remoteViews.setChronometerCountDown(C0012R$id.chronometer, notification.extras.getBoolean("android.chronometerCountDown"));
            } else {
                remoteViews.setViewVisibility(C0012R$id.time, 0);
                remoteViews.setLong(C0012R$id.time, "setTime", notification.when);
            }
        } else {
            int i = C0012R$id.time;
    ...
    private static boolean handleActions(RemoteViews remoteViews, Notification notification, Context context) {
        ...
        if (z) {
            remoteViews.setViewVisibility(C0012R$id.actions, 0);
            for (Notification.Action action : notification.actions) {
                BuilderRemoteViews builderRemoteViews = new BuilderRemoteViews(context.getApplicationInfo(), C0014R$layout.notification_material_action);
                builderRemoteViews.setOnClickPendingIntent(C0012R$id.action0, action.actionIntent);
                builderRemoteViews.setContentDescription(C0012R$id.action0, action.title);
                if (action.getRemoteInputs() != null) {
                    builderRemoteViews.setRemoteInputs(C0012R$id.action0, action.getRemoteInputs());
                }
                builderRemoteViews.setTextViewText(C0012R$id.action0, processTextSpans(action.title, context));
                remoteViews.addView(C0012R$id.actions, builderRemoteViews);
            }
        }
        return z;
    }
