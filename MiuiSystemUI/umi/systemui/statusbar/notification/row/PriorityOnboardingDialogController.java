            ...
            if (dialog3 != null) {
                ...
                if (dialog4 != null) {
                    ...
                    if (dialog5 != null) {
                        ...
                        TextView textView = (TextView) dialog5.findViewById(C0012R$id.done_button);
                        if (textView != null) {
                            textView.setOnClickListener(new PriorityOnboardingDialogController$initDialog$$inlined$apply$lambda$1(this));
                        }
                        TextView textView2 = (TextView) dialog5.findViewById(C0012R$id.settings_button);
                        if (textView2 != null) {
                            textView2.setOnClickListener(new PriorityOnboardingDialogController$initDialog$$inlined$apply$lambda$2(this));
                        }
                        ImageView imageView = (ImageView) dialog5.findViewById(C0012R$id.conversation_icon);
                        if (imageView != null) {
                            imageView.setImageDrawable(this.icon);
                        }
                        ImageView imageView2 = (ImageView) dialog5.findViewById(C0012R$id.icon);
                        if (imageView2 != null) {
                            imageView2.setImageDrawable(this.badge);
                        }
                        ImageView imageView3 = (ImageView) dialog5.findViewById(C0012R$id.conversation_icon_badge_ring);
                        ImageView imageView4 = (ImageView) dialog5.findViewById(C0012R$id.conversation_icon_badge_bg);
                        ...
                        if (drawable != null) {
                            ...
                            if (drawable2 != null) {
                                ...
                                if (dialog6 != null) {
                                    int dimensionPixelSize5 = dialog6.getContext().getResources().getDimensionPixelSize(C0009R$dimen.conversation_onboarding_bullet_gap_width);
                                    SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
                                    spannableStringBuilder.append(dialog5.getContext().getText(C0018R$string.priority_onboarding_show_at_top_text), new BulletSpan(dimensionPixelSize5), 0);
                                    spannableStringBuilder.append(System.lineSeparator());
                                    spannableStringBuilder.append(dialog5.getContext().getText(C0018R$string.priority_onboarding_show_avatar_text), new BulletSpan(dimensionPixelSize5), 0);
                                    if (this.showsAsBubble) {
                                        spannableStringBuilder.append(System.lineSeparator());
                                        spannableStringBuilder.append(dialog5.getContext().getText(C0018R$string.priority_onboarding_appear_as_bubble_text), new BulletSpan(dimensionPixelSize5), 0);
                                    }
                                    if (this.ignoresDnd) {
                                        spannableStringBuilder.append(System.lineSeparator());
                                        spannableStringBuilder.append(dialog5.getContext().getText(C0018R$string.priority_onboarding_ignores_dnd_text), new BulletSpan(dimensionPixelSize5), 0);
                                    }
                                    ((TextView) dialog5.findViewById(C0012R$id.behaviors)).setText(spannableStringBuilder);
