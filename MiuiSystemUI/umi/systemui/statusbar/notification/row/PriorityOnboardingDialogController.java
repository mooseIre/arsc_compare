                    ...
                    if (dialog5 != null) {
                        ...
                        if (drawable != null) {
                            ...
                            if (drawable2 != null) {
                                ...
                                int dimensionPixelSize = context2.getResources().getDimensionPixelSize(17105241);
                                Context context3 = dialog5.getContext();
                                Intrinsics.checkExpressionValueIsNotNull(context3, "context");
                                int dimensionPixelSize2 = context3.getResources().getDimensionPixelSize(17105239);
                                Context context4 = dialog5.getContext();
                                Intrinsics.checkExpressionValueIsNotNull(context4, "context");
                                int dimensionPixelSize3 = context4.getResources().getDimensionPixelSize(17105240) - (dimensionPixelSize * 2);
                                Context context5 = dialog5.getContext();
                                Intrinsics.checkExpressionValueIsNotNull(context5, "context");
                                int dimensionPixelSize4 = context5.getResources().getDimensionPixelSize(17105124);
