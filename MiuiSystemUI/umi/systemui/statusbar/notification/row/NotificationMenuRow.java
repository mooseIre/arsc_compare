...
public class NotificationMenuRow implements NotificationMenuRowPlugin, View.OnClickListener, ExpandableNotificationRow.LayoutListener {
    ...
    public NotificationMenuRow(Context context, PeopleNotificationIdentifier peopleNotificationIdentifier) {
        ...
        this.mShouldShowMenu = context.getResources().getBoolean(C0007R$bool.config_showNotificationGear);
    ...
    private void createMenuViews(boolean z, boolean z2) {
        ...
        this.mHorizSpaceForIcon = resources.getDimensionPixelSize(C0009R$dimen.notification_menu_icon_size);
        this.mVertSpaceForIcons = resources.getDimensionPixelSize(C0009R$dimen.notification_min_height);
    ...
    private void setAppName(String str, ArrayList<NotificationMenuRowPlugin.MenuItem> arrayList) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            String format = String.format(resources.getString(C0018R$string.notification_menu_accessibility), new Object[]{str, menuItem.getContentDescription()});
    ...
    static NotificationMenuRowPlugin.MenuItem createSnoozeItem(Context context) {
        return new NotificationMenuItem(context, context.getResources().getString(C0018R$string.notification_menu_snooze_description), (NotificationSnooze) LayoutInflater.from(context).inflate(C0014R$layout.notification_snooze, (ViewGroup) null, false), C0010R$drawable.ic_snooze);
    }

    static NotificationMenuItem createConversationItem(Context context) {
        return new NotificationMenuItem(context, context.getResources().getString(C0018R$string.notification_menu_gear_description), (NotificationConversationInfo) LayoutInflater.from(context).inflate(C0014R$layout.notification_conversation_info, (ViewGroup) null, false), C0010R$drawable.ic_settings);
    }

    static NotificationMenuItem createPartialConversationItem(Context context) {
        return new NotificationMenuItem(context, context.getResources().getString(C0018R$string.notification_menu_gear_description), (PartialConversationInfo) LayoutInflater.from(context).inflate(C0014R$layout.partial_conversation_info, (ViewGroup) null, false), C0010R$drawable.ic_settings);
    }

    static NotificationMenuItem createInfoItem(Context context) {
        return new NotificationMenuItem(context, context.getResources().getString(C0018R$string.notification_menu_gear_description), (NotificationInfo) LayoutInflater.from(context).inflate(C0014R$layout.notification_info, (ViewGroup) null, false), C0010R$drawable.ic_settings);
    }

    static NotificationMenuRowPlugin.MenuItem createAppOpsItem(Context context) {
        return new NotificationMenuItem(context, (String) null, (AppOpsInfo) LayoutInflater.from(context).inflate(C0014R$layout.app_ops_info, (ViewGroup) null, false), -1);
    }
    ...
    public static class NotificationMenuItem implements NotificationMenuRowPlugin.MenuItem {
        ...
        public NotificationMenuItem(Context context, String str, NotificationGuts.GutsContent gutsContent, int i) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0009R$dimen.notification_menu_icon_padding);
            int color = resources.getColor(C0008R$color.notification_gear_color);
            if (i >= 0) {
