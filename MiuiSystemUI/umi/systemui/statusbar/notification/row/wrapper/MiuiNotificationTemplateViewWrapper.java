...
public class MiuiNotificationTemplateViewWrapper extends MiuiNotificationViewWrapper {
    ...
    private void resolveTemplateViews() {
        this.mMainColumn = this.mView.findViewById(C0014R$id.notification_main_column);
        this.mRightIcon = (ImageView) this.mView.findViewById(C0014R$id.right_icon);
        this.mText = (TextView) this.mView.findViewById(C0014R$id.text);
        this.mTimeLine1 = this.mView.findViewById(C0014R$id.time_line_1);
        this.mProgressBar = this.mView.findViewById(C0014R$id.progress);
        this.mMiuiAction = this.mView.findViewById(C0014R$id.miui_action);
    }
    ...
    private void handleMainColumn() {
        if (showMiuiAction()) {
            ...
            setViewMarginEnd(this.mMainColumn, getDimensionPixelSize(C0011R$dimen.miui_notification_content_margin_end));
        } else {
            int dimensionPixelSize = getDimensionPixelSize(C0011R$dimen.notification_right_icon_size) + getDimensionPixelSize(C0011R$dimen.notification_main_column_right_margin);
            if (isBaseLayout()) {
                dimensionPixelSize += getDimensionPixelSize(C0011R$dimen.miui_notification_content_margin_end);
            }
    ...
    public /* synthetic */ void lambda$handleMainColumn$1$MiuiNotificationTemplateViewWrapper() {
        setViewMarginEnd(this.mMainColumn, getDimensionPixelSize(C0011R$dimen.miui_notification_content_margin_end) + this.mMiuiAction.getMeasuredWidth() + getDimensionPixelSize(C0011R$dimen.notification_main_column_right_margin));
    }
    ...
    private void handleRightIcon() {
        if (showRightIcon()) {
            ...
            if (showTimeChronometer()) {
                layoutParams.topMargin = getDimensionPixelSize(C0011R$dimen.notification_right_icon_margin_top);
                if (isBaseLayout()) {
                    layoutParams.topMargin += getDimensionPixelSize(C0011R$dimen.miui_notification_content_margin_top);
                }
        ...
        NotificationUtil.setViewRoundCorner(this.mRightIcon, (float) getDimensionPixelSize(C0011R$dimen.notification_right_icon_corner_radius));
    }
    ...
    private void handleText() {
        if (showRightIcon()) {
            int i = 0;
            if (showTimeChronometer()) {
                i = getDimensionPixelSize(C0011R$dimen.notification_right_icon_size) + getDimensionPixelSize(C0011R$dimen.notification_main_column_right_margin);
            }
