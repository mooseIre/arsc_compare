...
public class MessagingImageTransformState extends ImageTransformState {
    private static final int START_ACTUAL_HEIGHT = C0012R$id.transformation_start_actual_height;
    private static final int START_ACTUAL_WIDTH = C0012R$id.transformation_start_actual_width;
