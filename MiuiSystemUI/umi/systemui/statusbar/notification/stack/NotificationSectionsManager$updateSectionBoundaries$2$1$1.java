...
public final class NotificationSectionsManager$updateSectionBoundaries$2$1$1 extends Lambda implements Function1<NotificationSectionsManager.SectionUpdateState<? extends ExpandableView>, Boolean> {
    final /* synthetic */ NotificationSectionsManager.SectionUpdateState $state;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NotificationSectionsManager$updateSectionBoundaries$2$1$1(NotificationSectionsManager.SectionUpdateState sectionUpdateState) {
        super(1);
