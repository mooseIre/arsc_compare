...
public class NotificationStackScrollLayout extends ViewGroup implements ScrollAdapter, NotificationListContainer, ConfigurationController.ConfigurationListener, Dumpable, DynamicPrivacyController.Listener {
    ...
    /* access modifiers changed from: private */
    public final MiuiNotificationSectionsManager mSectionsManager;
    ...
    public NotificationStackScrollLayout(Context context, AttributeSet attributeSet, boolean z, NotificationRoundnessManager notificationRoundnessManager, DynamicPrivacyController dynamicPrivacyController, SysuiStatusBarStateController sysuiStatusBarStateController, HeadsUpManagerPhone headsUpManagerPhone, KeyguardBypassController keyguardBypassController, KeyguardMediaController keyguardMediaController, ZenModeViewController zenModeViewController, FalsingManager falsingManager, NotificationLockscreenUserManager notificationLockscreenUserManager, NotificationGutsManager notificationGutsManager, ZenModeController zenModeController, MiuiNotificationSectionsManager miuiNotificationSectionsManager, ForegroundServiceSectionController foregroundServiceSectionController, ForegroundServiceDismissalFeatureController foregroundServiceDismissalFeatureController, FeatureFlags featureFlags, NotifPipeline notifPipeline, NotificationEntryManager notificationEntryManager, NotifCollection notifCollection, UiEventLogger uiEventLogger, MediaTimeoutListener mediaTimeoutListener, MediaDataFilter mediaDataFilter) {
        ...
        this.mNotificationCallback = new NotificationSwipeHelper.NotificationCallback() {
            ...
            public View getChildAtPosition(MotionEvent motionEvent) {
                ...
                if (!(access$3600 instanceof ExpandableNotificationRow) || (notificationParent = ((ExpandableNotificationRow) access$3600).getNotificationParent()) == null || !notificationParent.areChildrenExpanded()) {
                    return access$3600;
                }
                return (notificationParent.areGutsExposed() || NotificationStackScrollLayout.this.mSwipeHelper.getExposedMenuView() == notificationParent || (notificationParent.getAttachedChildren().size() == 1 && notificationParent.getEntry().isClearable())) ? notificationParent : access$3600;
            }
        ...
        this.mDragDownCallback = new DragDownHelper.DragDownCallback() {
            ...
            public boolean onDraggedDown(View view, int i) {
                ...
                if (NotificationStackScrollLayout.this.mStatusBarState == 1 && z) {
                    ...
                    NotificationStackScrollLayout.this.mStatusBar.dismissKeyguardThenExecute($$Lambda$NotificationStackScrollLayout$16$4jJHIvYLz4tPygD0Enr8OUidlx4.INSTANCE, (Runnable) null, false);
                    return true;
                }
            }
        ...
        this.mOnGroupChangeListener = new NotificationGroupManager.OnGroupChangeListener() {
            public void onGroupExpansionChanged(final ExpandableNotificationRow expandableNotificationRow, boolean z) {
                ...
                if (z2) {
                    ...
                    boolean unused2 = NotificationStackScrollLayout.this.mGroupExpanded = z;
                    boolean unused3 = NotificationStackScrollLayout.this.mNeedsAnimation = true;
                }
        ...
        this.mSectionsManager = miuiNotificationSectionsManager2;
        miuiNotificationSectionsManager2.initialize(this, LayoutInflater.from(context));
        ...
        this.mBgColor = context.getColor(C0008R$color.notification_shade_background_color);
        ExpandHelper expandHelper = new ExpandHelper(getContext(), this.mExpandHelperCallback, resources.getDimensionPixelSize(C0009R$dimen.notification_min_height), resources.getDimensionPixelSize(C0009R$dimen.notification_max_height));
        this.mExpandHelper = expandHelper;
        expandHelper.setEventSource(this);
        this.mExpandHelper.setScrollAdapter(this);
        this.mSwipeHelper = new NotificationSwipeHelper(0, new MiuiNotificationSwipeCallback(this.mNotificationCallback, mediaTimeoutListener, mediaDataFilter, zenModeViewController2), getContext(), this.mMenuEventListener, this.mFalsingManager);
        this.mStackScrollAlgorithm = createStackScrollAlgorithm(context);
        initView(context);
        this.mShouldDrawNotificationBackground = resources.getBoolean(C0007R$bool.config_drawNotificationBackground);
        this.mFadeNotificationsOnDismiss = resources.getBoolean(C0007R$bool.config_fadeNotificationsOnDismiss);
        ...
        this.mClearAllEnabled = resources.getBoolean(C0007R$bool.config_enableNotificationsClearAll);
        ...
        zenModeViewController2.setVisibilityChangedListener(new Function2(zenModeViewController2) {
    ...
    public void updateFooter() {
        if (this.mFooterView != null) {
            if (((this.mClearAllEnabled && hasActiveClearableNotifications(0)) || hasActiveNotifications()) && this.mStatusBarState != 1) {
                boolean isRemoteInputActive = this.mRemoteInputManager.getController().isRemoteInputActive();
            }
            int intForUser = Settings.Secure.getIntForUser(this.mContext.getContentResolver(), "notification_history_enabled", 0, -2);
    ...
    public void onUiModeChanged() {
        this.mBgColor = this.mContext.getColor(C0008R$color.notification_shade_background_color);
    ...
    private void initView(Context context) {
        ...
        this.mPaddingBetweenElements = Math.max(1, resources.getDimensionPixelSize(C0009R$dimen.notification_divider_height));
        this.mIncreasedPaddingBetweenElements = resources.getDimensionPixelSize(C0009R$dimen.notification_divider_height_increased);
        this.mMinTopOverScrollToEscape = (float) resources.getDimensionPixelSize(C0009R$dimen.min_top_overscroll_to_qs);
        this.mStatusBarHeight = resources.getDimensionPixelSize(C0009R$dimen.status_bar_height);
        this.mBottomMargin = resources.getDimensionPixelSize(C0009R$dimen.notification_panel_margin_bottom);
        this.mSidePaddings = resources.getDimensionPixelSize(C0009R$dimen.notification_side_paddings);
        this.mMinInteractionHeight = resources.getDimensionPixelSize(C0009R$dimen.notification_min_interaction_height);
        this.mCornerRadius = resources.getDimensionPixelSize(Utils.getThemeAttr(this.mContext, 16844145));
        this.mHeadsUpInset = this.mStatusBarHeight + resources.getDimensionPixelSize(C0009R$dimen.heads_up_status_bar_padding);
    }
    ...
    private int getTopHeadsUpPinnedHeight() {
        ...
        if (row.isChildInGroup() && (groupSummary = this.mGroupManager.getGroupSummary((StatusBarNotification) row.getEntry().getSbn())) != null) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (expandableView.getVisibility() == 0 && (!z2 || !(expandableView instanceof StackScrollerDecorView))) {
                ...
                if ((actualHeight - clipTopAmount >= ((float) this.mMinInteractionHeight) || !z) && f2 >= clipTopAmount && f2 <= actualHeight && f >= ((float) 0) && f <= ((float) width)) {
                    ...
                    if (this.mIsExpanded || !expandableNotificationRow.isHeadsUp() || !expandableNotificationRow.isPinned() || this.mHeadsUpManager.getTopEntry().getRow() == expandableNotificationRow || this.mGroupManager.getGroupSummary((StatusBarNotification) this.mHeadsUpManager.getTopEntry().getSbn()) == entry) {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.mStatusBarHeight = getResources().getDimensionPixelOffset(C0009R$dimen.status_bar_height);
    ...
    private boolean isChildInInvisibleGroup(View view) {
        ...
        ExpandableNotificationRow expandableNotificationRow = (ExpandableNotificationRow) view;
        NotificationEntry groupSummary = this.mGroupManager.getGroupSummary((StatusBarNotification) expandableNotificationRow.getEntry().getSbn());
    ...
    /* JADX WARNING: type inference failed for: r0v1, types: [com.android.systemui.statusbar.notification.row.ExpandableNotificationRow] */
    ...
    public int getPositionInLinearLayout(android.view.View r15) {
        /*
            ...
            com.android.systemui.statusbar.notification.row.ExpandableNotificationRow r15 = r1.getNotificationParent()
            r0 = r15
            goto L_0x0011
        L_0x0010:
            r0 = r1
    ...
    public void updateDecorViews(boolean z) {
        if (z != this.mUsingLightTheme) {
            ...
            int colorAttrDefaultColor = Utils.getColorAttrDefaultColor(new ContextThemeWrapper(this.mContext, z ? C0019R$style.Theme_SystemUI_Light : C0019R$style.Theme_SystemUI), C0006R$attr.wallpaperTextColor);
    ...
    public void updateEmptyShadeView(boolean z) {
        ...
        int i = this.mZenController.areNotificationsHiddenInShade() ? C0018R$string.dnd_suppressing_shade_text : C0018R$string.empty_shade_text;
        if (textResource != i) {
    ...
    public void clearNotifications(int r12, boolean r13) {
        ...
        L_0x00b4:
            return
        L_0x00b5:
            com.android.systemui.statusbar.notification.stack.-$$Lambda$NotificationStackScrollLayout$zlAMjWL_SCOXxqekdJNTgIiHNdc r0 = new com.android.systemui.statusbar.notification.stack.-$$Lambda$NotificationStackScrollLayout$zlAMjWL_SCOXxqekdJNTgIiHNdc
            r0.<init>(r2, r12)
    ...
    public /* synthetic */ void lambda$performDismissAllAnimations$11$NotificationStackScrollLayout(boolean z, Runnable runnable) {
        Class cls = ShadeController.class;
        if (z) {
    ...
    public void inflateFooterView() {
        FooterView footerView = (FooterView) LayoutInflater.from(this.mContext).inflate(C0014R$layout.status_bar_notification_footer, this, false);
    ...
    private void inflateEmptyShadeView() {
        EmptyShadeView emptyShadeView = (EmptyShadeView) LayoutInflater.from(this.mContext).inflate(C0014R$layout.status_bar_no_notifications, this, false);
        emptyShadeView.setText(C0018R$string.empty_shade_text);
    ...
    public void lambda$clearNotifications$9(List<ExpandableNotificationRow> list, int i) {
        if (!this.mFeatureFlags.isNewNotifPipelineRenderingEnabled()) {
            for (ExpandableNotificationRow next : list) {
                if (!canChildBeDismissed(next)) {
                    next.resetTranslation();
                } else if (i == 0) {
                    this.mEntryManager.removeNotification(next.getEntry().getKey(), (NotificationListenerService.RankingMap) null, 3);
                } else {
                    this.mEntryManager.performRemoveNotification(next.getEntry().getSbn(), 3);
                }
            }
            if (i == 0) {
                try {
