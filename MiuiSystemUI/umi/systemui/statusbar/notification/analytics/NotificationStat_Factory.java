...
public final class NotificationStat_Factory implements Factory<NotificationStat> {
    ...
    public NotificationStat get() {
        return provideInstance(this.contextProvider, this.entryManagerProvider, this.groupManagerProvider, this.headsUpManagerProvider, this.barStateControllerProvider, this.keyguardStateControllerProvider, this.eventTrackerProvider, this.settingsManagerProvider, this.batteryControllerProvider);
    }
