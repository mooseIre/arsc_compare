...
public final class FoldManager {
    ...
    private static boolean isFoldNeedsAnim = true;
    ...
    public static final class Companion {
        ...
        public final boolean isFoldNeedsAnim() {
            return FoldManager.isFoldNeedsAnim;
        }

        public final void setFoldNeedsAnim(boolean z) {
            FoldManager.isFoldNeedsAnim = z;
        }
