...
public class BlurUtils implements Dumpable {
    ...
    private final int maxBlurRadius = this.resources.getDimensionPixelSize(C0009R$dimen.max_window_blur_radius);
    ...
    public BlurUtils(@NotNull Resources resources2, @NotNull DumpManager dumpManager) {
        ...
        this.minBlurRadius = resources2.getDimensionPixelSize(C0009R$dimen.min_window_blur_radius);
