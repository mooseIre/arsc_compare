...
public final class NavigationBarTransitions extends BarTransitions implements LightBarTransitionsController.DarkIntensityApplier {
    ...
    public NavigationBarTransitions(NavigationBarView navigationBarView, CommandQueue commandQueue) {
        super(navigationBarView, C0010R$drawable.nav_background);
        ...
        this.mAllowAutoDimWallpaperNotVisible = navigationBarView.getContext().getResources().getBoolean(C0007R$bool.config_navigation_bar_enable_auto_dim_no_visible_wallpaper);
        ...
        if (currentView != null) {
            this.mNavButtons = currentView.findViewById(C0012R$id.nav_buttons);
        }
    }
