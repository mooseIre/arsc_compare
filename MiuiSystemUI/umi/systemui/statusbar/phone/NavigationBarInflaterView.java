...
public class NavigationBarInflaterView extends FrameLayout implements NavigationModeController.ModeChangedListener {
    ...
    private void inflateChildren() {
        removeAllViews();
        FrameLayout frameLayout = (FrameLayout) this.mLayoutInflater.inflate(C0014R$layout.navigation_layout, this, false);
        this.mHorizontal = frameLayout;
        addView(frameLayout);
        FrameLayout frameLayout2 = (FrameLayout) this.mLayoutInflater.inflate(C0014R$layout.navigation_layout_vertical, this, false);
    ...
    public String getDefaultLayout() {
        ...
        if (QuickStepContract.isGesturalMode(this.mNavBarMode)) {
            i = C0018R$string.config_navBarLayoutHandle;
        } else if (this.mOverviewProxyService.shouldShowSwipeUpUI()) {
            i = C0018R$string.config_navBarLayoutQuickstep;
        } else {
    ...
    private void updateAlternativeOrder() {
        updateAlternativeOrder(this.mHorizontal.findViewById(C0012R$id.ends_group));
        updateAlternativeOrder(this.mHorizontal.findViewById(C0012R$id.center_group));
        updateAlternativeOrder(this.mVertical.findViewById(C0012R$id.ends_group));
        updateAlternativeOrder(this.mVertical.findViewById(C0012R$id.center_group));
    }
    ...
    private void initiallyFill(ButtonDispatcher buttonDispatcher) {
        addAll(buttonDispatcher, (ViewGroup) this.mHorizontal.findViewById(C0012R$id.ends_group));
        addAll(buttonDispatcher, (ViewGroup) this.mHorizontal.findViewById(C0012R$id.center_group));
        addAll(buttonDispatcher, (ViewGroup) this.mVertical.findViewById(C0012R$id.ends_group));
        addAll(buttonDispatcher, (ViewGroup) this.mVertical.findViewById(C0012R$id.center_group));
    }
    ...
    public void inflateLayout(String str) {
        ...
        inflateButtons(split2, (ViewGroup) this.mHorizontal.findViewById(C0012R$id.ends_group), false, true);
        inflateButtons(split2, (ViewGroup) this.mVertical.findViewById(C0012R$id.ends_group), true, true);
        inflateButtons(split3, (ViewGroup) this.mHorizontal.findViewById(C0012R$id.center_group), false, false);
        inflateButtons(split3, (ViewGroup) this.mVertical.findViewById(C0012R$id.center_group), true, false);
        addGravitySpacer((LinearLayout) this.mHorizontal.findViewById(C0012R$id.ends_group));
        addGravitySpacer((LinearLayout) this.mVertical.findViewById(C0012R$id.ends_group));
        inflateButtons(split4, (ViewGroup) this.mHorizontal.findViewById(C0012R$id.ends_group), false, false);
        inflateButtons(split4, (ViewGroup) this.mVertical.findViewById(C0012R$id.ends_group), true, false);
    ...
    private View createView(String str, ViewGroup viewGroup, LayoutInflater layoutInflater) {
        ...
        if ("home".equals(extractButton)) {
            return layoutInflater.inflate(C0014R$layout.home, viewGroup, false);
        }
        if ("back".equals(extractButton)) {
            return layoutInflater.inflate(C0014R$layout.back, viewGroup, false);
        }
        if ("recent".equals(extractButton)) {
            return layoutInflater.inflate(C0014R$layout.recent_apps, viewGroup, false);
        }
        if ("menu_ime".equals(extractButton)) {
            return layoutInflater.inflate(C0014R$layout.menu_ime, viewGroup, false);
        }
        if ("space".equals(extractButton)) {
            return layoutInflater.inflate(C0014R$layout.nav_key_space, viewGroup, false);
        }
        if ("clipboard".equals(extractButton)) {
            return layoutInflater.inflate(C0014R$layout.clipboard, viewGroup, false);
        }
        if ("contextual".equals(extractButton)) {
            return layoutInflater.inflate(C0014R$layout.contextual, viewGroup, false);
        }
        if ("home_handle".equals(extractButton)) {
            return layoutInflater.inflate(C0014R$layout.home_handle, viewGroup, false);
        }
        if ("ime_switcher".equals(extractButton)) {
            return layoutInflater.inflate(C0014R$layout.ime_switcher, viewGroup, false);
        }
        ...
        View inflate = layoutInflater.inflate(C0014R$layout.custom_key, viewGroup, false);
    ...
    private void clearViews() {
        ...
        clearAllChildren((ViewGroup) this.mHorizontal.findViewById(C0012R$id.nav_buttons));
        clearAllChildren((ViewGroup) this.mVertical.findViewById(C0012R$id.nav_buttons));
    }
    ...
    public void updateBackground(boolean z) {
        if (z) {
            this.mHorizontal.setBackgroundResource(C0010R$drawable.ic_sysbar_bg_darkmode);
            this.mVertical.setBackgroundResource(C0010R$drawable.ic_sysbar_bg_land_darkmode);
            return;
        }
        this.mHorizontal.setBackgroundResource(C0010R$drawable.ic_sysbar_bg);
        this.mVertical.setBackgroundResource(C0010R$drawable.ic_sysbar_bg_land);
    }
}
