...
public abstract class PanelView extends FrameLayout {
    ...
    public abstract void lambda$endMotionEvent$0(float f, boolean z);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!this.mNotificationsDragEnabled) {
            ...
            if (actionMasked != 0) {
                ...
                this.mPeekTouching = isFullyCollapsed;
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            ...
            boolean z2 = this.mHeightAnimator != null;
            this.mAnimatingOnDown = z2;
            this.mMinExpandHeight = 0.0f;
            if ((!z2 || !this.mClosing || this.mHintAnimationRunning) && this.mPeekAnimator == null) {
                this.mInitialTouchY = y;
