...
public class NavigationHandle extends View implements ButtonInterface {
    ...
    public NavigationHandle(Context context, AttributeSet attributeSet) {
        ...
        this.mRadius = resources.getDimensionPixelSize(C0009R$dimen.navigation_handle_radius);
        this.mBottom = resources.getDimensionPixelSize(C0009R$dimen.navigation_handle_bottom);
        ...
        this.mLightColor = Utils.getColorAttrDefaultColor(contextThemeWrapper, C0006R$attr.homeHandleColor);
        this.mDarkColor = Utils.getColorAttrDefaultColor(contextThemeWrapper2, C0006R$attr.homeHandleColor);
