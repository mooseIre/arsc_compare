...
public class KeyguardBouncer {
    ...
    public void inflateView() {
        ...
        ViewGroup viewGroup = (ViewGroup) LayoutInflater.from(this.mContext).inflate(C0014R$layout.keyguard_bouncer, (ViewGroup) null);
        this.mRoot = viewGroup;
        KeyguardHostView keyguardHostView = (KeyguardHostView) viewGroup.findViewById(C0012R$id.keyguard_host_view);
        ...
        this.mStatusBarHeight = this.mRoot.getResources().getDimensionPixelOffset(C0009R$dimen.status_bar_height);
        ...
        this.mBgImageView = (ImageView) this.mRoot.findViewById(C0012R$id.keyguard_bouncer_bg);
