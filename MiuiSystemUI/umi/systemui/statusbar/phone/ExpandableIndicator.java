...
public class ExpandableIndicator extends ImageView {
    ...
    private int getDrawableResourceId(boolean z) {
        if (this.mIsDefaultDirection) {
            if (z) {
                return C0012R$drawable.ic_volume_collapse_animation;
            }
            return C0012R$drawable.ic_volume_expand_animation;
        } else if (z) {
            return C0012R$drawable.ic_volume_expand_animation;
        } else {
            return C0012R$drawable.ic_volume_collapse_animation;
    ...
    private String getContentDescription(boolean z) {
        if (z) {
            return ((ImageView) this).mContext.getString(C0020R$string.accessibility_quick_settings_collapse);
        }
        return ((ImageView) this).mContext.getString(C0020R$string.accessibility_quick_settings_expand);
    }
