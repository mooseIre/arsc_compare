...
public final class MiuiKeyguardClockPositionAlgorithm extends KeyguardClockPositionAlgorithm {
    ...
    public void loadDimens(@Nullable Resources resources) {
        ...
        if (resources != null) {
            this.mClockYFractionMin = resources.getFraction(C0011R$fraction.keyguard_clock_y_fraction_min, 1, 1);
            this.mClockYFractionMax = resources.getFraction(C0011R$fraction.keyguard_clock_y_fraction_max, 1, 1);
            resources.getDimensionPixelSize(C0009R$dimen.miui_keyguard_clock_magin_top);
            this.mClockNotificationsPadding = (float) resources.getDimensionPixelSize(C0009R$dimen.miui_keyguard_clock_stack_scroller_padding_top);
            return;
        }
        Intrinsics.throwNpe();
        throw null;
