...
public class MiuiPhoneStatusBarPolicy extends PhoneStatusBarPolicy {
    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if ("android.intent.action.BLUETOOTH_HANDSFREE_BATTERY_CHANGED".equals(action)) {
                Log.d("MiuiPhoneStatusBarPolicy", "onReceive: updateBluetoothHandsfreeBattery");
                MiuiPhoneStatusBarPolicy.this.updateBluetoothHandsfreeBattery(intent);
            } else if ("android.media.extra.AUDIO_MIC_PLUG_STATE".equals(action)) {
    ...
    public MiuiPhoneStatusBarPolicy(Context context, StatusBarIconController statusBarIconController, CommandQueue commandQueue, BroadcastDispatcher broadcastDispatcher, Executor executor, Resources resources, CastController castController, HotspotController hotspotController, BluetoothController bluetoothController, NextAlarmController nextAlarmController, UserInfoController userInfoController, RotationLockController rotationLockController, DataSaverController dataSaverController, ZenModeController zenModeController, DeviceProvisionedController deviceProvisionedController, KeyguardStateController keyguardStateController, LocationController locationController, SensorPrivacyController sensorPrivacyController, IActivityManager iActivityManager, AlarmManager alarmManager, UserManager userManager, RecordingController recordingController, TelecomManager telecomManager, int i, SharedPreferences sharedPreferences, DateFormatUtil dateFormatUtil, RingerModeTracker ringerModeTracker) {
        ...
        Log.d("MiuiPhoneStatusBarPolicy", "MiuiPhoneStatusBarPolicy: ");
    ...
    public void miuiInit() {
        ...
        this.mIconController.setIcon(this.mSlotZen, C0010R$drawable.stat_sys_quiet_mode, (CharSequence) null);
        this.mIconController.setIconVisibility(this.mSlotZen, false);
        this.mIconController.setIcon(this.mSlotSyncActive, C0010R$drawable.stat_sys_sync, (CharSequence) null);
        this.mIconController.setIconVisibility(this.mSlotSyncActive, false);
        this.mIconController.setIcon(this.mSlotMute, C0010R$drawable.stat_notify_call_mute, (CharSequence) null);
        this.mIconController.setIconVisibility(this.mSlotMute, false);
        this.mIconController.setIcon(this.mSlotSpeakerphone, C0010R$drawable.stat_sys_speakerphone, (CharSequence) null);
        this.mIconController.setIconVisibility(this.mSlotSpeakerphone, false);
        this.mIconController.setIcon(this.mSlotLocation, C0010R$drawable.stat_sys_gps_on, this.mResources.getString(C0018R$string.accessibility_location_active));
        this.mIconController.setIconVisibility(this.mSlotLocation, false);
        this.mIconController.setIcon(this.mSlotRotate, C0010R$drawable.stat_sys_rotate_portrait, (CharSequence) null);
        this.mIconController.setIconVisibility(this.mSlotRotate, false);
        this.mIconController.setIcon(this.mSlotHotspot, C0010R$drawable.stat_sys_wifi_ap_on, this.mResources.getString(C0018R$string.accessibility_status_bar_hotspot));
        this.mIconController.setIconVisibility(this.mSlotHotspot, false);
        this.mIconController.setIcon(this.mSlotVolume, C0010R$drawable.stat_sys_ringer_vibrate, this.mContext.getString(C0018R$string.accessibility_ringer_vibrate));
        this.mIconController.setIconVisibility(this.mSlotVolume, false);
        this.mIconController.setIcon(this.mSlotHeadset, C0010R$drawable.stat_sys_headset, this.mResources.getString(C0018R$string.accessibility_status_bar_headset));
        this.mIconController.setIconVisibility(this.mSlotHeadset, false);
        this.mIconController.setIcon(this.mSlotMicphone, C0010R$drawable.stat_sys_micphone, (CharSequence) null);
        this.mIconController.setIconVisibility(this.mSlotMicphone, false);
        this.miuiDripLeftStatusBarIconController.setIcon(this.mSlotVolume, C0010R$drawable.stat_sys_ringer_vibrate, this.mContext.getString(C0018R$string.accessibility_ringer_vibrate));
        this.miuiDripLeftStatusBarIconController.setIconVisibility(this.mSlotVolume, false);
        this.miuiDripLeftStatusBarIconController.setIcon(this.mSlotZen, C0010R$drawable.stat_sys_quiet_mode, (CharSequence) null);
        this.miuiDripLeftStatusBarIconController.setIconVisibility(this.mSlotZen, false);
        initVloumeZen();
        this.miuiDripLeftStatusBarIconController.setIcon(this.mSlotHeadset, C0010R$drawable.stat_sys_headset, this.mResources.getString(C0018R$string.accessibility_status_bar_headset));
        this.miuiDripLeftStatusBarIconController.setIconVisibility(this.mSlotHeadset, false);
        this.miuiDripLeftStatusBarIconController.setIcon(this.mSlotAlarmClock, C0010R$drawable.stat_sys_alarm, buildAlarmContentDescription());
        this.miuiDripLeftStatusBarIconController.setIconVisibility(this.mSlotAlarmClock, false);
        this.miuiDripLeftStatusBarIconController.setIcon(this.mSlotMicphone, C0010R$drawable.stat_sys_micphone, (CharSequence) null);
        this.miuiDripLeftStatusBarIconController.setIconVisibility(this.mSlotMicphone, false);
        this.miuiDripLeftStatusBarIconController.setIcon(this.mSlotMute, C0010R$drawable.stat_notify_call_mute, (CharSequence) null);
        this.miuiDripLeftStatusBarIconController.setIconVisibility(this.mSlotMute, false);
        this.miuiDripLeftStatusBarIconController.setIcon(this.mSlotSpeakerphone, C0010R$drawable.stat_sys_speakerphone, (CharSequence) null);
    ...
    public void updateBluetooth(String str) {
        ...
        int i2 = C0010R$drawable.stat_sys_data_bluetooth;
        String string = this.mResources.getString(C0018R$string.accessibility_quick_settings_bluetooth_on);
        BluetoothController bluetoothController = this.mBluetooth;
        boolean z = false;
        if (bluetoothController != null) {
            boolean isBluetoothEnabled = bluetoothController.isBluetoothEnabled();
            ...
            if (isBluetoothConnected) {
                i2 = C0010R$drawable.stat_sys_data_bluetooth_connected;
                string = this.mResources.getString(C0018R$string.accessibility_bluetooth_connected);
            }
            ...
            if (b == 1) {
                i = C0010R$drawable.stat_sys_data_bluetooth_in;
            } else if (b == 2) {
                i = C0010R$drawable.stat_sys_data_bluetooth_out;
            } else {
                if (b == 3) {
                    i = C0010R$drawable.stat_sys_data_bluetooth_inout;
                }
    ...
    public /* synthetic */ void lambda$updateManagedProfile$0$MiuiPhoneStatusBarPolicy(boolean z, boolean z2, boolean z3) {
        ...
        if (!z) {
            if (z2 && this.mKeyguardStateController.isShowing()) {
                this.mIconController.setIcon(this.mSlotManagedProfile, C0010R$drawable.stat_sys_managed_profile_status, this.mContext.getString(C0018R$string.accessibility_managed_profile));
            } else if (this.mManagedProfileInQuietMode) {
                this.mIconController.setIcon(this.mSlotManagedProfile, C0010R$drawable.stat_sys_managed_profile_status_off, this.mContext.getString(C0018R$string.accessibility_managed_profile));
            } else if (z3) {
                z4 = !this.mKeyguardStateController.isShowing();
                this.mIconController.setIcon(this.mSlotManagedProfile, C0010R$drawable.stat_sys_managed_profile_not_owner_user, this.mContext.getString(C0018R$string.accessibility_managed_profile));
            }
            z4 = true;
        }
    ...
    public void updateBluetoothHandsfreeBattery(Intent intent) {
        ...
        switch (intExtra) {
            case 1:
            case 2:
                this.mIconController.setIcon(this.mSlotBluetoothBattery, C0010R$drawable.stat_sys_bluetooth_handsfree_battery_1, this.mContext.getString(C0018R$string.accessibility_quick_settings_bluetooth_handsfree_battery_level, new Object[]{Integer.valueOf(intExtra * 10)}));
                break;
            case 3:
            case 4:
                this.mIconController.setIcon(this.mSlotBluetoothBattery, C0010R$drawable.stat_sys_bluetooth_handsfree_battery_2, this.mContext.getString(C0018R$string.accessibility_quick_settings_bluetooth_handsfree_battery_level, new Object[]{Integer.valueOf(intExtra * 10)}));
                break;
            case 5:
            case 6:
                this.mIconController.setIcon(this.mSlotBluetoothBattery, C0010R$drawable.stat_sys_bluetooth_handsfree_battery_3, this.mContext.getString(C0018R$string.accessibility_quick_settings_bluetooth_handsfree_battery_level, new Object[]{Integer.valueOf(intExtra * 10)}));
                break;
            case 7:
            case 8:
                this.mIconController.setIcon(this.mSlotBluetoothBattery, C0010R$drawable.stat_sys_bluetooth_handsfree_battery_4, this.mContext.getString(C0018R$string.accessibility_quick_settings_bluetooth_handsfree_battery_level, new Object[]{Integer.valueOf(intExtra * 10)}));
                break;
            default:
                this.mIconController.setIcon(this.mSlotBluetoothBattery, C0010R$drawable.stat_sys_bluetooth_handsfree_battery_5, this.mContext.getString(C0018R$string.accessibility_quick_settings_bluetooth_handsfree_battery_level, new Object[]{Integer.valueOf(intExtra * 10)}));
                break;
        }
    ...
    public void updateVolumeZen() {
        ...
        if (this.mZenController.isVibrateOn()) {
            i = C0010R$drawable.stat_sys_ringer_vibrate;
            str = this.mContext.getString(C0018R$string.accessibility_ringer_vibrate);
        } else {
            i = C0010R$drawable.stat_sys_ringer_silent;
            str = this.mContext.getString(C0018R$string.accessibility_ringer_silent);
        }
    ...
    public void updateLocation(Intent intent) {
        ...
        if (!action.equals("android.location.GPS_FIX_CHANGE") || !booleanExtra) {
            ...
            i = C0010R$drawable.stat_sys_gps_on;
            z = true;
        }
        if (i != 0) {
    ...
    public void updateHeadsetPlug(Intent intent) {
        ...
        if (z) {
            ...
            if (z2) {
                i = C0018R$string.accessibility_status_bar_headset;
            } else {
                i = C0018R$string.accessibility_status_bar_headphones;
            }
            String string = resources.getString(i);
            StatusBarIconController statusBarIconController = this.mIconController;
            String str = this.mSlotHeadset;
            if (z2) {
                i2 = C0010R$drawable.stat_sys_headset;
            } else {
                i2 = C0010R$drawable.stat_sys_headset_without_mic;
            }
            ...
            if (z2) {
                i3 = C0010R$drawable.stat_sys_headset;
            } else {
                i3 = C0010R$drawable.stat_sys_headset_without_mic;
            }
    ...
    public void updateAlarm() {
        ...
        if (z3) {
            i = C0010R$drawable.stat_sys_alarm_dim;
        } else {
            i = C0010R$drawable.stat_sys_alarm;
        }
        statusBarIconController.setIcon(str, i, buildAlarmContentDescription());
        this.mIconController.setIconVisibility(this.mSlotAlarmClock, this.mCurrentUserSetup && z2);
        MiuiDripLeftStatusBarIconControllerImpl miuiDripLeftStatusBarIconControllerImpl = this.miuiDripLeftStatusBarIconController;
        String str2 = this.mSlotAlarmClock;
        if (z3) {
            i2 = C0010R$drawable.stat_sys_alarm_dim;
        } else {
            i2 = C0010R$drawable.stat_sys_alarm;
        }
        miuiDripLeftStatusBarIconControllerImpl.setIcon(str2, i2, buildAlarmContentDescription());
        MiuiDripLeftStatusBarIconControllerImpl miuiDripLeftStatusBarIconControllerImpl2 = this.miuiDripLeftStatusBarIconController;
        String str3 = this.mSlotAlarmClock;
        if (!this.mCurrentUserSetup || !z2) {
            z = false;
        }
        miuiDripLeftStatusBarIconControllerImpl2.setIconVisibility(str3, z);
    }
}
