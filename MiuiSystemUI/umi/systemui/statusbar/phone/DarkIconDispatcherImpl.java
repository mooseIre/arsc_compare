...
public class DarkIconDispatcherImpl implements SysuiDarkIconDispatcher, LightBarTransitionsController.DarkIntensityApplier, ConfigurationController.ConfigurationListener {
    ...
    @Override // com.android.systemui.plugins.DarkIconDispatcher
    public void reapply(DarkIconDispatcher.DarkReceiver darkReceiver) {
        DarkIconDispatcher.DarkReceiver darkReceiver2 = this.mReceivers.get(darkReceiver);
        if (darkReceiver2 != null) {
            darkReceiver2.onDarkChanged(this.mTintArea, this.mDarkIntensity, this.mIconTint, this.mLightModeIconColorSingleTone, this.mDarkModeIconColorSingleTone, this.mUseTint);
        }
    }
