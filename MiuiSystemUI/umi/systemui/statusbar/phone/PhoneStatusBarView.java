...
public class PhoneStatusBarView extends PanelBar {
    ...
    public void onFinishInflate() {
        this.mBattery = (DarkIconDispatcher.DarkReceiver) findViewById(C0014R$id.battery);
        this.mCutoutSpace = findViewById(C0014R$id.cutout_space_view);
        this.mCenterIconSpace = findViewById(C0014R$id.centered_icon_area);
        updateResources();
    }
    ...
    public void updateResources() {
        ...
        this.mRoundedCornerPadding = getResources().getDimensionPixelSize(C0011R$dimen.rounded_corner_content_padding);
    ...
    private void updateStatusBarHeight() {
        ...
        int dimensionPixelSize = getResources().getDimensionPixelSize(C0011R$dimen.status_bar_height);
        this.mStatusBarHeight = dimensionPixelSize;
        layoutParams.height = dimensionPixelSize - i;
        int dimensionPixelSize2 = getResources().getDimensionPixelSize(C0011R$dimen.status_bar_padding_top);
        int dimensionPixelSize3 = getResources().getDimensionPixelSize(C0011R$dimen.status_bar_padding_start);
        findViewById(C0014R$id.status_bar_contents).setPaddingRelative(dimensionPixelSize3, dimensionPixelSize2, getResources().getDimensionPixelSize(C0011R$dimen.status_bar_padding_end), 0);
        findViewById(C0014R$id.notification_lights_out).setPaddingRelative(0, dimensionPixelSize3, 0, 0);
