    ...
    public void onRotationProposal(int i, int i2, boolean z) {
        ...
        if (this.mRotationButton.acceptRotationProposal()) {
            if (!z) {
                ...
                if (i2 == 0 || i2 == 2) {
                    i3 = isRotationAnimationCCW ? C0019R$style.RotateButtonCCWStart90 : C0019R$style.RotateButtonCWStart90;
                } else {
                    i3 = isRotationAnimationCCW ? C0019R$style.RotateButtonCCWStart0 : C0019R$style.RotateButtonCWStart0;
                }
                this.mStyleRes = i3;
