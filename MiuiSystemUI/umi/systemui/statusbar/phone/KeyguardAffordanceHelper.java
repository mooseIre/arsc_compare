...
public class KeyguardAffordanceHelper {
    ...
    private void initDimens() {
        ...
        this.mContext.getResources().getDimensionPixelSize(C0011R$dimen.keyguard_affordance_min_background_radius);
        this.mTouchTargetSize = this.mContext.getResources().getDimensionPixelSize(C0011R$dimen.keyguard_affordance_touch_target_size);
        this.mContext.getResources().getDimensionPixelSize(C0011R$dimen.hint_grow_amount_sideways);
