...
public class KeyguardClockPositionAlgorithm {
    ...
    public void loadDimens(Resources resources) {
        this.mClockNotificationsMargin = resources.getDimensionPixelSize(C0009R$dimen.keyguard_clock_notifications_margin);
        this.mContainerTopPadding = Math.max(resources.getDimensionPixelSize(C0009R$dimen.keyguard_clock_top_margin), resources.getDimensionPixelSize(C0009R$dimen.keyguard_lock_height) + resources.getDimensionPixelSize(C0009R$dimen.keyguard_lock_padding) + resources.getDimensionPixelSize(C0009R$dimen.keyguard_clock_lock_margin));
