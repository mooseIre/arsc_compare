...
public class NotificationsQuickSettingsContainer extends FrameLayout implements ViewStub.OnInflateListener, FragmentHostManager.FragmentListener, AboveShelfObserver.HasViewAboveShelfChangedListener {
    ...
    public void onFinishInflate() {
        ...
        this.mQsFrame = (FrameLayout) findViewById(C0014R$id.qs_frame);
        NotificationStackScrollLayout notificationStackScrollLayout = (NotificationStackScrollLayout) findViewById(C0014R$id.notification_stack_scroller);
        ...
        this.mKeyguardStatusBar = findViewById(C0014R$id.keyguard_header);
        ViewStub viewStub = (ViewStub) findViewById(C0014R$id.keyguard_user_switcher);
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        reloadWidth(this.mQsFrame, C0011R$dimen.qs_panel_width);
        reloadWidth(this.mStackScroller, C0011R$dimen.notification_panel_width);
    }
