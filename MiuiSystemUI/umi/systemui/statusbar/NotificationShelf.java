...
public class NotificationShelf extends ActivatableNotificationView implements View.OnLayoutChangeListener, StatusBarStateController.StateListener {
    ...
    public static final int TAG_CONTINUOUS_CLIPPING = C0012R$id.continuous_clipping_tag;
    ...
    public void onFinishInflate() {
        ...
        NotificationIconContainer notificationIconContainer = (NotificationIconContainer) findViewById(C0012R$id.content);
    ...
    private void initDimens() {
        ...
        this.mIconAppearTopPadding = resources.getDimensionPixelSize(C0009R$dimen.notification_icon_appear_padding);
        this.mStatusBarHeight = resources.getDimensionPixelOffset(C0009R$dimen.status_bar_height);
        resources.getDimensionPixelOffset(C0009R$dimen.status_bar_padding_start);
        this.mPaddingBetweenElements = resources.getDimensionPixelSize(C0009R$dimen.notification_divider_height);
        ViewGroup.LayoutParams layoutParams = getLayoutParams();
        layoutParams.height = resources.getDimensionPixelOffset(C0009R$dimen.notification_shelf_height);
        setLayoutParams(layoutParams);
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C0009R$dimen.shelf_icon_container_padding);
        this.mShelfIcons.setPadding(dimensionPixelOffset, 0, dimensionPixelOffset, 0);
        this.mScrollFastThreshold = resources.getDimensionPixelOffset(C0009R$dimen.scroll_fast_threshold);
        this.mShowNotificationShelf = resources.getBoolean(C0007R$bool.config_showNotificationShelf);
        this.mIconSize = resources.getDimensionPixelSize(17105492);
        this.mHiddenShelfIconSize = (float) resources.getDimensionPixelOffset(C0009R$dimen.hidden_shelf_icon_size);
        this.mGapHeight = resources.getDimensionPixelSize(C0009R$dimen.qs_notification_padding);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.mInteractive) {
            ...
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, getContext().getString(C0018R$string.accessibility_overflow_action)));
        }
    }
