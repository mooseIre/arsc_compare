...
public final class IlluminationDrawable$animateBackground$$inlined$apply$lambda$1 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        if (animatedValue != null) {
            ...
            IlluminationDrawable.access$getPaint$p(this.this$0).setColor(ColorUtils.blendARGB(this.$initialBackground$inlined, this.this$0.backgroundColor, floatValue));
