...
public final class PlayerViewHolder {
    ...
    private PlayerViewHolder(View view) {
        if (view != null) {
            ...
            this.artwork = (RoundedSideImageView) view.requireViewById(C0014R$id.media_control_artwork);
            this.appIcon = (ImageView) view.requireViewById(C0014R$id.icon);
            this.appName = (TextView) view.requireViewById(C0014R$id.app_name);
            this.albumView = (ImageView) view.requireViewById(C0014R$id.album_art);
            this.titleText = (TextView) view.requireViewById(C0014R$id.header_title);
            this.artistText = (TextView) view.requireViewById(C0014R$id.header_artist);
            this.seamless = (ViewGroup) view.requireViewById(C0014R$id.media_seamless);
            this.seamlessIcon = (ImageView) view.requireViewById(C0014R$id.media_seamless_image);
            this.seamlessText = (TextView) view.requireViewById(C0014R$id.media_seamless_text);
            this.seamlessFallback = (ImageView) view.requireViewById(C0014R$id.media_seamless_fallback);
            this.seekBar = (SeekBar) view.requireViewById(C0014R$id.media_progress_bar);
            this.progressTimes = (ViewGroup) view.requireViewById(C0014R$id.notification_media_progress_time);
            this.elapsedTimeView = (TextView) view.requireViewById(C0014R$id.media_elapsed_time);
            this.totalTimeView = (TextView) view.requireViewById(C0014R$id.media_total_time);
            FrameLayout frameLayout = (FrameLayout) view.requireViewById(C0014R$id.actions);
            this.action0 = (ImageButton) view.requireViewById(C0014R$id.action0);
            this.action1 = (ImageButton) view.requireViewById(C0014R$id.action1);
            this.action2 = (ImageButton) view.requireViewById(C0014R$id.action2);
            this.action3 = (ImageButton) view.requireViewById(C0014R$id.action3);
            this.action4 = (ImageButton) view.requireViewById(C0014R$id.action4);
            view.requireViewById(C0014R$id.qs_media_controls_options);
            return;
        }
    ...
    public static final class Companion {
        ...
        public final PlayerViewHolder create(@NotNull LayoutInflater layoutInflater, @NotNull ViewGroup viewGroup) {
            ...
            View inflate = layoutInflater.inflate(C0016R$layout.media_view, viewGroup, false);
