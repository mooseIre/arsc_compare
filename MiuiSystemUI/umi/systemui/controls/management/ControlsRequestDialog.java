    ...
    public final Dialog createDialog(@NotNull CharSequence charSequence) {
        ...
        if (componentName != null) {
            ...
            if (control2 != null) {
                ...
                View inflate = LayoutInflater.from(this).inflate(C0014R$layout.controls_dialog, (ViewGroup) null);
                ImageView imageView = (ImageView) inflate.requireViewById(C0012R$id.icon);
                ...
                View requireViewById = inflate.requireViewById(C0012R$id.title);
                ...
                if (control3 != null) {
                    ...
                    View requireViewById2 = inflate.requireViewById(C0012R$id.subtitle);
                    ...
                    if (control4 != null) {
                        ...
                        View requireViewById3 = inflate.requireViewById(C0012R$id.control);
                        Intrinsics.checkExpressionValueIsNotNull(requireViewById3, "requireViewById<View>(R.id.control)");
                        requireViewById3.setElevation(inflate.getResources().getFloat(C0009R$dimen.control_card_elevation));
                        AlertDialog create = new AlertDialog.Builder(this).setTitle(getString(C0018R$string.controls_dialog_title)).setMessage(getString(C0018R$string.controls_dialog_message, new Object[]{charSequence})).setPositiveButton(C0018R$string.controls_dialog_ok, this).setNegativeButton(17039360, this).setOnCancelListener(this).setView(inflate).create();
