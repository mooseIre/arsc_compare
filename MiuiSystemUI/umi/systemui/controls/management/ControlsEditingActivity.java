...
public final class ControlsEditingActivity extends LifecycleActivity {
    private static final int EMPTY_TEXT_ID = C0020R$string.controls_favorite_removed;
    private static final int SUBTITLE_ID = C0020R$string.controls_favorite_rearrange;
    ...
    private final void bindViews() {
        ...
        viewStub.setLayoutResource(C0016R$layout.controls_management_editing);
        viewStub.inflate();
        View requireViewById2 = requireViewById(C0014R$id.title);
        ...
        if (charSequence != null) {
            ...
            if (charSequence2 != null) {
                ...
                View requireViewById3 = requireViewById(C0014R$id.subtitle);
    ...
    private final void bindButtons() {
        ViewGroup viewGroup = (ViewGroup) requireViewById(C0014R$id.controls_management_root);
        View requireViewById = requireViewById(C0014R$id.done);
        Button button = (Button) requireViewById;
        button.setEnabled(false);
        button.setText(C0020R$string.save);
        ...
        if (componentName != null) {
            ...
            if (charSequence != null) {
                ...
                if (componentName2 != null) {
                    ...
                    float f = getResources().getFloat(C0011R$dimen.control_card_elevation);
                    RecyclerView recyclerView = (RecyclerView) requireViewById(C0014R$id.list);
                    ...
                    int dimensionPixelSize = getResources().getDimensionPixelSize(C0011R$dimen.controls_card_margin);
