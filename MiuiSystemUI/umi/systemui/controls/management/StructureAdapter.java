...
public final class StructureAdapter extends RecyclerView.Adapter<StructureHolder> {
    ...
    public StructureHolder onCreateViewHolder(@NotNull ViewGroup viewGroup, int i) {
        ...
        View inflate = LayoutInflater.from(viewGroup.getContext()).inflate(C0016R$layout.controls_structure_page, viewGroup, false);
    ...
    public static final class StructureHolder extends RecyclerView.ViewHolder {
        ...
        public StructureHolder(@NotNull View view) {
            ...
            View requireViewById = this.itemView.requireViewById(C0014R$id.listAll);
            ...
            this.controlAdapter = new ControlAdapter(context.getResources().getFloat(C0011R$dimen.control_card_elevation));
            setUpRecyclerView();
        }
        ...
        private final void setUpRecyclerView() {
            ...
            Intrinsics.checkExpressionValueIsNotNull(context, "itemView.context");
            int dimensionPixelSize = context.getResources().getDimensionPixelSize(C0011R$dimen.controls_card_margin);
