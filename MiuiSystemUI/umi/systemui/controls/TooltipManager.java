...
public final class TooltipManager {
    ...
    public TooltipManager(@NotNull Context context, @NotNull String str, int i, boolean z) {
        ...
        View inflate = LayoutInflater.from(context).inflate(C0014R$layout.controls_onboarding, (ViewGroup) null);
        if (inflate != null) {
            ...
            this.textView = (TextView) this.layout.requireViewById(C0012R$id.onboarding_text);
            this.layout.requireViewById(C0012R$id.dismiss).setOnClickListener(new TooltipManager$$special$$inlined$apply$lambda$1(this));
            View requireViewById = this.layout.requireViewById(C0012R$id.arrow);
            ...
            int dimensionPixelSize = context.getResources().getDimensionPixelSize(C0009R$dimen.recents_onboarding_toast_arrow_corner_radius);
