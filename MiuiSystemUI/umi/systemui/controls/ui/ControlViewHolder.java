...
import com.android.systemui.C0011R$fraction;
...
public final class ControlViewHolder {
    ...
    public ControlViewHolder(@NotNull ViewGroup viewGroup, @NotNull ControlsController controlsController2, @NotNull DelayableExecutor delayableExecutor, @NotNull DelayableExecutor delayableExecutor2, @NotNull ControlActionCoordinator controlActionCoordinator2) {
        ...
        this.toggleBackgroundIntensity = context2.getResources().getFraction(C0011R$fraction.controls_toggle_bg_intensity, 1, 1);
        View requireViewById = this.layout.requireViewById(C0012R$id.icon);
        ...
        View requireViewById2 = this.layout.requireViewById(C0012R$id.status);
        ...
        View requireViewById3 = this.layout.requireViewById(C0012R$id.title);
        ...
        View requireViewById4 = this.layout.requireViewById(C0012R$id.subtitle);
        ...
        if (background != null) {
            ...
            Drawable findDrawableByLayerId = layerDrawable.findDrawableByLayerId(C0012R$id.clip_layer);
            if (findDrawableByLayerId != null) {
                ClipDrawable clipDrawable = (ClipDrawable) findDrawableByLayerId;
                this.clipLayer = clipDrawable;
                clipDrawable.setAlpha(0);
                Drawable findDrawableByLayerId2 = layerDrawable.findDrawableByLayerId(C0012R$id.background);
    ...
    public final void setErrorStatus() {
        animateStatusChange(true, new ControlViewHolder$setErrorStatus$1(this, this.context.getResources().getString(C0018R$string.controls_error_failed)));
    }
    ...
    private final void animateBackgroundChange(boolean z, boolean z2, int i) {
        ...
        int color = this.context.getResources().getColor(C0008R$color.control_default_background, this.context.getTheme());
        ...
        if (z2) {
            ...
            list = CollectionsKt__CollectionsKt.listOf(Integer.valueOf(this.context.getResources().getColor(C0008R$color.control_default_background, this.context.getTheme())), 0);
        }
