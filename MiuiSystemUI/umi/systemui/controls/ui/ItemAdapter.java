...
final class ItemAdapter extends ArrayAdapter<SelectionItem> {
    ...
    public View getView(int i, @Nullable View view, @NotNull ViewGroup viewGroup) {
        ...
        ((TextView) view.requireViewById(C0012R$id.controls_spinner_item)).setText(selectionItem.getTitle());
        ((ImageView) view.requireViewById(C0012R$id.app_icon)).setImageDrawable(selectionItem.getIcon());
