...
final class ChallengeDialogs$createPinDialog$$inlined$apply$lambda$3 implements DialogInterface.OnShowListener {
    ...
    public final void onShow(DialogInterface dialogInterface) {
        final EditText editText = (EditText) this.$this_apply.requireViewById(C0012R$id.controls_pin_input);
        editText.setHint(this.$instructions$inlined);
        final CheckBox checkBox = (CheckBox) this.$this_apply.requireViewById(C0012R$id.controls_pin_use_alpha);
        ...
        ((CheckBox) this.$this_apply.requireViewById(C0012R$id.controls_pin_use_alpha)).setOnClickListener(new View.OnClickListener() {
