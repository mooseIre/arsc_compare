...
public final class MiuiVendorServices_Factory implements Factory<MiuiVendorServices> {
    ...
    public MiuiVendorServices_Factory(Provider<Context> provider, Provider<MiuiWallpaperZoomOutService> provider2, Provider<MiuiHeadsUpPolicy> provider3, Provider<MiuiGxzwPolicy> provider4, Provider<NotificationFilterController> provider5, Provider<NotificationAlertController> provider6, Provider<NotificationDynamicFpsController> provider7, Provider<NotificationCountLimitPolicy> provider8, Provider<MiuiNotificationShadePolicy> provider9, Provider<MiuiRecentProxy> provider10, Provider<OrientationPolicy> provider11, Provider<NotificationPanelNavigationBarCoordinator> provider12, Provider<HeadsetPolicy> provider13, Provider<MiuiFullScreenGestureProxy> provider14, Provider<CodeBlueService> provider15, Provider<OLEDScreenHelper> provider16, Provider<MiuiChargeManager> provider17, Provider<NotificationEntryManager> provider18, Provider<MiuiFaceUnlockManager> provider19, Provider<MiuiStatusBarConfigurationListener> provider20, Provider<MiuiActivityUtil> provider21) {
        ...
        this.mNotificationNavigationCoordinatorProvider = provider12;
        this.mHeadsetPolicyProvider = provider13;
        this.mMiuiFullScreenGestureProxyProvider = provider14;
        this.mCodeBlueServiceProvider = provider15;
        ...
        this.mMiuiActivityUtilProvider = provider21;
    }
    ...
    public static MiuiVendorServices provideInstance(Provider<Context> provider, Provider<MiuiWallpaperZoomOutService> provider2, Provider<MiuiHeadsUpPolicy> provider3, Provider<MiuiGxzwPolicy> provider4, Provider<NotificationFilterController> provider5, Provider<NotificationAlertController> provider6, Provider<NotificationDynamicFpsController> provider7, Provider<NotificationCountLimitPolicy> provider8, Provider<MiuiNotificationShadePolicy> provider9, Provider<MiuiRecentProxy> provider10, Provider<OrientationPolicy> provider11, Provider<NotificationPanelNavigationBarCoordinator> provider12, Provider<HeadsetPolicy> provider13, Provider<MiuiFullScreenGestureProxy> provider14, Provider<CodeBlueService> provider15, Provider<OLEDScreenHelper> provider16, Provider<MiuiChargeManager> provider17, Provider<NotificationEntryManager> provider18, Provider<MiuiFaceUnlockManager> provider19, Provider<MiuiStatusBarConfigurationListener> provider20, Provider<MiuiActivityUtil> provider21) {
        ...
        MiuiVendorServices_MembersInjector.injectMNotificationNavigationCoordinator(miuiVendorServices, provider12.get());
        MiuiVendorServices_MembersInjector.injectMHeadsetPolicy(miuiVendorServices, provider13.get());
        MiuiVendorServices_MembersInjector.injectMMiuiFullScreenGestureProxy(miuiVendorServices, provider14.get());
        MiuiVendorServices_MembersInjector.injectMCodeBlueService(miuiVendorServices, provider15.get());
        ...
        MiuiVendorServices_MembersInjector.injectMMiuiActivityUtil(miuiVendorServices, provider21.get());
    ...
    public static MiuiVendorServices_Factory create(Provider<Context> provider, Provider<MiuiWallpaperZoomOutService> provider2, Provider<MiuiHeadsUpPolicy> provider3, Provider<MiuiGxzwPolicy> provider4, Provider<NotificationFilterController> provider5, Provider<NotificationAlertController> provider6, Provider<NotificationDynamicFpsController> provider7, Provider<NotificationCountLimitPolicy> provider8, Provider<MiuiNotificationShadePolicy> provider9, Provider<MiuiRecentProxy> provider10, Provider<OrientationPolicy> provider11, Provider<NotificationPanelNavigationBarCoordinator> provider12, Provider<HeadsetPolicy> provider13, Provider<MiuiFullScreenGestureProxy> provider14, Provider<CodeBlueService> provider15, Provider<OLEDScreenHelper> provider16, Provider<MiuiChargeManager> provider17, Provider<NotificationEntryManager> provider18, Provider<MiuiFaceUnlockManager> provider19, Provider<MiuiStatusBarConfigurationListener> provider20, Provider<MiuiActivityUtil> provider21) {
        return new MiuiVendorServices_Factory(provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8, provider9, provider10, provider11, provider12, provider13, provider14, provider15, provider16, provider17, provider18, provider19, provider20, provider21);
    }
}
