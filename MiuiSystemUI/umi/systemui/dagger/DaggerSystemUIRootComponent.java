...
import miui.systemui.performance.BinderMonitor_Factory;
...
import miui.systemui.performance.FrameMonitor_Factory;
...
import miui.systemui.performance.MessageMonitor_Factory;
...
public final class DaggerSystemUIRootComponent implements SystemUIRootComponent {
    ...
    private Provider<BinderMonitor> binderMonitorProvider;
    ...
    private Provider<FrameMonitor> frameMonitorProvider;
    ...
    private void initialize3(Builder builder) {
        ...
        Provider<ControlPanelController> provider21 = DoubleCheck.provider(ControlPanelController_Factory.create(this.provideContextProvider, this.newKeyguardViewMediatorProvider, this.providesBroadcastDispatcherProvider, provider20, this.keyguardStateControllerImplProvider));
    ...
    private void initialize4(Builder builder) {
        ...
        this.controlsListingControllerImplProvider = DoubleCheck.provider(ControlsListingControllerImpl_Factory.create(this.provideContextProvider, provider2));
        ...
        Provider<PackageManager> provider3 = DoubleCheck.provider(SystemServicesModule_ProvidePackageManagerFactory.create(this.provideContextProvider));
        ...
        Provider<GlobalActionsComponent> provider5 = DoubleCheck.provider(GlobalActionsComponent_Factory.create(this.provideContextProvider, this.provideCommandQueueProvider, this.extensionControllerImplProvider, create2, this.statusBarKeyguardViewManagerProvider));
        ...
        Provider<ControlActionCoordinatorImpl> provider6 = DoubleCheck.provider(ControlActionCoordinatorImpl_Factory.create(this.provideContextProvider, this.provideDelayableExecutorProvider, this.provideMainDelayableExecutorProvider, this.activityStarterDelegateProvider, this.keyguardStateControllerImplProvider, this.globalActionsComponentProvider));
        this.controlActionCoordinatorImplProvider = provider6;
        Provider<ControlsUiControllerImpl> provider7 = DoubleCheck.provider(ControlsUiControllerImpl_Factory.create(this.controlsControllerImplProvider, this.provideContextProvider, this.provideMainDelayableExecutorProvider, this.provideBackgroundDelayableExecutorProvider, this.controlsListingControllerImplProvider, this.provideSharePreferencesProvider, provider6, this.activityStarterDelegateProvider, this.shadeControllerImplProvider));
        ...
        Provider<GlobalScreenshot> provider10 = DoubleCheck.provider(GlobalScreenshot_Factory.create(this.provideContextProvider, this.provideResourcesProvider, create5, this.provideUiEventLoggerProvider));
        ...
        Provider<LeakReporter> provider14 = DoubleCheck.provider(LeakReporter_Factory.create(this.provideContextProvider, this.provideLeakDetectorProvider, provider13));
        this.leakReporterProvider = provider14;
        Provider<GarbageMonitor> provider15 = DoubleCheck.provider(GarbageMonitor_Factory.create(this.provideContextProvider, this.provideBgLooperProvider, this.provideLeakDetectorProvider, provider14));
        this.garbageMonitorProvider = provider15;
        this.serviceProvider = DoubleCheck.provider(GarbageMonitor_Service_Factory.create(this.provideContextProvider, provider15));
        ...
        Provider<SlaveWifiHelper> provider16 = DoubleCheck.provider(SlaveWifiHelper_Factory.create(this.provideContextProvider));
        ...
        Provider<ManagedProfileControllerImpl> provider17 = DoubleCheck.provider(ManagedProfileControllerImpl_Factory.create(this.provideContextProvider, this.providesBroadcastDispatcherProvider));
        ...
        Provider<MiuiFlashlightControllerImpl> provider18 = DoubleCheck.provider(MiuiFlashlightControllerImpl_Factory.create(this.provideContextProvider));
    ...
    private void initialize5(Builder builder) {
        ...
        MiuiAirplaneModeTile_Factory create = MiuiAirplaneModeTile_Factory.create(this.qSTileHostProvider, this.networkControllerImplProvider);
        ...
        this.binderMonitorProvider = DoubleCheck.provider(BinderMonitor_Factory.create(this.provideContextProvider, this.provideBgLooperProvider));
        this.evilMethodMonitorProvider = DoubleCheck.provider(EvilMethodMonitor_Factory.create(this.provideContextProvider, this.provideBgLooperProvider));
        this.frameMonitorProvider = DoubleCheck.provider(FrameMonitor_Factory.create(this.provideContextProvider, this.provideBgLooperProvider));
        this.memoryMonitorProvider = DoubleCheck.provider(MemoryMonitor_Factory.create(this.provideContextProvider, this.provideBgLooperProvider));
        this.messageMonitorProvider = DoubleCheck.provider(MessageMonitor_Factory.create());
        Provider<ViewLeakMonitor> provider13 = DoubleCheck.provider(ViewLeakMonitor_Factory.create(this.provideContextProvider, this.provideBgLooperProvider, this.statusBarStateControllerImplProvider, this.provideNotificationEntryManagerProvider, this.provideConfigurationControllerProvider, this.controlPanelControllerProvider, this.settingsManagerProvider));
        this.viewLeakMonitorProvider = provider13;
        this.performanceToolsProvider = DoubleCheck.provider(PerformanceTools_Factory.create(this.provideContextProvider, this.binderMonitorProvider, this.evilMethodMonitorProvider, this.frameMonitorProvider, this.memoryMonitorProvider, this.messageMonitorProvider, provider13, this.dumpManagerProvider));
        ...
        Provider<EventTracker> provider14 = DoubleCheck.provider(EventTracker_Factory.create(this.provideContextProvider));
        this.eventTrackerProvider = provider14;
        this.codeBlueServiceProvider = DoubleCheck.provider(CodeBlueService_Factory.create(this.provideContextProvider, this.provideBgLooperProvider, this.provideNotificationEntryManagerProvider, provider14));
        ...
        Provider<ContextComponentResolver> provider16 = DoubleCheck.provider(ContextComponentResolver_Factory.create(this.mapOfClassOfAndProviderOfActivityProvider, this.mapOfClassOfAndProviderOfServiceProvider, this.mapOfClassOfAndProviderOfSystemUIProvider, this.mapOfClassOfAndProviderOfRecentsImplementationProvider, build));
        this.contextComponentResolverProvider = provider16;
        ((DelegateFactory) this.contextComponentResolverProvider).setDelegatedProvider(provider16);
        ...
        Provider<NotificationPanelStat> provider17 = DoubleCheck.provider(NotificationPanelStat_Factory.create(this.provideContextProvider, this.eventTrackerProvider));
        this.notificationPanelStatProvider = provider17;
        this.notificationStatProvider = DoubleCheck.provider(NotificationStat_Factory.create(this.provideContextProvider, this.provideNotificationEntryManagerProvider, this.notificationGroupManagerProvider, this.provideHeadsUpManagerPhoneProvider, this.statusBarStateControllerImplProvider, this.keyguardStateControllerImplProvider, this.eventTrackerProvider, provider17, this.notificationSettingsManagerProvider));
    ...
    private void initialize6(Builder builder) {
        ...
        Provider<ModalController> provider2 = DoubleCheck.provider(ModalController_Factory.create(this.provideContextProvider, this.provideStatusBarProvider, this.statusBarStateControllerImplProvider, provider));
        ...
        Provider<MiuiMediaTransferManager> provider5 = DoubleCheck.provider(MiuiMediaTransferManager_Factory.create(this.provideContextProvider));
        this.miuiMediaTransferManagerProvider = provider5;
        this.miuiMediaControlPanelProvider = MiuiMediaControlPanel_Factory.create(this.provideContextProvider, this.provideBackgroundExecutorProvider, this.activityStarterDelegateProvider, this.mediaViewControllerProvider, this.seekBarViewModelProvider, provider5);
        ...
        Provider<MediaDeviceManager> provider6 = DoubleCheck.provider(MediaDeviceManager_Factory.create(this.provideContextProvider, this.localMediaManagerFactoryProvider, create, this.provideMainExecutorProvider, this.mediaDataManagerProvider, this.dumpManagerProvider));
        ...
        Provider<MediaCarouselController> provider9 = DoubleCheck.provider(MediaCarouselController_Factory.create(this.provideContextProvider, this.miuiMediaControlPanelProvider, this.provideVisualStabilityManagerProvider, this.mediaHostStatesManagerProvider, this.activityStarterDelegateProvider, this.provideMainDelayableExecutorProvider, provider8, this.provideConfigurationControllerProvider, this.falsingManagerProxyProvider));
        this.mediaCarouselControllerProvider = provider9;
        this.mediaHierarchyManagerProvider = DoubleCheck.provider(MediaHierarchyManager_Factory.create(this.provideContextProvider, this.statusBarStateControllerImplProvider, this.keyguardStateControllerImplProvider, this.keyguardBypassControllerProvider, provider9, this.notificationLockscreenUserManagerImplProvider, this.wakefulnessLifecycleProvider));
    ...
    private final class DependencyInjectorImpl implements Dependency.DependencyInjector {
        ...
        private Dependency injectDependency(Dependency dependency) {
            ...
            Dependency_MembersInjector.injectMPerformanceTools(dependency, DoubleCheck.lazy(DaggerSystemUIRootComponent.this.performanceToolsProvider));
