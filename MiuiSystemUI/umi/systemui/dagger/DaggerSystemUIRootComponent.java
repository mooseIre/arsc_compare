...
public final class DaggerSystemUIRootComponent implements SystemUIRootComponent {
    ...
    private void initialize2(Builder builder) {
        ...
        Provider<CommandQueue> provider2 = DoubleCheck.provider(StatusBarDependenciesModule_ProvideCommandQueueFactory.create(this.provideContextProvider, provider));
        this.provideCommandQueueProvider = provider2;
        this.miuiNotificationInterruptStateProviderImplProvider = DoubleCheck.provider(MiuiNotificationInterruptStateProviderImpl_Factory.create(this.provideContentResolverProvider, this.providePowerManagerProvider, this.provideIDreamManagerProvider, this.provideAmbientDisplayConfigurationProvider, this.notificationFilterProvider, this.provideBatteryControllerProvider, this.statusBarStateControllerImplProvider, this.provideHeadsUpManagerPhoneProvider, this.provideMainHandlerProvider, this.zenModeControllerImplProvider, this.settingsManagerProvider, provider2));
        ...
        Provider<NotificationEntryManager> provider4 = DoubleCheck.provider(NotificationsModule_ProvideNotificationEntryManagerFactory.create(this.notificationEntryManagerLoggerProvider, this.notificationGroupManagerProvider, this.notificationRankingManagerProvider, this.keyguardEnvironmentImplProvider, this.featureFlagsProvider, this.notificationRowBinderImplProvider, this.provideNotificationRemoteInputManagerProvider, this.provideLeakDetectorProvider, provider3));
        this.provideNotificationEntryManagerProvider = provider4;
        ((DelegateFactory) this.provideNotificationEntryManagerProvider).setDelegatedProvider(provider4);
        ...
        Provider<AppOpsControllerImpl> provider5 = DoubleCheck.provider(AppOpsControllerImpl_Factory.create(this.provideContextProvider, this.provideBgLooperProvider, this.dumpManagerProvider));
        this.appOpsControllerImplProvider = provider5;
        Provider<ForegroundServiceController> provider6 = DoubleCheck.provider(ForegroundServiceController_Factory.create(this.provideNotificationEntryManagerProvider, provider5, this.provideMainHandlerProvider));
        this.foregroundServiceControllerProvider = provider6;
        this.appOpsCoordinatorProvider = DoubleCheck.provider(AppOpsCoordinator_Factory.create(provider6, this.appOpsControllerImplProvider, this.provideMainDelayableExecutorProvider));
        Provider<IPackageManager> provider7 = DoubleCheck.provider(SystemServicesModule_ProvideIPackageManagerFactory.create());
        this.provideIPackageManagerProvider = provider7;
        this.deviceProvisionedCoordinatorProvider = DoubleCheck.provider(DeviceProvisionedCoordinator_Factory.create(this.deviceProvisionedControllerImplProvider, provider7));
        DelegateFactory delegateFactory = new DelegateFactory();
        ...
        Provider<HeadsUpViewBinder> provider8 = DoubleCheck.provider(HeadsUpViewBinder_Factory.create(this.provideNotificationMessagingUtilProvider, this.rowContentBindStageProvider));
        this.headsUpViewBinderProvider = provider8;
        this.headsUpCoordinatorProvider = DoubleCheck.provider(HeadsUpCoordinator_Factory.create(this.provideHeadsUpManagerPhoneProvider, provider8, this.miuiNotificationInterruptStateProviderImplProvider, this.provideNotificationRemoteInputManagerProvider));
        ...
        this.preparationCoordinatorProvider = DoubleCheck.provider(PreparationCoordinator_Factory.create(this.preparationCoordinatorLoggerProvider, this.notifInflaterImplProvider, this.notifInflationErrorManagerProvider, provider9, this.provideIStatusBarServiceProvider));
        ...
        Provider<VisualStabilityManager> provider10 = DoubleCheck.provider(NotificationsModule_ProvideVisualStabilityManagerFactory.create(this.provideNotificationEntryManagerProvider, ConcurrencyModule_ProvideHandlerFactory.create()));
        this.provideVisualStabilityManagerProvider = provider10;
        Provider<NotifViewManager> provider11 = DoubleCheck.provider(NotifViewManager_Factory.create(this.notifViewBarnProvider, provider10, this.featureFlagsProvider));
        this.notifViewManagerProvider = provider11;
        this.notifPipelineInitializerProvider = DoubleCheck.provider(NotifPipelineInitializer_Factory.create(this.notifPipelineProvider, this.groupCoalescerProvider, this.notifCollectionProvider, this.shadeListBuilderProvider, this.notifCoordinatorsProvider, this.notifInflaterImplProvider, this.dumpManagerProvider, this.featureFlagsProvider, provider11));
        ...
        Provider<ChannelEditorDialogController> provider13 = DoubleCheck.provider(ChannelEditorDialogController_Factory.create(this.provideContextProvider, this.provideINotificationManagerProvider, ChannelEditorDialog_Builder_Factory.create()));
        ...
        Provider<ActivityStarterDelegate> provider15 = DoubleCheck.provider(ActivityStarterDelegate_Factory.create(access$500));
        this.activityStarterDelegateProvider = provider15;
        this.userSwitcherControllerProvider = DoubleCheck.provider(UserSwitcherController_Factory.create(this.provideContextProvider, this.keyguardStateControllerImplProvider, this.provideMainHandlerProvider, provider15, this.providesBroadcastDispatcherProvider, this.provideUiEventLoggerProvider));
        ...
        Provider<NetworkScoreManager> provider16 = DoubleCheck.provider(SystemServicesModule_ProvideNetworkScoreManagerFactory.create(this.provideContextProvider));
        ...
        this.pipSnapAlgorithmProvider = PipSnapAlgorithm_Factory.create(this.provideContextProvider);
    }

    private void initialize3(Builder builder) {
        this.pipBoundsHandlerProvider = DoubleCheck.provider(PipBoundsHandler_Factory.create(this.provideContextProvider, this.pipSnapAlgorithmProvider, this.displayControllerProvider));
        ...
        Provider<ControlPanelController> provider19 = DoubleCheck.provider(ControlPanelController_Factory.create(this.provideContextProvider, this.newKeyguardViewMediatorProvider));
        this.controlPanelControllerProvider = provider19;
    ...
    private void initialize4(Builder builder) {
        ...
        Provider<SettingsObserverImpl> provider15 = DoubleCheck.provider(SettingsObserverImpl_Factory.create(this.provideContextProvider, this.providesBroadcastDispatcherProvider));
        this.settingsObserverImplProvider = provider15;
        this.superSaveModeControllerProvider = DoubleCheck.provider(SuperSaveModeController_Factory.create(this.provideContextProvider, provider15));
        ...
        Provider<FlashlightControllerImpl> provider17 = DoubleCheck.provider(FlashlightControllerImpl_Factory.create(this.provideContextProvider));
    ...
    private void initialize5(Builder builder) {
        ...
        Provider<NotificationCountLimitPolicy> provider10 = DoubleCheck.provider(NotificationCountLimitPolicy_Factory.create(this.provideNotificationEntryManagerProvider));
        this.notificationCountLimitPolicyProvider = provider10;
        this.miuiVendorServicesProvider = DoubleCheck.provider(MiuiVendorServices_Factory.create(this.provideContextProvider, this.miuiWallpaperZoomOutServiceProvider, this.miuiHeadsUpPolicyProvider, this.miuiGxzwPolicyProvider, this.notificationAlertControllerProvider, this.notificationDynamicFpsControllerProvider, provider10));
        ...
        this.appMiniWindowManagerProvider = DoubleCheck.provider(AppMiniWindowManager_Factory.create(this.provideContextProvider, this.provideDividerProvider, this.provideHeadsUpManagerPhoneProvider, this.notificationSettingsManagerProvider));
        ...
        this.modalControllerProvider = DoubleCheck.provider(ModalController_Factory.create(this.provideContextProvider, this.provideStatusBarProvider, provider13));
        ...
        Provider<MediaHostStatesManager> provider14 = DoubleCheck.provider(MediaHostStatesManager_Factory.create());
        this.mediaHostStatesManagerProvider = provider14;
        this.mediaViewControllerProvider = MediaViewController_Factory.create(this.provideContextProvider, this.provideConfigurationControllerProvider, provider14);
        Provider<RepeatableExecutor> provider15 = DoubleCheck.provider(ConcurrencyModule_ProvideBackgroundRepeatableExecutorFactory.create(this.provideBackgroundDelayableExecutorProvider));
    ...
    private void initialize6(Builder builder) {
        this.miuiMediaControlPanelProvider = MiuiMediaControlPanel_Factory.create(this.provideContextProvider, this.provideBackgroundExecutorProvider, this.activityStarterDelegateProvider, this.mediaViewControllerProvider, this.seekBarViewModelProvider);
        ...
        Provider<MediaDeviceManager> provider = DoubleCheck.provider(MediaDeviceManager_Factory.create(this.provideContextProvider, this.localMediaManagerFactoryProvider, create, this.provideMainExecutorProvider, this.mediaDataManagerProvider, this.dumpManagerProvider));
        this.mediaDeviceManagerProvider = provider;
        Provider<MediaDataCombineLatest> provider2 = DoubleCheck.provider(MediaDataCombineLatest_Factory.create(this.mediaDataManagerProvider, provider));
        this.mediaDataCombineLatestProvider = provider2;
        Provider<MediaDataFilter> provider3 = DoubleCheck.provider(MediaDataFilter_Factory.create(provider2, this.providesBroadcastDispatcherProvider, this.mediaResumeListenerProvider, this.mediaDataManagerProvider, this.notificationLockscreenUserManagerImplProvider, this.provideMainExecutorProvider));
        this.mediaDataFilterProvider = provider3;
        Provider<MediaCarouselController> provider4 = DoubleCheck.provider(MediaCarouselController_Factory.create(this.provideContextProvider, this.miuiMediaControlPanelProvider, this.provideVisualStabilityManagerProvider, this.mediaHostStatesManagerProvider, this.activityStarterDelegateProvider, this.provideMainDelayableExecutorProvider, provider3, this.provideConfigurationControllerProvider, this.falsingManagerProxyProvider));
        this.mediaCarouselControllerProvider = provider4;
        this.mediaHierarchyManagerProvider = DoubleCheck.provider(MediaHierarchyManager_Factory.create(this.provideContextProvider, this.statusBarStateControllerImplProvider, this.keyguardStateControllerImplProvider, this.keyguardBypassControllerProvider, provider4, this.notificationLockscreenUserManagerImplProvider, this.wakefulnessLifecycleProvider));
        ...
        Provider<LogBuffer> provider7 = DoubleCheck.provider(LogModule_ProvideNotificationSectionLogBufferFactory.create(this.provideLogcatEchoTrackerProvider, this.dumpManagerProvider));
        this.provideNotificationSectionLogBufferProvider = provider7;
        this.notificationSectionsLoggerProvider = DoubleCheck.provider(NotificationSectionsLogger_Factory.create(provider7));
