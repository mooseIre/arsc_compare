...
public final class ControlCenterModule_ProvideControlCenterFactory implements Factory<ControlCenter> {
    ...
    public ControlCenterModule_ProvideControlCenterFactory(Provider<Context> provider, Provider<ControlPanelController> provider2, Provider<StatusBarIconController> provider3, Provider<ExpandInfoController> provider4, Provider<ActivityStarter> provider5, Provider<CommandQueue> provider6, Provider<InjectionInflationController> provider7, Provider<SuperSaveModeController> provider8, Provider<ControlCenterActivityStarter> provider9, Provider<QSTileHost> provider10, Provider<ControlPanelWindowManager> provider11, Provider<StatusBar> provider12, Provider<ControlsPluginManager> provider13, Provider<MiPlayPluginManager> provider14, Provider<BroadcastDispatcher> provider15, Provider<ConfigurationController> provider16) {
        ...
        this.miPlayPluginManagerProvider = provider14;
    ...
    public static ControlCenterModule_ProvideControlCenterFactory create(Provider<Context> provider, Provider<ControlPanelController> provider2, Provider<StatusBarIconController> provider3, Provider<ExpandInfoController> provider4, Provider<ActivityStarter> provider5, Provider<CommandQueue> provider6, Provider<InjectionInflationController> provider7, Provider<SuperSaveModeController> provider8, Provider<ControlCenterActivityStarter> provider9, Provider<QSTileHost> provider10, Provider<ControlPanelWindowManager> provider11, Provider<StatusBar> provider12, Provider<ControlsPluginManager> provider13, Provider<MiPlayPluginManager> provider14, Provider<BroadcastDispatcher> provider15, Provider<ConfigurationController> provider16) {
        return new ControlCenterModule_ProvideControlCenterFactory(provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8, provider9, provider10, provider11, provider12, provider13, provider14, provider15, provider16);
    }
