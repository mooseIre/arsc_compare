...
public class QSControlScrollView extends ScrollView {
    ...
    public boolean onTouchEvent(android.view.MotionEvent r9) {
        /*
            r8 = this;
            com.android.systemui.controlcenter.phone.QSControlCenterTileLayout r0 = r8.mQsControlCenterTileLayout
        ...
        L_0x006b:
            ...
            return r5
        L_0x0084:
            com.android.systemui.controlcenter.phone.QSControlCenterPanel r0 = r8.mQSControlCenterPanel
            float r5 = r9.getRawX()
            int r5 = (int) r5
            float r6 = r9.getRawY()
            int r6 = (int) r6
        ...
        L_0x00b9:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.controlcenter.phone.QSControlScrollView.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void setTransHeight(float f) {
        ...
        if (f == 0.0f) {
            ...
            float translationY = ControlCenterUtils.getTranslationY(f, (float) height);
