...
public class QSControlCustomizer extends FrameLayout implements TileQueryHelper.TileStateListener, QSTile.Callback {
    ...
    protected QSControlPanelCallback mQsPanelCallback = new QSControlPanelCallback() {
        public void show() {
            if (!QSControlCustomizer.this.isShown) {
                ...
                qSControlCustomizer.announceForAccessibility(qSControlCustomizer.mContext.getString(C0018R$string.accessibility_desc_quick_settings_edit));
        ...
        public void hide() {
            if (QSControlCustomizer.this.isShown) {
                ...
                QSControlCustomizer.this.setCustomizerAnimating(true);
                QSControlCustomizer qSControlCustomizer = QSControlCustomizer.this;
                qSControlCustomizer.announceForAccessibility(qSControlCustomizer.mContext.getString(C0018R$string.accessibility_desc_quick_settings));
    ...
    public QSControlCustomizer(Context context, AttributeSet attributeSet, CCTileQueryHelper cCTileQueryHelper, KeyguardUpdateMonitorInjector keyguardUpdateMonitorInjector) {
        ...
        setClickable(true);
        this.mSpanCount = this.mContext.getResources().getInteger(C0009R$dimen.qs_control_tiles_columns);
        this.mTileVerticalIntervel = this.mContext.getResources().getDimensionPixelSize(C0009R$dimen.qs_control_customizer_tiles_margin_bottom);
        LayoutInflater.from(getContext()).inflate(C0014R$layout.qs_control_customize_panel_content, this);
        this.mRecyclerView = (RecyclerView) findViewById(C0012R$id.list_added);
        ...
        this.mOthersRecyclerView = (RecyclerView) findViewById(C0012R$id.list_others);
        ...
        UnAddedTilesLayout unAddedTilesLayout = (UnAddedTilesLayout) findViewById(C0012R$id.unAdded_tiles);
        this.mUnAddedTilesLayout = unAddedTilesLayout;
        unAddedTilesLayout.setAddedLayout(this.mRecyclerView);
        TextView textView = (TextView) findViewById(C0012R$id.save);
        ...
        this.mHeader = (LinearLayout) findViewById(C0012R$id.header);
        this.mTitle = (TextView) findViewById(C0012R$id.title);
        this.mSubTitle = (TextView) findViewById(C0012R$id.sub_title);
        this.mSpanCount = -1;
    ...
    public void onFinishInflate() {
        ...
        if (!this.mLayoutParamsInited) {
            ...
            this.mUnAddedTilesLayout.setMarginTop(this.mContext.getResources().getDimensionPixelSize(C0009R$dimen.qs_control_customizer_tiles_title_height) + this.mContext.getResources().getDimensionPixelSize(C0009R$dimen.qs_control_customizer_tiles_sub_title_height) + layoutParams.topMargin + layoutParams.bottomMargin + this.mTileVerticalIntervel + this.mContext.getResources().getDimensionPixelSize(C0009R$dimen.qs_control_customizer_tiles_content_margin_top) + this.mContext.getResources().getDimensionPixelSize(C0009R$dimen.qs_control_customizer_tile_height), this.mContext.getResources().getDimensionPixelSize(C0009R$dimen.qs_control_customizer_tiles_title_height) + this.mContext.getResources().getDimensionPixelSize(C0009R$dimen.qs_control_customizer_tiles_sub_title_height) + this.mContext.getResources().getDimensionPixelSize(C0009R$dimen.qs_control_customizer_tiles_content_margin_top) + layoutParams.topMargin + layoutParams.bottomMargin + (this.mContext.getResources().getDimensionPixelSize(C0009R$dimen.qs_control_customizer_tile_height) * 4) + (this.mTileVerticalIntervel * 4));
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.mTitle.setText(C0018R$string.qs_control_customize_title);
        this.mSubTitle.setText(C0018R$string.qs_control_customize_sub_title);
        this.mDoneButton.setText(C0018R$string.qs_control_customize_save_text);
        Resources resources = this.mContext.getResources();
        int max = Math.max(1, resources.getInteger(C0009R$dimen.qs_control_tiles_columns));
    ...
    public void updateResources() {
        this.mTitle.setTextAppearance(C0019R$style.TextAppearance_QSControl_CustomizeTitle);
        this.mSubTitle.setTextAppearance(C0019R$style.TextAppearance_QSControl_CustomizeSubTitle);
        this.mDoneButton.setTextAppearance(C0019R$style.TextAppearance_QSControl_CustomizeSaveText);
